! function(e, t) {
	"function" == typeof define && define.amd ? define([], t) : "object" == typeof module && module.exports ? module.exports =
		t() : e.echarts = t()
}(this, function() {
	var e, t;
	! function() {
		...
		function r(e) {
			function t(t, o) {
				...
				t instanceof Array && (o = o || function() {}, o.apply(this, n(t, o, e)))
			}
			var r = {};
			return t
		}
			...
			if (e) {
				...
				for (var a in r)
					if (r.hasOwnProperty(a)) {
						var o = e[a],
							s = r[a];
						!w(s) || !w(o) || x(s) || x(o) || S(s) || S(o) || M(s) || M(o) ? !n && a in e || (e[a] = t(r[a], !0)) : i(o, s,
							n)
					} return e
			}
		}
		...
		function d(e, t, i) {
			if (e && t)
				if (e.forEach && e.forEach === k) e.forEach(t, i);
				else if (e.length === +e.length)
				for (var r = 0, n = e.length; n > r; r++) t.call(i, e[r], r, e);
			else
				for (var a in e) e.hasOwnProperty(a) && t.call(i, e[a], a, e)
		}
		...
		function m(e, t, i) {
			if (e && t)
				for (var r = 0, n = e.length; n > r; r++)
					if (t.call(i, e[r], r, e)) return e[r]
		}
		...
		function t(e, t) {
			for (var i, r = e.constructor, n = e[t];
				(r = r.$superClass) && (i = r.prototype[t]) && i === n;);
			return i
		}
		...
		return r.enableClassExtend = function(e, r) {
			...
			if (e.registerClass = function(e, t) {
					...
					var r = n[e];
					if (r && r[a] && (r = t ? r[t] : null), i && !r) throw new Error("Component " + e + "." + (t || "") +
						" not exists");
					return r
		...
		return {
			getAreaStyle: e("./makeStyleMapper")([
				["fill", "color"],
				["shadowBlur"],
				["shadowOffsetX"],
				["shadowOffsetY"],
			...
			t = {
				...
				rotate: function(e, t, i) {
					var r = t[0],
						...
						c = Math.sin(i),
						u = Math.cos(i);
					return e[0] = r * u + o * c, e[1] = -r * c + o * u, e[2] = n * u + s * c, e[3] = -n * c + u * s, e[4] = u * a +
						c * l, e[5] = u * l - c * a, e
				},
				scale: function(e, t, i) {
					var r = i[0],
				...
				invert: function(e, t) {
					var i = t[0],
						...
						s = t[5],
						l = i * o - a * r;
					return l ? (l = 1 / l, e[0] = o * l, e[1] = -a * l, e[2] = -r * l, e[3] = i * l, e[4] = (r * s - o * n) * l, e[
						5] = (a * n - i * s) * l, e) : null
				}
			};
		return t
		...
		return t.prototype = {
			...
			union: function(e) {
				var t = a(e.x, this.x),
					i = a(e.y, this.y);
				this.width = s(e.x + e.width, this.x + this.width) - t, this.height = s(e.y + e.height, this.y + this.height) -
					i, this.x = t, this.y = i
			},
			applyTransform: function() {
				var e = [],
					t = [];
				return function(i) {
					i && (e[0] = this.x, e[1] = this.y, t[0] = this.x + this.width, t[1] = this.y + this.height, n(e, e, i), n(t,
						t, i), this.x = a(e[0], t[0]), this.y = a(e[1], t[1]), this.width = o(t[0] - e[0]), this.height = o(t[1] -
						e[1]))
				}
			}(),
		...
		function t(e, t) {
			var i = e + ":" + t;
			if (s[i]) return s[i];
			for (var r = (e + "").split("\n"), n = 0, a = 0, o = r.length; o > a; a++) n = Math.max(d.measureText(r[a], t).width,
				n);
		...
		return {
			...
			getFont: function() {
				var e = this.ecModel,
					i = e && e.getModel("textStyle");
				return [this.getShallow("fontStyle") || t(i, "fontStyle"), this.getShallow("fontWeight") || t(i, "fontWeight"),
					(this.getShallow("fontSize") || t(i, "fontSize") || 12) + "px", this.getShallow("fontFamily") || t(i,
		...
		return {
			getItemStyle: e("./makeStyleMapper")([
				["fill", "color"],
				["stroke", "borderColor"],
	...
	}), t("echarts/model/Model", ["require", "zrender/core/util", "../util/clazz", "./mixin/lineStyle",
		"./mixin/areaStyle", "./mixin/textStyle", "./mixin/itemStyle"
	], function(e) {
		function t(e, t, i) {
		...
		t.prototype = {
			...
			get: function(e, t) {
				...
				for (var i = this.option, r = this.parentModel, n = 0; n < e.length && (i = i && "object" == typeof i ? i[e[n]] :
						null, null != i); n++);
			...
			getModel: function(e, i) {
				var r = this.get(e, !0),
					n = this.parentModel,
					a = new t(r, i || n && n.getModel(e), this.ecModel);
				return a
			},
			isEmpty: function() {
		...
		var n = i.mixin;
		return n(t, e("./mixin/lineStyle")), n(t, e("./mixin/areaStyle")), n(t, e("./mixin/textStyle")), n(t, e(
			"./mixin/itemStyle")), t
		...
		function r(e) {
			var t = e.length;
			return "number" == typeof e ? [e, e, e, e] : 2 === t ? [e[0], e[1], e[0], e[1]] : 3 === t ? [e[0], e[1], e[2], e[
				1]] : e
		}
		...
		function o(e, t) {
			...
			for (var c = 0; i > c; c++)
				for (var u = 0; u < r.length; u++) e = e.replace(a(l[u], c), t[c][r[u]]);
			return e
		}
		var s = e("zrender/core/util"),
			l = ["a", "b", "c", "d", "e", "f", "g"];
		return {
			normalizeCssArray: r,
			addCommas: t,
		...
		function(e) {
			...
			var i = e("zrender/core/util"),
				r = e("zrender/core/BoundingRect"),
				n = e("./number"),
				a = e("./format"),
				o = n.parsePercent,
				s = i.each,
				l = {};
			return l.box = t, l.vbox = i.curry(t, "vertical"), l.hbox = i.curry(t, "horizontal"), l.getAvailableSize =
				function(e, t, i) {
					var r = t.width,
						n = t.height,
						s = o(e.x, r),
						...
						c = o(e.x2, r),
						u = o(e.y2, n);
					return (isNaN(s) || isNaN(parseFloat(e.x))) && (s = 0), (isNaN(c) || isNaN(parseFloat(e.x2))) && (c = r), (isNaN(
						l) || isNaN(parseFloat(e.y))) && (l = 0), (isNaN(u) || isNaN(parseFloat(e.y2))) && (u = n), i = a.normalizeCssArray(
						i || 0), {
					...
					var n = t.width,
						...
						g = i[1] + i[3],
						m = e.aspect;
					switch (isNaN(d) && (d = n - u - g - l), isNaN(p) && (p = s - h - f - c), isNaN(d) && isNaN(p) && (m > n / s ? d =
						.8 * n : p = .8 * s), null != m && (isNaN(d) && (d = m * p), isNaN(p) && (p = d / m)), isNaN(l) && (l = n - u -
						d - g), isNaN(c) && (c = s - h - p - f), e.left || e.right) {
						case "center":
							l = n / 2 - d / 2 - i[3];
							break;
						case "right":
	...
	}), t("echarts/model/Component", ["require", "./Model", "zrender/core/util", "../util/component", "../util/clazz",
		"../util/layout", "./mixin/boxLayout"
	], function(e) {
		function t(e) {
			var t = [];
		...
		return o.enableClassExtend(l, function(e, t, i, n) {
			r.extend(this, n), this.uid = a.getUID("componentModel"), this.setReadOnly(["type", "id", "uid", "name",
				"mainType", "subType", "dependentModels", "componentIndex"
			])
		}), o.enableClassManagement(l, {
			registerWhenExtend: !0
		}), a.enableSubTypeDefaulter(l), a.enableTopologicalTravel(l, t), r.mixin(l, e("./mixin/boxLayout")), l
	}), t("echarts/model/globalDefault", [], function() {
		var e = "";
		return "undefined" != typeof navigator && (e = navigator.platform || ""), {
			color: ["#c23531", "#314656", "#61a0a8", "#dd8668", "#91c7ae", "#6e7074", "#61a0a8", "#bda29a", "#44525d",
				"#c4ccd3"
			],
			grid: {},
			textStyle: {
	...
	}), t("echarts/model/Global", ["require", "zrender/core/util", "./Model", "./Component", "./globalDefault"],
		function(e) {
			function t(e, t) {
				for (var i in t) x.hasClass(i) || ("object" == typeof t[i] ? e[i] = e[i] ? h.merge(e[i], t[i], !1) : h.clone(t[i]) :
					e[i] = t[i])
			}

			function i(e) {
				e = e, this.option = {}, this._componentsMap = {}, this._seriesIndices = null, t(e, this._theme.option), h.merge(
					e, _, !1), this.mergeOption(e)
			}
				...
				return p(t, function(t, r) {
					if (y(t) && t.id)
						for (var n = 0, a = e.length; a > n; n++)
							if (e[n].id === t.id) return void(i[r] = e.splice(n, 1)[0])
				}), p(t, function(t, r) {
					if (y(t) && t.name && !c(t))
						for (var n = 0, a = e.length; a > n; n++)
							if (e[n].name === t.name) return void(i[r] = e.splice(n, 1)[0])
				}), p(t, function(t, r) {
					i[r] || !e[r] || c(t) || (i[r] = e[r])
				}), i
			}
			...
			function a(e, t, i) {
				...
				return p(t, function(t, r) {
					...
					var n = e.name;
					if (e.id = i ? i.id : null != t.id ? t.id : a + [r, n, l[n]++].join("|"), s[e.id]) throw new Error(
						"id duplicates: " + e.id);
					s[e.id] = 1
				}), n
			}
				...
				b = d.extend({
					...
					findComponents: function(e) {
						...
						var r = e.query,
							n = e.mainType,
							a = t(r),
							o = a ? this.queryComponents(a) : this._componentsMap[n];
						return i(l(o, e))
					},
					eachComponent: function(e, t, i) {
						...
						else if (h.isString(e)) p(r[e], t, i);
						else if (y(e)) {
		...
		var i = e("zrender/core/util"),
			r = ["getDom", "getZr", "getWidth", "getHeight", "dispatchAction", "on", "off", "getDataURL",
				"getConnectedDataURL"
			];
		return t
		...
		return t.prototype = {
			...
			mountOption: function() {
				...
				return this._timelineOptions = c(e.timelineOptions, l), this._mediaList = c(e.mediaList, l), this._mediaDefault =
					l(e.mediaDefault), this._currentMediaIndices = [], l(e.baseOption)
			},
		...
		return o.createNameEach = function(e, t) {
			...
			var r = t && t.type;
			return "ordinal" === r ? e : ("time" !== r || isFinite(e) || null == e || "-" === e || (e = +i.parseDate(e)),
				null == e || "" === e ? NaN : +e)
		}, o.dataFormatMixin = {
			...
			getFormattedLabel: function(e, i, r) {
				...
				var n = this.getData(),
					a = n.getItemModel(e),
					o = this.getDataParams(e);
				return r || (r = a.get(["label", i, "formatter"])), "function" == typeof r ? (o.status = i, r(o)) : "string" ==
					typeof r ? t.formatTpl(r, o) : void 0
			},
	...
	}), t("echarts/model/Series", ["require", "zrender/core/util", "../util/format", "../util/model", "./Component"],
		function(e) {
			var t = e("zrender/core/util"),
				i = e("../util/format"),
				r = e("../util/model"),
				...
				s = n.extend({
					...
					init: function(e, t, i, r) {
						this.seriesIndex = this.componentIndex, this.mergeDefaultAndTheme(e, i), this._dataBeforeProcessed = this.getInitialData(
							e, i), this._data = this._dataBeforeProcessed.cloneShallow()
					},
					mergeDefaultAndTheme: function(e, i) {
						t.merge(e, i.getTheme().get(this.subType)), t.merge(e, this.getDefaultOption()), r.defaultEmphasis(e.label, [
					...
					formatTooltip: function(e, i) {
						var r = this._data,
							n = this.getRawValue(e),
							s = t.isArray(n) ? t.map(n, o).join(", ") : o(n),
							l = r.getName(e);
		...
		var i = e("../core/matrix"),
			...
			a = 5e-5,
			o = function(e) {
				e = e || {}, e.position || (this.position = [0, 0]), null == e.rotation && (this.rotation = 0), e.scale || (this
					.scale = [1, 1]), this.origin = this.origin || null
			},
			s = o.prototype;
		s.transform = null, s.needLocalTransform = function() {
			return t(this.rotation) || t(this.position[0]) || t(this.position[1]) || t(this.scale[0] - 1) || t(this.scale[1] -
				1)
			...
			var e = this.parent,
				...
				a = this.transform;
			return r || t ? (a = a || i.create(), r ? this.getLocalTransform(a) : n(a), t && (r ? i.mul(a, e.transform, a) :
				i.copy(a, e.transform)), this.transform = a, this.invTransform = this.invTransform || i.create(), void i.invert(
				this.invTransform, a)) : void(a && n(a))
			...
			var t = this.origin,
				...
				a = this.rotation,
				o = this.position;
			return t && (e[4] -= t[0], e[5] -= t[1]), i.scale(e, e, r), a && i.rotate(e, e, a), t && (e[4] += t[0], e[5] +=
				t[1]), e[4] += o[0], e[5] += o[1], e
		...
		return s.decomposeTransform = function() {
			if (this.transform) {
				...
				var n = r[0] * r[0] + r[1] * r[1],
					...
					o = this.position,
					s = this.scale;
				t(n - 1) && (n = Math.sqrt(n)), t(a - 1) && (a = Math.sqrt(a)), r[0] < 0 && (n = -n), r[3] < 0 && (a = -a), o[0] =
					r[4], o[1] = r[5], s[0] = n, s[1] = a, this.rotation = Math.atan2(-r[1] / a, r[0] / n)
			}
		...
		var e = {
			...
			exponentialInOut: function(e) {
				return 0 === e ? 0 : 1 === e ? 1 : (e *= 2) < 1 ? .5 * Math.pow(1024, e - 1) : .5 * (-Math.pow(2, -10 * (e - 1)) +
					2)
			},
			...
			elasticIn: function(e) {
				var t, i = .1,
					r = .4;
				return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1, t = r / 4) : t = r * Math.asin(1 / i) / (2 * Math.PI),
					-(i * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r)))
			},
			elasticOut: function(e) {
				var t, i = .1,
					r = .4;
				return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1, t = r / 4) : t = r * Math.asin(1 / i) / (2 * Math.PI),
					i * Math.pow(2, -10 * e) * Math.sin((e - t) * (2 * Math.PI) / r) + 1)
			},
			elasticInOut: function(e) {
				var t, i = .1,
					r = .4;
				return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1, t = r / 4) : t = r * Math.asin(1 / i) / (2 * Math.PI),
					(e *= 2) < 1 ? -.5 * (i * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r)) : i * Math.pow(
						2, -10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r) * .5 + 1)
			},
			backIn: function(e) {
				var t = 1.70158;
				return e * e * ((t + 1) * e - t)
			...
			bounceOut: function(e) {
				return 1 / 2.75 > e ? 7.5625 * e * e : 2 / 2.75 > e ? 7.5625 * (e -= 1.5 / 2.75) * e + .75 : 2.5 / 2.75 > e ?
		...
		function t(e) {
			this._target = e.target, this._life = e.life || 1e3, this._delay = e.delay || 0, this._initialized = !1, this.loop =
				null == e.loop ? !1 : e.loop, this.gap = e.gap || 0, this.easing = e.easing || "Linear", this.onframe = e.onframe,
				this.ondestroy = e.ondestroy, this.onrestart = e.onrestart
		}
		var i = e("./easing");
		return t.prototype = {
			constructor: t,
			step: function(e) {
				...
				if (!(0 > t)) {
					t = Math.min(t, 1);
					var r = this.easing,
						n = "string" == typeof r ? i[r] : r,
						a = "function" == typeof n ? n(t) : t;
					return this.fire("frame", a), 1 == t ? this.loop ? (this.restart(), "restart") : (this._needsRemove = !0,
						"destroy") : null
				}
			},
			restart: function() {
		...
		function o(e, t, i) {
			return 0 > i ? i += 1 : i > 1 && (i -= 1), 1 > 6 * i ? e + (t - e) * i * 6 : 1 > 2 * i ? t : 2 > 3 * i ? e + (t -
				e) * (2 / 3 - i) * 6 : e
		}
			...
			if (e) {
				...
				if (0 === l) t = 0, i = 0;
					...
					var u = ((s - r) / 6 + l / 2) / l,
						h = ((s - n) / 6 + l / 2) / l,
						d = ((s - a) / 6 + l / 2) / l;
					r === s ? t = d - h : n === s ? t = 1 / 3 + u - d : a === s && (t = 2 / 3 + h - u), 0 > t && (t += 1), t > 1 &&
						(t -= 1)
				}
				var p = [360 * t, i, c];
		...
		function p(e, i, r) {
			if (i && i.length && e >= 0 && 1 >= e) {
				...
				var n = e * (i.length - 1),
					...
					c = i[o],
					u = n - a;
				return r[0] = t(s(l[0], c[0], u)), r[1] = t(s(l[1], c[1], u)), r[2] = t(s(l[2], c[2], u)), r[3] = t(s(l[3], c[3],
					u)), r
			}
		}
		...
		function g(e, t) {
			if (!(2 !== e.length || e[1] < e[0])) {
				for (var i = f(e[0], t, !0), r = f(e[1], t, !0), n = [{
						color: i.color,
						offset: 0
					}], a = r.value - i.value, o = Math.max(i.value, i.rightIndex), s = Math.min(r.value, r.leftIndex), l = o; a >
					0 && s >= l; l++) n.push({
					color: t[l],
					offset: (l - i.value) / a
				});
		...
		function m(e, t, r, n) {
			return e = l(e), e ? (e = u(e), null != t && (e[0] = i(t)), null != r && (e[1] = a(r)), null != n && (e[2] = a(n)),
				y(c(e), "rgba")) : void 0
		}
		...
		function a(e, t, i, n, a) {
			var o = e.length;
			if (1 == a)
				for (var s = 0; o > s; s++) n[s] = r(e[s], t[s], i);
			else
				for (var l = e[0].length, s = 0; o > s; s++)
					for (var c = 0; l > c; c++) n[s][c] = r(e[s][c], t[s][c], i)
		}
		...
		function o(e, t, i) {
			...
			if (r !== n) {
				...
				if (a) e.length = n;
					...
					for (var o = r; n > o; o++) e.push(1 === i ? t[o] : v.call(t[o]))
			}
		}
		...
		function s(e, t, i) {
			...
			if (1 === i) {
				...
				for (var a = e[0].length, n = 0; r > n; n++)
					for (var o = 0; a > o; o++)
		...
		function l(e, t, i, r, n, a, o, s, l) {
			var u = e.length;
			if (1 == l)
				for (var h = 0; u > h; h++) s[h] = c(e[h], t[h], i[h], r[h], n, a, o);
			else
				for (var d = e[0].length, h = 0; u > h; h++)
					for (var p = 0; d > p; p++) s[h][p] = c(e[h][p], t[h][p], i[h][p], r[h][p], n, a, o)
		}
			...
			if (x) {
				...
				if (!I) {
					...
					var Z = function(e, t) {
							...
							if (0 !== o)
								if (R = (t - z[i]) / o, y)
									if (E = C[i], O = C[0 === i ? i : i - 1], q = C[i > x - 2 ? x - 1 : i + 1], B = C[i > x - 3 ? x - 1 : i + 2],
										w) l(O, E, q, B, R, R * R, R * R * R, g(e, d), A);
									else {
										var s;
										if (M) s = l(O, E, q, B, R, R * R, R * R * R, F, 1), s = h(F);
										else {
											if (S) return n(E, q, R);
							...
							else if (w) a(C[i], C[i + 1], R, g(e, d), A);
							else {
								var s;
								if (M) a(C[i], C[i + 1], R, F, 1), s = h(F);
								else {
		...
		var p = e("./Clip"),
			...
			y = function(e, r, n, a) {
				this._tracks = {}, this._target = e, this._loop = r || !1, this._getter = n || t, this._setter = a || i, this._clipCount =
		...
		return s.prototype = {
			...
			animateTo: function(e, t, i, a, o) {
				...
				r(i) ? (o = a, a = i, i = 0) : n(a) ? (o = a, a = "linear", i = 0) : n(i) ? (o = i, i = 0) : n(t) ? (o = t, t =
					500) : t || (t = 500), this.stopAnimation(), this._animateToShallow("", this, e, t, i, a, o);
			...
			_animateToShallow: function(e, t, r, n, o) {
				var s = {},
					l = 0;
				for (var c in r)
					if (null != t[c]) a(r[c]) && !i.isArrayLike(r[c]) ? this._animateToShallow(e ? e + "." + c : c, t[c], r[c], n,
						o) : (s[c] = r[c], l++);
					else if (null != r[c])
					if (e) {
						var u = {};
	...
	}), t("zrender/Element", ["require", "./core/guid", "./mixin/Eventful", "./mixin/Transformable",
		"./mixin/Animatable", "./core/util"
	], function(e) {
		var t = e("./core/guid"),
			i = e("./mixin/Eventful"),
			r = e("./mixin/Transformable"),
			n = e("./mixin/Animatable"),
			a = e("./core/util"),
			o = function(e) {
		...
		return o.prototype = {
			...
			attr: function(e, t) {
				if ("string" == typeof e) this.attrKV(e, t);
					...
					for (var i in e) e.hasOwnProperty(i) && this.attrKV(i, e[i]);
				return this.dirty(), this
			},
			setClipPath: function(e) {
				var t = this.__zr;
				t && e.addSelfToZr(t), this.clipPath && this.clipPath !== e && this.removeClipPath(), this.clipPath = e, e.__zr =
					t, e.__clipTarget = this, this.dirty()
			},
			...
			addSelfToZr: function(e) {
				...
				if (t)
					for (var i = 0; i < t.length; i++) e.animation.addAnimator(t[i]);
			...
			removeSelfFromZr: function(e) {
				...
				var t = this.animators;
				if (t)
					for (var i = 0; i < t.length; i++) e.animation.removeAnimator(t[i]);
		...
		return n.prototype = {
			...
			remove: function(e) {
				var i = this.__zr,
					...
					a = this._children,
					o = t.indexOf(a, e);
				return 0 > o ? this : (a.splice(o, 1), e.parent = null, r && (r.delFromMap(e.id), e instanceof n && e.delChildrenFromStorage(
					r)), i && i.refresh(), this)
			},
			removeAll: function() {
				var e, t, i = this._children,
					r = this.__storage;
				for (t = 0; t < i.length; t++) e = i[t], r && (r.delFromMap(e.id), e instanceof n && e.delChildrenFromStorage(
					r)), e.parent = null;
	...
	}), t("echarts/view/Component", ["require", "zrender/container/Group", "../util/component", "../util/clazz"],
		function(e) {
			var t = e("zrender/container/Group"),
				i = e("../util/component"),
				r = e("../util/clazz"),
				n = function() {
			...
			var a = n.prototype;
			return a.updateView = a.updateLayout = a.updateVisual = function(e, t, i, r) {}, r.enableClassExtend(n), r.enableClassManagement(
				n, {
					registerWhenExtend: !0
				}), n
		}), t("echarts/view/Chart", ["require", "zrender/container/Group", "../util/component", "../util/clazz"], function(
		e) {
		function t() {
		...
		function i(e, t) {
			if (e && (e.trigger(t), "group" === e.type))
				for (var r = 0; r < e.childCount(); r++) i(e.childAt(r), t)
		}
		...
		function r(e, t, r) {
			if (null != t.dataIndex) {
				...
				var a = e.indexOfName(t.name),
					n = e.getItemGraphicEl(a);
				i(n, r)
			} else e.eachItemGraphicEl(function(e) {
				i(e, r)
			})
		}
		var n = e("zrender/container/Group"),
			a = e("../util/component"),
			o = e("../util/clazz");
		t.prototype = {
			type: "chart",
		...
		return s.updateView = s.updateLayout = s.updateVisual = function(e, t, i, r) {
			this.render(e, t, i, r)
		}, o.enableClassExtend(t), o.enableClassManagement(t, {
			registerWhenExtend: !0
		}), t
		...
		i.prototype = {
			...
			bind: function(e, i) {
				...
				null != r && (e.fillStyle = r.canvasGradient ? r.canvasGradient : r), null != n && (e.strokeStyle = n.canvasGradient ?
					n.canvasGradient : n), null != this.opacity && (e.globalAlpha = this.opacity)
			},
		...
		var r = e("../../contain/text"),
			n = e("../../core/BoundingRect"),
			a = new n,
			o = function() {};
		return o.prototype = {
			constructor: o,
			drawRectText: function(e, n, o) {
				var s = this.style,
					l = s.text;
				if (null != l && (l += ""), l) {
					var c, u, h = s.textPosition,
						d = s.textDistance,
						p = s.textAlign,
						f = s.textFont || s.font,
						g = s.textBaseline;
					...
					var m = this.transform,
						v = this.invTransform;
					if (m && (a.copy(n), a.applyTransform(m), n = a, i(e, v)), h instanceof Array) c = n.x + t(h[0], n.width), u =
						n.y + t(h[1], n.height), p = p || "left", g = g || "top";
					else {
					...
					var x = s.textFill,
						_ = s.textStroke;
					x && (e.fillStyle = x), _ && (e.strokeStyle = _), e.font = f, e.shadowColor = s.textShadowColor, e.shadowBlur =
						s.textShadowBlur, e.shadowOffsetX = s.textShadowOffsetX, e.shadowOffsetY = s.textShadowOffsetY;
					for (var b = l.split("\n"), w = 0; w < b.length; w++) x && e.fillText(b[w], c, u), _ && e.strokeText(b[w], c,
						u), u += o.lineHeight;
					m && i(e, m)
				}
			}
		}, o
	}), t("zrender/graphic/Displayable", ["require", "../core/util", "./Style", "../Element", "./mixin/RectText"],
		function(e) {
			function t(e) {
				e = e || {}, n.call(this, e);
		...
		function a(e, i, r, n, a, o) {
			...
			if (t(h) && t(d))
				...
				if (t(m)) {
					...
					var z = (2 * h * l - 3 * s * d) / (2 * x(h * h * h)),
						C = Math.acos(z) / 3,
						L = x(h),
						I = Math.cos(C),
						g = (-l - 2 * L * I) / (3 * s),
						_ = (-l + L * (I + b * Math.sin(C))) / (3 * s),
		...
		function l(e, t, i, n, a, o, s, l, c, u, h) {
			var d, p, f, g, m, y = .005,
				b = 1 / 0;
			M[0] = c, M[1] = u;
			for (var w = 0; 1 > w; w += .05) S[0] = r(e, i, a, s, w), S[1] = r(t, n, o, l, w), g = v(M, S), b > g && (d = w,
				b = g);
			b = 1 / 0;
			for (var z = 0; 32 > z && !(_ > y); z++) p = d - y, f = d + y, S[0] = r(e, i, a, s, p), S[1] = r(t, n, o, l, p),
				g = v(S, M), p >= 0 && b > g ? (d = p, b = g) : (A[0] = r(e, i, a, s, f), A[1] = r(t, n, o, l, f), m = v(A, M),
					1 >= f && b > m ? (d = f, b = m) : y *= .5);
		...
		return r.fromPoints = function(e, t, i) {
			...
			y.push(e, c), x.push(t, u), p = n.apply(null, y), f = a.apply(null, y), g = n.apply(null, x), m = a.apply(null,
				x), h[0] = p, h[1] = g, d[0] = f, d[1] = m
			...
			if (l[0] = s(a) * r + e, l[1] = o(a) * n + i, c[0] = s(d) * r + e, c[1] = o(d) * n + i, m(f, l, c), v(g, l, c),
				a %= h, 0 > a && (a += h), d %= h, 0 > d && (d += h), a > d && !p ? d += h : d > a && p && (a += h), p) {
				var y = d;
				d = a, a = y
			}
			for (var x = 0; d > x; x += Math.PI / 2) x > a && (u[0] = s(x) * r + e, u[1] = o(x) * n + i, m(f, u, f), v(g, u,
				g))
		}, r
		...
		return m.prototype = {
			...
			beginPath: function(e) {
				return this._ctx = e, e && e.beginPath(), this._len = 0, this._lineDash && (this._lineDash = null, this._dashOffset =
					0), this
			},
			moveTo: function(e, t) {
				return this.addData(a.M, e, t), this._ctx && this._ctx.moveTo(e, t), this._x0 = e, this._y0 = t, this._xi = e,
					this._yi = t, this
			},
			lineTo: function(e, t) {
				return this.addData(a.L, e, t), this._ctx && (this._needsDash() ? this._dashedLineTo(e, t) : this._ctx.lineTo(
					e, t)), this._xi = e, this._yi = t, this
			},
			bezierCurveTo: function(e, t, i, r, n, o) {
				return this.addData(a.C, e, t, i, r, n, o), this._ctx && (this._needsDash() ? this._dashedBezierTo(e, t, i, r,
					n, o) : this._ctx.bezierCurveTo(e, t, i, r, n, o)), this._xi = n, this._yi = o, this
			},
			quadraticCurveTo: function(e, t, i, r) {
				return this.addData(a.Q, e, t, i, r), this._ctx && (this._needsDash() ? this._dashedQuadraticTo(e, t, i, r) :
					this._ctx.quadraticCurveTo(e, t, i, r)), this._xi = i, this._yi = r, this
			},
			arc: function(e, t, i, r, n, o) {
				return this.addData(a.A, e, t, i, i, r, n - r, 0, o ? 0 : 1), this._ctx && this._ctx.arc(e, t, i, r, n, o),
					this._xi = d(n) * i + e, this._xi = p(n) * i + e, this
			},
			...
			_dashedLineTo: function(e, t) {
				var i, r, n = this._dashSum,
					...
					v = c,
					y = o.length;
				for (d /= g, p /= g, 0 > a && (a = n + a), a %= n, m -= a * d, v -= a * p; d >= 0 && e >= m || 0 > d && m > e;)
					r = this._dashIdx, i = o[r], m += d * i, v += p * i, this._dashIdx = (r + 1) % y, d > 0 && l > m || 0 > d &&
					m > l || s[r % 2 ? "moveTo" : "lineTo"](d >= 0 ? u(m, e) : h(m, e), p >= 0 ? u(v, t) : h(v, t));
			...
			_dashedBezierTo: function(e, i, r, n, a, o) {
				var s, l, c, u, h, d = this._dashSum,
					...
					w = g.length,
					M = 0;
				for (0 > p && (p = d + p), p %= d, s = 0; 1 > s; s += .1) l = x(v, e, r, a, s + .1) - x(v, e, r, a, s), c = x(
					y, i, n, o, s + .1) - x(y, i, n, o, s), _ += f(l * l + c * c);
				for (; w > b && (M += g[b], !(M > p)); b++);
				for (s = (M - p) / _; 1 >= s;) u = x(v, e, r, a, s), h = x(y, i, n, o, s), b % 2 ? m.moveTo(u, h) : m.lineTo(u,
					h), s += g[b] / _, b = (b + 1) % w;
			...
			_dashedQuadraticTo: function(e, t, i, r) {
				var n = i,
					a = r;
				i = (i + 2 * e) / 3, r = (r + 2 * t) / 3, e = (this._xi + 2 * e) / 3, t = (this._yi + 2 * t) / 3, this._dashedBezierTo(
					e, t, i, r, n, a)
			},
			toStatic: function() {
					...
					switch (1 == g && (t = e[g], u = e[g + 1], h = t, f = u), m) {
						...
						case a.A:
							var v = e[g++],
								...
								w = e[g++] + b,
								M = (e[g++], 1 - e[g++]);
							1 == g && (h = d(b) * x + v, f = p(b) * _ + y), r.fromArc(v, y, x, _, b, w, M, l, c), t = d(w) * x + v, u =
								p(w) * _ + y;
							break;
						case a.R:
							h = t = e[g++], f = u = e[g++];
					...
					switch (r) {
						...
						case a.A:
							var n = t[i++],
								...
								g = s > l ? l / s : 1,
								m = Math.abs(s - l) > .001;
							m ? (e.translate(n, o), e.rotate(h), e.scale(f, g), e.arc(0, 0, p, c, c + u, 1 - d), e.scale(1 / f, 1 / g),
								e.rotate(-h), e.translate(-n, -o)) : e.arc(n, o, p, c, c + u, 1 - d);
							break;
						case a.R:
		...
		return {
			containStroke: function(e, t, i, r, n, a, o) {
				...
				var s = n,
					l = 0,
					c = e;
				if (o > t + s && o > r + s || t - s > o && r - s > o || a > e + s && a > i + s || e - s > a && i - s > a) return !
					1;
		...
		return {
			containStroke: function(e, i, r, n, a, o, s, l, c, u, h) {
				if (0 === c) return !1;
				var d = c;
				if (h > i + d && h > n + d && h > o + d && h > l + d || i - d > h && n - d > h && o - d > h && l - d > h || u >
					e + d && u > r + d && u > a + d && u > s + d || e - d > u && r - d > u && a - d > u && s - d > u) return !1;
		...
		return {
			containStroke: function(e, i, r, n, a, o, s, l, c) {
				if (0 === s) return !1;
				var u = s;
				if (c > i + u && c > n + u && c > o + u || i - u > c && n - u > c && o - u > c || l > e + u && l > r + u && l >
					a + u || e - u > l && r - u > l && a - u > l) return !1;
	...
	}), t("zrender/contain/path", ["require", "../core/PathProxy", "./line", "./cubic", "./quadratic", "./arc", "./util",
		"../core/curve", "./windingLine"
	], function(e) {
		function t(e, t) {
		...
		function r(e, t, r, n, a, o, s, l, c, u) {
			...
			for (var d, f, g = 0, m = -1, v = 0; h > v; v++) {
				var _ = y[v],
					b = p.cubicAt(e, r, a, s, _);
				c > b || (0 > m && (m = p.cubicExtrema(t, n, o, l, x), x[1] < x[0] && m > 1 && i(), d = p.cubicAt(t, n, o, l, x[
						0]), m > 1 && (f = p.cubicAt(t, n, o, l, x[1]))), g += 2 == m ? _ < x[0] ? t > d ? 1 : -1 : _ < x[1] ? d > f ?
					1 : -1 : f > l ? 1 : -1 : _ < x[0] ? t > d ? 1 : -1 : d > l ? 1 : -1)
			}
			return g
		}
			...
			for (var u = 0, h = 0; 2 > h; h++) {
				...
				if (p + e > o) {
					var f = Math.atan2(s, p),
						c = a ? 1 : -1;
					0 > f && (f = m + f), (f >= r && n >= f || f + m >= r && n >= f + m) && (f > Math.PI / 2 && f < 1.5 * Math.PI &&
						(c = -c), u += c)
				}
			}
			return u
				...
				switch (1 == _ && (m = e[_], v = e[_ + 1], y = m, x = v), b) {
					...
					case s.R:
						...
						var P = e[_++],
							...
							T = x + k;
						if (o) {
							if (g(y, x, I, x, i, l, d) || g(I, x, I, T, i, l, d) || g(I, T, y, T, i, l, d) || g(y, T, I, T, i, l, d))
								return !0
		...
		var s = e("../core/PathProxy").CMD,
			l = e("./line"),
			c = e("./cubic"),
			u = e("./quadratic"),
			h = e("./arc"),
			d = e("./util").normalizeRadian,
			p = e("../core/curve"),
			f = e("./windingLine"),
			g = l.containStroke,
			m = 2 * Math.PI,
	...
	}), t("zrender/graphic/Path", ["require", "./Displayable", "../core/util", "../core/PathProxy", "../contain/path",
		"./Gradient"
	], function(e) {
		function t(e) {
			var t = e.fill;
		...
		return r.prototype = {
			...
			brush: function(e) {
				...
				var r = this.style,
					...
					a = i(r),
					o = t(r);
				this.__dirtyPath && (o && r.fill instanceof l && r.fill.updateCanvasGradient(this, e), a && r.stroke instanceof l &&
					r.stroke.updateCanvasGradient(this, e)), r.bind(e, this), this.setTransform(e);
				var s = r.lineDash,
					c = r.lineDashOffset,
					u = !!e.setLineDash;
				this.__dirtyPath || s && !u && a ? (n = this.path.beginPath(e), s && !u && (n.setLineDash(s), n.setLineDashOffset(
						c)), this.buildPath(n, this.shape), this.__dirtyPath = !1) : (e.beginPath(), this.path.rebuildPath(e)), o &&
					n.fill(e), s && u && (e.setLineDash(s), e.lineDashOffset = c), a && n.stroke(e), null != r.text && this.drawRectText(
						e, this.getBoundingRect()), e.restore()
			},
			...
			getBoundingRect: function() {
				...
				if (i(t) && (this.__dirty || !this._rect)) {
					...
					n.copy(e);
					var a = t.lineWidth,
						o = t.strokeNoScale ? this.getLineScale() : 1;
					return a = Math.max(a, this.strokeContainThreshold), o > 1e-10 && (n.width += a / o, n.height += a / o, n.x -=
						a / o / 2, n.y -= a / o / 2), n
				}
				return this._rect = e, e
			},
			contain: function(e, r) {
				var n = this.transformCoordToLocal(e, r),
			...
			dirty: function(e) {
				0 === arguments.length && (e = !0), e && (this.__dirtyPath = e, this._rect = null), this.__dirty = !0, this.__zr &&
			...
			for (c = 0, u = 0; c < d.length;) {
				switch (r = d[c++], u = c, l = 0, r) {
					...
					case v:
						...
						break;
					case m:
						S[0] = d[c++], S[1] = d[c++], n(S, S, t), d[u++] = S[0], d[u++] = S[1], S[0] += d[c++], S[1] += d[c++], n(S, S,
							t), d[u++] = S[0], d[u++] = S[1]
				}
				for (h = 0; l > h; h++) {
					var S = a[h];
		...
		var i = e("../core/PathProxy").CMD,
			...
			s = Math.atan2;
		return t
	}), t("zrender/tool/path", ["require", "../graphic/Path", "../core/PathProxy", "./transformPath", "../core/matrix"],
		function(e) {
			function t(e, t, i, r, n, a, o, s, l, p, m) {
				var v = l * (d / 180),
					y = h(v) * (e - i) / 2 + u(v) * (t - r) / 2,
					x = -1 * u(v) * (e - i) / 2 + h(v) * (t - r) / 2,
					_ = y * y / (o * o) + x * x / (s * s);
				_ > 1 && (o *= c(_), s *= c(_));
				var b = (n === a ? -1 : 1) * c((o * o * (s * s) - o * o * (x * x) - s * s * (y * y)) / (o * o * (x * x) + s * s *
						(y * y))) || 0,
					w = b * o * x / s,
					M = b * -s * y / o,
					S = (e + i) / 2 + h(v) * w - u(v) * M,
					...
					L = [(-1 * y - w) / o, (-1 * x - M) / s],
					I = g(C, L);
				f(C, L) <= -1 && (I = d), f(C, L) >= 1 && (I = 0), 0 === a && I > 0 && (I -= 2 * d), 1 === a && 0 > I && (I += 2 *
					d), m.addData(p, S, A, o, s, z, I, v, a)
			}
					...
					for (; g < m.length && !isNaN(m[g]) && !isNaN(m[0]);) {
						...
						switch (f) {
							...
							case "C":
								...
								break;
							case "c":
								d = h.C, u.addData(d, m[g++] + s, m[g++] + c, m[g++] + s, m[g++] + c, m[g++] + s, m[g++] + c), s += m[g - 2],
									c += m[g - 1];
								break;
							case "S":
								y = s, x = c;
								var C = u.len(),
									L = u.data;
								n === h.C && (y += s - L[C - 4], x += c - L[C - 3]), d = h.C, A = m[g++], z = m[g++], s = m[g++], c = m[g++],
									u.addData(d, y, x, A, z, s, c);
								break;
							case "s":
								y = s, x = c;
								var C = u.len(),
									L = u.data;
								n === h.C && (y += s - L[C - 4], x += c - L[C - 3]), d = h.C, A = s + m[g++], z = c + m[g++], s += m[g++], c +=
									m[g++], u.addData(d, y, x, A, z, s, c);
								break;
							case "Q":
							...
							case "t":
								...
								var C = u.len(),
									L = u.data;
								n === h.Q && (y += s - L[C - 4], x += c - L[C - 3]), s += m[g++], c += m[g++], d = h.Q, u.addData(d, y, x, s,
									c);
								break;
							case "A":
								_ = m[g++], b = m[g++], w = m[g++], M = m[g++], S = m[g++], A = s, z = c, s = m[g++], c = m[g++], d = h.A, t(
									A, z, s, c, M, S, _, b, w, d, u);
								break;
							case "a":
								_ = m[g++], b = m[g++], w = m[g++], M = m[g++], S = m[g++], A = s, z = c, s += m[g++], c += m[g++], d = h.A,
									t(A, z, s, c, M, S, _, b, w, d, u)
						}
		...
		return {
			buildPath: function(e, t) {
				var i, r, n, a, o = t.x,
					...
					c = t.height,
					u = t.r;
				"number" == typeof u ? i = r = n = a = u : u instanceof Array ? 1 === u.length ? i = r = n = a = u[0] : 2 ===
					u.length ? (i = n = u[0], r = a = u[1]) : 3 === u.length ? (i = u[0], r = a = u[1], n = u[2]) : (i = u[0], r =
						u[1], n = u[2], a = u[3]) : i = r = n = a = 0;
				var h;
				i + r > l && (h = i + r, i *= l / h, r *= l / h), n + a > l && (h = n + a, n *= l / h, a *= l / h), r + n > c &&
					(h = r + n, r *= c / h, n *= c / h), i + a > c && (h = i + a, i *= c / h, a *= c / h), e.moveTo(o + i, s), e.lineTo(
						o + l - r, s), 0 !== r && e.quadraticCurveTo(o + l, s, o + l, s + r), e.lineTo(o + l, s + c - n), 0 !== n &&
					e.quadraticCurveTo(o + l, s + c, o + l - n, s + c), e.lineTo(o + a, s + c), 0 !== a && e.quadraticCurveTo(o, s +
						c, o, s + c - a), e.lineTo(o, s + i), 0 !== i && e.quadraticCurveTo(o, s, o + i, s)
			}
		}
	...
	}), t("zrender/graphic/Image", ["require", "./Displayable", "../core/BoundingRect", "../core/util",
		"./helper/roundRect", "../core/LRU"
	], function(e) {
		var t = e("./Displayable"),
			i = e("../core/BoundingRect"),
			r = e("../core/util"),
			n = e("./helper/roundRect"),
			a = e("../core/LRU"),
			o = new a(50),
			s = function(e) {
				t.call(this, e)
			...
			brush: function(e) {
				...
				if (t = "string" == typeof r ? this._image : r, !t && r) {
					...
					if (!a) return t = new Image, t.onload = function() {
						...
						image: t,
						pending: [this]
					}, t.src = r, o.put(r, a), void(this._image = t);
					if (t = a.image, this._image = t, !t.width || !t.height) return void a.pending.push(this)
				}
				if (t) {
					var s = i.width || t.width,
						l = i.height || t.height,
						c = i.x || 0,
						u = i.y || 0;
					if (!t.width || !t.height) return;
					if (e.save(), i.bind(e), this.setTransform(e), i.r && (e.beginPath(), n.buildPath(e, i), e.clip()), i.sWidth &&
						i.sHeight) {
						var h = i.sx || 0,
							d = i.sy || 0;
					...
					null == i.width && (i.width = s), null == i.height && (i.height = l), null != i.text && this.drawRectText(e,
						this.getBoundingRect()), e.restore()
				}
			},
			getBoundingRect: function() {
				var e = this.style;
		...
		return n.prototype = {
			...
			brush: function(e) {
				var t = this.style,
					...
					s = t.stroke;
				if (null != a && (a += ""), a) {
					e.save(), this.style.bind(e), this.setTransform(e), o && (e.fillStyle = o), s && (e.strokeStyle = s), e.font =
						t.textFont || t.font, e.textAlign = t.textAlign, e.textBaseline = t.textBaseline;
					for (var l = r.measureText("国", e.font).width, c = a.split("\n"), u = 0; u < c.length; u++) o && e.fillText(c[
						u], i, n), s && e.strokeText(c[u], i, n), n += l;
					e.restore()
				}
			},
			getBoundingRect: function() {
				if (!this._rect) {
					var e = this.style,
						t = r.getBoundingRect(e.text + "", e.textFont, e.textAlign, e.textBaseline);
		...
		return e("../Path").extend({
			...
			buildPath: function(e, t) {
				var i = t.cx,
					...
					c = Math.cos(o),
					u = Math.sin(o);
				e.moveTo(c * n + i, u * n + r), e.lineTo(c * a + i, u * a + r), e.arc(i, r, a, o, s, !l), e.lineTo(Math.cos(s) *
					n + i, Math.sin(s) * n + r), 0 !== n && e.arc(i, r, n, s, o, l), e.closePath()
			}
		})
		...
		return function(e, r) {
			...
			l = n > l ? n : l;
			for (var s = 0; l > s; s++) {
				var c, u, h, d = s / (l - 1) * (r ? n : n - 1),
					p = Math.floor(d),
					f = d - p,
					g = e[p % n];
				r ? (c = e[(p - 1 + n) % n], u = e[(p + 1) % n], h = e[(p + 2) % n]) : (c = e[0 === p ? p : p - 1], u = e[p > n -
					2 ? n - 1 : p + 1], h = e[p > n - 3 ? n - 1 : p + 2]);
				var m = f * f,
					v = f * m;
		...
		return e("../Path").extend({
			...
			buildPath: function(e, t) {
				var n = t.x1,
					...
					d = t.cpy2,
					p = t.percent;
				0 !== p && (e.moveTo(n, a), null == h || null == d ? (1 > p && (i(n, c, s, p, o), c = o[1], s = o[2], i(a, u,
					l, p, o), u = o[1], l = o[2]), e.quadraticCurveTo(c, u, s, l)) : (1 > p && (r(n, c, h, s, p, o), c = o[1],
					h = o[2], s = o[3], r(a, u, d, l, p, o), u = o[1], d = o[2], l = o[3]), e.bezierCurveTo(c, u, h, d, s, l)))
			},
			pointAt: function(e) {
				var t = this.shape,
					i = t.cpx2,
					r = t.cpy2;
				return null === i || null === r ? [n(t.x1, t.cpx1, t.x2, e), n(t.y1, t.cpy1, t.y2, e)] : [a(t.x1, t.cpx1, t.cpx1,
					t.x2, e), a(t.y1, t.cpy1, t.cpy1, t.y2, e)]
			}
		})
		...
		var t = e("../core/util"),
			...
			r = function(e, t, r, n, a) {
				this.x = null == e ? 0 : e, this.y = null == t ? 0 : t, this.x2 = null == r ? 1 : r, this.y2 = null == n ? 0 : n,
					i.call(this, a)
			};
		return r.prototype = {
			constructor: r,
			type: "linear",
			updateCanvasGradient: function(e, t) {
				for (var i = e.getBoundingRect(), r = this.x * i.width + i.x, n = this.x2 * i.width + i.x, a = this.y * i.height +
						i.y, o = this.y2 * i.height + i.y, s = t.createLinearGradient(r, a, n, o), l = this.colorStops, c = 0; c < l
					.length; c++) s.addColorStop(l[c].offset, l[c].color);
		...
		return r.prototype = {
			...
			type: "radial",
			updateCanvasGradient: function(e, t) {
				for (var i = e.getBoundingRect(), r = i.width, n = i.height, a = Math.min(r, n), o = this.x * r + i.x, s =
						this.y * n + i.y, l = this.r * a, c = t.createRadialGradient(o, s, 0, o, s, l), u = this.colorStops, h = 0; h <
					u.length; h++) c.addColorStop(u[h].offset, u[h].color);
				this.canvasGradient = c
			}
		}, t.inherits(r, i), r
	}), t("echarts/util/graphic", ["require", "zrender/core/util", "zrender/tool/path", "zrender/graphic/Path",
		"zrender/tool/color", "zrender/core/matrix", "zrender/core/vector", "zrender/graphic/Gradient",
		"zrender/container/Group", "zrender/graphic/Image", "zrender/graphic/Text", "zrender/graphic/shape/Circle",
		"zrender/graphic/shape/Sector", "zrender/graphic/shape/Polygon", "zrender/graphic/shape/Polyline",
		"zrender/graphic/shape/Rect", "zrender/graphic/shape/Line", "zrender/graphic/shape/BezierCurve",
		"zrender/graphic/shape/Arc", "zrender/graphic/LinearGradient", "zrender/graphic/RadialGradient"
	], function(e) {
		function t(e) {
			if (!e.__isHover) {
				if (e.__hoverStlDirty) {
					var t = e.style.stroke,
						i = e.style.fill,
						r = e.__hoverStl;
					r.fill = r.fill || (i instanceof y ? i : g.lift(i, -.1)), r.stroke = r.stroke || (t instanceof y ? t : g.lift(t,
						-.1));
					var n = {};
		...
		function u(e, t, i, r, n) {
			var a = e ? "Update" : "",
				o = r && r.getShallow("animationDuration" + a),
				s = r && r.getShallow("animationEasing" + a);
			r && r.getShallow("animation") ? t.animateTo(i, o, s, n) : (t.attr(i), n && n())
		}
		var h = e("zrender/core/util"),
			d = e("zrender/tool/path"),
			p = Math.round,
			f = e("zrender/graphic/Path"),
			g = e("zrender/tool/color"),
			m = e("zrender/core/matrix"),
			v = e("zrender/core/vector"),
			y = e("zrender/graphic/Gradient"),
			x = {};
		return x.Group = e("zrender/container/Group"), x.Image = e("zrender/graphic/Image"), x.Text = e(
			"zrender/graphic/Text"), x.Circle = e("zrender/graphic/shape/Circle"), x.Sector = e(
			"zrender/graphic/shape/Sector"), x.Polygon = e("zrender/graphic/shape/Polygon"), x.Polyline = e(
			"zrender/graphic/shape/Polyline"), x.Rect = e("zrender/graphic/shape/Rect"), x.Line = e(
			"zrender/graphic/shape/Line"), x.BezierCurve = e("zrender/graphic/shape/BezierCurve"), x.Arc = e(
			"zrender/graphic/shape/Arc"), x.LinearGradient = e("zrender/graphic/LinearGradient"), x.RadialGradient = e(
			"zrender/graphic/RadialGradient"), x.extendShape = function(e) {
			return f.extend(e)
		}, x.extendPath = function(e, t) {
			return d.extendFromString(e, t)
		}, x.makePath = function(e, t, i, r) {
			var n = d.createFromString(e, t),
				a = n.getBoundingRect();
			if (i) {
			...
			var t = x.subPixelOptimize,
				i = e.shape,
				r = e.style.lineWidth;
			return p(2 * i.x1) === p(2 * i.x2) && (i.x1 = i.x2 = t(i.x1, r, !0)), p(2 * i.y1) === p(2 * i.y2) && (i.y1 = i.y2 =
				t(i.y1, r, !0)), e
			...
			var t = x.subPixelOptimize,
				...
				o = i.width,
				s = i.height;
			return i.x = t(i.x, r, !0), i.y = t(i.y, r, !0), i.width = Math.max(t(n + o, r, !1) - i.x, 0 === o ? 0 : 1), i.height =
				Math.max(t(a + s, r, !1) - i.y, 0 === s ? 0 : 1), e
			...
			return a = x.applyTransform(a, t, i), Math.abs(a[0]) > Math.abs(a[1]) ? a[0] > 0 ? "right" : "left" : a[1] > 0 ?
				"bottom" : "top"
		}, x
		...
		function e(e) {
			var t = this.os = {},
				...
				c = l && e.match(/TouchPad/),
				u = e.match(/Kindle\/([\d.]+)/),
				h = e.match(/Silk\/([\d._]+)/),
				d = e.match(/(BlackBerry).*Version\/([\d.]+)/),
				p = e.match(/(BB10).*Version\/([\d.]+)/),
				f = e.match(/(RIM\sTablet\sOS)\s([\d.]+)/),
				g = e.match(/PlayBook/),
				m = e.match(/Chrome\/([\d.]+)/) || e.match(/CriOS\/([\d.]+)/),
				v = e.match(/Firefox\/([\d.]+)/),
				y = e.match(/MSIE ([\d.]+)/),
				x = r && e.match(/Mobile\//) && !m,
				_ = e.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/) && !m,
				y = e.match(/MSIE\s([\d.]+)/);
			return (i.webkit = !!r) && (i.version = r[1]), n && (t.android = !0, t.version = n[2]), s && !o && (t.ios = t.iphone = !
					0, t.version = s[2].replace(/_/g, ".")), a && (t.ios = t.ipad = !0, t.version = a[2].replace(/_/g, ".")), o &&
				(t.ios = t.ipod = !0, t.version = o[3] ? o[3].replace(/_/g, ".") : null), l && (t.webos = !0, t.version = l[2]),
				c && (t.touchpad = !0), d && (t.blackberry = !0, t.version = d[2]), p && (t.bb10 = !0, t.version = p[2]), f && (
					t.rimtabletos = !0, t.version = f[2]), g && (i.playbook = !0), u && (t.kindle = !0, t.version = u[1]), h && (i.silk = !
					0, i.version = h[1]), !h && t.android && e.match(/Kindle Fire/) && (i.silk = !0), m && (i.chrome = !0, i.version =
					m[1]), v && (i.firefox = !0, i.version = v[1]), y && (i.ie = !0, i.version = y[1]), x && (e.match(/Safari/) ||
					t.ios) && (i.safari = !0), _ && (i.webview = !0), y && (i.ie = !0, i.version = y[1]), t.tablet = !!(a || g || n &&
					!e.match(/Mobile/) || v && e.match(/Tablet/) || y && !e.match(/Phone/) && e.match(/Touch/)), t.phone = !(t.tablet ||
					t.ipod || !(n || s || l || d || p || m && e.match(/Android/) || m && e.match(/CriOS\/([\d.]+)/) || v && e.match(
						/Mobile/) || y && e.match(/Touch/))), {
					browser: i,
					os: t,
					node: !1,
		...
		function i(e, i) {
			...
			if (n) {
				...
				var s = 0,
					l = 0;
				i.pageX || i.pageY ? (s = i.pageX, l = i.pageY) : (s = i.clientX + document.body.scrollLeft + document.documentElement
					.scrollLeft, l = i.clientY + document.body.scrollTop + document.documentElement.scrollTop);
				var c = t(e),
					u = c.top + (window.pageYOffset || e.scrollTop) - (e.clientTop || 0),
		...
		return t.prototype = {
			...
			_dragStart: function(e) {
				var t = e.target;
				t && t.draggable && (this._draggingTarget = t, t.dragging = !0, this._x = e.offsetX, this._y = e.offsetY, this
					._dispatchProxy(t, "dragstart", e.event))
			},
			_drag: function(e) {
				...
				if (t) {
					...
					var o = this._findHover(i, r, t),
						s = this._dropTarget;
					this._dropTarget = o, t !== o && (s && o !== s && this._dispatchProxy(s, "dragleave", e.event), o && o !== s &&
						this._dispatchProxy(o, "dragenter", e.event))
				}
			},
			_dragEnd: function(e) {
				var t = this._draggingTarget;
				t && (t.dragging = !1), this._dispatchProxy(t, "dragend", e.event), this._dropTarget && this._dispatchProxy(
					this._dropTarget, "drop", e.event), this._draggingTarget = null, this._dropTarget = null
			}
		}, t
			...
			pinch: function(e, r) {
				...
				if (n) {
					...
					if (o && o.length > 1 && a && a.length > 1) {
						...
						var l = i(a);
						return r.pinchX = l[0], r.pinchY = l[1], {
							type: "pinch",
							target: e[0].target,
							event: r
						}
		...
		return r
	}), t("zrender/Handler", ["require", "./core/env", "./core/event", "./core/util", "./mixin/Draggable",
		"./core/GestureMgr", "./mixin/Eventful"
	], function(e) {
		function t(e) {
			return "_" + e + "Handler"
		}
		...
		var o = e("./core/env"),
			...
			y = {
				mousemove: function(e) {
					...
					var t = e.zrX,
						i = e.zrY,
						r = this._findHover(t, i, null),
						n = this._hovered;
					this._hovered = r, this.root.style.cursor = r ? r.cursor : this._defaultCursorStyle, n && r !== n && n.__zr &&
						this._dispatchProxy(n, "mouseout", e), this._dispatchProxy(r, "mousemove", e), r && r !== n && this._dispatchProxy(
							r, "mouseover", e)
				},
				mouseout: function(e) {
					e = v(this.root, e);
					...
					this._dispatchProxy(this._hovered, "mouseout", e), this.trigger("globalout", {
						event: e
					})
				},
				touchstart: function(e) {
					e = v(this.root, e), this._lastTouchMoment = new Date, r(this, e, "start"), this._mousemoveHandler(e), this._mousedownHandler(
						e)
				},
				...
				touchend: function(e) {
					e = v(this.root, e), r(this, e, "end"), this._mouseupHandler(e), +new Date - this._lastTouchMoment < f && this
						._clickHandler(e)
				}
			};
		...
		var x = function(e, i, r) {
			h.call(this), this.root = e, this.storage = i, this.painter = r, this._hovered, this._lastTouchMoment, this._lastX,
				this._lastY, this._defaultCursorStyle = "default", this._gestureMgr = new u, n(this), o.os.tablet || o.os.phone ?
				(l.each(p, function(i) {
					g(e, i, this[t(i)])
		...
		return x.prototype = {
			...
			_dispatchProxy: function(e, t, r) {
				for (var n = "on" + t, a = i(t, e, r), o = e; o && (o[n] && (a.cancelBubble = o[n].call(o, a)), o.trigger(t, a),
						o = o.parent, !a.cancelBubble););
			...
			_findHover: function(e, t, i) {
				for (var r = this.storage.getDisplayList(), n = r.length - 1; n >= 0; n--)
					if (!r[n].silent && r[n] !== i && a(r[n], e, t)) return r[n]
			}
		}, l.mixin(x, h), l.mixin(x, c), x
	}), t("zrender/Storage", ["require", "./core/util", "./container/Group"], function(e) {
		function t(e, t) {
			return e.zlevel === t.zlevel ? e.z === t.z ? e.z2 === t.z2 ? e.__renderidx - t.__renderidx : e.z2 - t.z2 : e.z -
				t.z : e.zlevel - t.zlevel
		}
		var i = e("./core/util"),
			r = e("./container/Group"),
			n = function() {
		...
		return n.prototype = {
			...
			delRoot: function(e) {
				...
				if (e instanceof Array)
					for (var t = 0, a = e.length; a > t; t++) this.delRoot(e[t]);
				else {
					var o;
		...
		var t = e("../core/util"),
			i = e("../core/event").Dispatcher,
			r = "undefined" != typeof window && (window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame ||
				window.webkitRequestAnimationFrame) || function(e) {
				setTimeout(e, 16)
			},
			n = e("./Animator"),
			a = function(e) {
				e = e || {}, this.stage = e.stage || {}, this.onframe = e.onframe || function() {}, this._clips = [], this._running = !
					1, this._time = 0, i.call(this)
			};
		return a.prototype = {
			constructor: a,
			addClip: function(e) {
			...
			_update: function() {
				for (var e = (new Date).getTime(), t = e - this._time, i = this._clips, r = i.length, n = [], a = [], o = 0; r >
					o; o++) {
					var s = i[o],
						l = s.step(e);
					l && (n.push(l), a.push(s))
		...
		function i(e, t, i, r) {
			var n = document.createElement(t),
				...
				o = i.getHeight(),
				s = n.style;
			return s.position = "absolute", s.left = 0, s.top = 0, s.width = a + "px", s.height = o + "px", n.width = a * r,
				n.height = o * r, n.setAttribute("data-zr-dom-id", e), n
		}
		var r = e("./core/util"),
			n = e("./config"),
			a = function(e, a, o) {
				var s;
				o = o || n.devicePixelRatio, "string" == typeof e ? s = i(e, "canvas", a, o) : r.isObject(e) && (s = e, e = s.id),
					this.id = e, this.dom = s;
				var l = s.style;
				l && (s.onselectstart = t, l["-webkit-user-select"] = "none", l["user-select"] = "none", l[
						"-webkit-touch-callout"] = "none", l["-webkit-tap-highlight-color"] = "rgba(0,0,0,0)"), this.domBack = null,
					this.ctxBack = null, this.painter = a, this.config = null, this.clearColor = 0, this.motionBlur = !1, this.lastFrameAlpha =
					.7, this.dpr = o
			};
		return a.prototype = {
			constructor: a,
			...
			createBackBuffer: function() {
				var e = this.dpr;
				this.domBack = i("back-" + this.id, "canvas", this.painter, e), this.ctxBack = this.domBack.getContext("2d"),
			...
			resize: function(e, t) {
				var i = this.dpr,
					...
					n = r.style,
					a = this.domBack;
				n.width = e + "px", n.height = t + "px", r.width = e * i, r.height = t * i, 1 != i && this.ctx.scale(i, i), a &&
					(a.width = e * i, a.height = t * i, 1 != i && this.ctxBack.scale(i, i))
			},
			clear: function(e) {
				var t = this.dom,
					i = this.ctx,
					...
					l = this.dpr;
				if (o && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack
						.drawImage(t, 0, 0, r / l, n / l)), i.clearRect(0, 0, r / l, n / l), a && (i.save(), i.fillStyle = this.clearColor,
						i.fillRect(0, 0, r / l, n / l), i.restore()), o) {
					var c = this.domBack;
					i.save(), i.globalAlpha = s, i.drawImage(c, 0, 0, r / l, n / l), i.restore()
				}
			}
		}, a
	}), t("zrender/Painter", ["require", "./config", "./core/util", "./core/log", "./core/BoundingRect", "./Layer",
		"./graphic/Image"
	], function(e) {
		function t(e) {
		...
		function a(e, t, i) {
			return p.copy(e.getBoundingRect()), e.transform && p.applyTransform(e.transform), f.width = t, f.height = i, !p.intersect(
				f)
		}
		...
		function s(e, t) {
			for (var i = 0; i < e.length; i++) {
				...
				var a = n.path;
				a.beginPath(t), n.buildPath(a, n.shape), t.clip(), n.transform && (r = n.invTransform, t.transform(r[0], r[1], r[
					2], r[3], r[4], r[5]))
			}
		}
		var l = e("./config"),
			...
			g = function(e, t, i) {
				...
				var n = e.style;
				if (n && (n["-webkit-tap-highlight-color"] = "transparent", n["-webkit-user-select"] = "none", n["user-select"] =
						"none", n["-webkit-touch-callout"] = "none", e.innerHTML = ""), this.storage = t, r) {
					var a = e.width,
						o = e.height;
					...
					this._domRoot = c;
					var u = c.style;
					u.position = "relative", u.overflow = "hidden", u.width = this._width + "px", u.height = this._height + "px", e
						.appendChild(c), this._layers = {}, this._zlevelList = []
				}
		...
		return g.prototype = {
			...
			_paintList: function(e, t) {
				...
				for (var p = null, f = 0, g = e.length; g > f; f++) {
					...
					if (l !== v && (l = v, i = this.getLayer(l), i.isBuildin || u("ZLevel " + l +
							" has been used by unkown layer " + i.id), c = i.ctx, i.__unusedCount = 0, (i.__dirty || t) && i.clear()),
						(i.__dirty || t) && !m.invisible && 0 !== m.style.opacity && m.scale[0] && m.scale[1] && (!m.culling || !a(m,
							h, d))) {
						var y = m.__clipPaths;
						o(y, p) && (p && c.restore(), y && (c.save(), s(y, c)), p = y), m.beforeBrush && m.beforeBrush(c), m.brush(c,
							!1), m.afterBrush && m.afterBrush(c)
					}
					m.__dirty = !1
				}
			...
			getLayer: function(e) {
				...
				return t || (t = new d("zr_" + e, this, this.dpr), t.isBuildin = !0, this._layerConfig[e] && c.merge(t, this._layerConfig[
					e], !0), this.insertLayer(e, t), t.initContext()), t
			},
			...
			resize: function(e, t) {
				var i = this._domRoot;
				if (i.style.display = "none", e = e || this._getWidth(), t = t || this._getHeight(), i.style.display = "",
			...
			_getWidth: function() {
				...
				return (e.clientWidth || t(i.width) || t(e.style.width)) - (t(i.paddingLeft) || 0) - (t(i.paddingRight) || 0) |
					0
			},
			_getHeight: function() {
				var e = this.root,
					i = document.defaultView.getComputedStyle(e);
				return (e.clientHeight || t(i.height) || t(e.style.height)) - (t(i.paddingTop) || 0) - (t(i.paddingBottom) ||
					0) | 0
			},
			_pathToImage: function(t, i, r, n, a) {
				...
				return null != l.position && (u.position = i.position = l.position), null != l.rotation && (u.rotation = i.rotation =
					l.rotation), null != l.scale && (u.scale = i.scale = l.scale), u
			},
	...
	}), t("zrender/zrender", ["require", "./core/guid", "./core/env", "./Handler", "./Storage", "./animation/Animation",
		"./Painter"
	], function(e) {
		function t(e) {
			delete c[e]
		...
		var h = function(e, t, i) {
			...
			var d = new l[h](t, u, i);
			this.storage = u, this.painter = d, r.node || (this.handler = new n(d.getViewportRoot(), u, d)), this.animation =
				new o({
					stage: {
						update: function() {
		...
		return h.prototype = {
			...
			dispose: function() {
				this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler && this.handler
		...
		var t = e("../util/graphic"),
			i = e("zrender/core/util"),
			r = Math.PI;
		return function(e, n) {
			n = n || {}, i.defaults(n, {
				text: "loading",
		...
		return function(e, i, r) {
			function n(e) {
				var n = [i, "normal", "color"],
					a = r.get("color"),
					o = e.getData(),
					s = e.get(n) || a[e.seriesIndex % a.length];
				o.setVisual("color", s), r.isSeriesFiltered(e) || ("function" != typeof s || s instanceof t || o.each(function(
					t) {
		...
		function t(e) {
			...
			t && i.each(r, function(r) {
				var n = t.normal,
					a = t.emphasis;
				n && n[r] && (e[r] = e[r] || {}, e[r].normal ? i.merge(e[r].normal, n[r]) : e[r].normal = n[r], n[r] = null),
					a && a[r] && (e[r] = e[r] || {}, e[r].emphasis ? i.merge(e[r].emphasis, a[r]) : e[r].emphasis = a[r], a[r] =
						null)
			})
		}
		var i = e("zrender/core/util"),
		...
		return function(e) {
			...
			if (r) {
				...
				var a = e.markPoint;
				if (a && a.data)
					for (var o = a.data, n = 0; n < o.length; n++) t(o[n]);
				var s = e.markLine;
				if (s && s.data)
					for (var l = s.data, n = 0; n < l.length; n++) i.isArray(l[n]) ? (t(l[n][0]), t(l[n][1])) : t(l[n])
			}
		}
		...
		var n = e("zrender/core/util"),
			...
			l = ["bar", "boxplot", "candlestick", "chord", "effectScatter", "funnel", "gauge", "lines", "graph", "heatmap",
				"line", "map", "parallel", "pie", "radar", "sankey", "scatter", "treemap"
			],
			c = n.each;
		return function(e) {
			c(e.series, function(e) {
				if (n.isObject(e)) {
					var o = e.type;
					if (a(e), ("pie" === o || "gauge" === o) && null != e.clockWise && (e.clockwise = e.clockWise), "gauge" ===
						o) {
		...
		"./model/OptionManager", "./model/Component", "./model/Series", "./view/Component", "./view/Chart",
		"./util/graphic", "zrender", "zrender/core/util", "zrender/tool/color", "zrender/core/env",
		"zrender/mixin/Eventful", "./loading/default", "./visual/seriesColor", "./preprocessor/backwardCompat",
		"echarts/util/graphic", "echarts/util/number", "echarts/util/format", "echarts/coord/geo/Geo"
	], function(e) {
		function t(e, t, i) {
		...
		function r(e, t, r) {
			r = r || {}, t && L(B, function(e) {
				...
				}), "string" == typeof t && (t = G[t]), this._theme = M.clone(t), this.Geo = C, this._chartsViews = [], this._chartsMap = {},
				this._componentsViews = [], this._componentsMap = {}, this._api = new f(this), this._coordinateSystem = new g, z
				.call(this), this._messageCenter = new i, this._initEvents(), this.resize = M.bind(this.resize, this)
		}
		...
		function o(e, t) {
			for (var i = "component" === e, r = i ? this._componentsViews : this._chartsViews, n = i ? this._componentsMap :
					this._chartsMap, a = this._zr, o = 0; o < r.length; o++) r[o].__keepAlive = !1;
			t[i ? "eachComponent" : "eachSeries"](function(e, o) {
				...
				var s = o.id + "_" + o.type,
					l = n[s];
				if (!l) {
					var c = v.parseClassType(o.type),
						u = i ? x.getClass(c.main, c.sub) : _.getClass(c.sub);
					if (!u) return;
		...
		var p = e("./model/Global"),
			f = e("./ExtensionAPI"),
			g = e("./CoordinateSystem"),
			m = e("./model/OptionManager"),
			v = e("./model/Component"),
			y = e("./model/Series"),
			x = e("./view/Component"),
			_ = e("./view/Chart"),
			b = e("./util/graphic"),
			w = e("zrender"),
			M = e("zrender/core/util"),
			S = e("zrender/tool/color"),
			A = e("zrender/core/env"),
			z = e("zrender/mixin/Eventful"),
			C = e("echarts/coord/geo/Geo"),
			L = M.each,
			I = ["echarts", "chart", "component"],
			T = ["transform", "filter", "statistic"];
		...
		D.getDom = function() {
			...
			(!this._model || t) && (this._model = new p(null, null, this._theme, new m(this._api))), this._model.setOption(e,
				B), P.prepareAndUpdate.call(this), !i && this._zr.refreshImmediately()
		}, D.setTheme = function() {
			...
			if (A.canvasSupported) {
				e = e || {}, e.pixelRatio = e.pixelRatio || 1, e.backgroundColor = e.backgroundColor || this._model.get(
					"backgroundColor");
				var t = this._zr,
			...
			if (A.canvasSupported) {
				...
				if (Z[t]) {
					...
					for (var h in F) {
						var d = F[h];
						if (d.group === t) {
							var p = d.getRenderedCanvas(M.clone(e)),
		...
		var P = {
			update: function(e) {
				var t = this._model;
				if (t) {
					t.restoreData(), s.call(this, t), l.call(this, t), this._coordinateSystem.update(t, this._api), c.call(this,
						t, e), u.call(this, t, e), h.call(this, t, e);
					...
					n.isSingleCanvas && n.isSingleCanvas() ? this._zr.configLayer(0, {
						clearColor: i
		...
		D.showLoading = function(e, t) {
			...
			if (i) {
				...
				for (var s, l = [], c = "highlight" === e.type || "downplay" === e.type, u = 0; u < a.length; u++) {
					var h = a[u];
					s = i.action(h, this._model), s = s || M.extend({}, h), s.type = r.event || s.type, l.push(s), c && P[n].call(
						this, h)
				}
		...
		return U.init = function(e, t, i) {
			if (w.version.replace(".", "") - 0 < U.dependencies.zrender.replace(".", "") - 0) throw new Error("ZRender " + w
				.version + " is too old for ECharts " + U.version + ". Current version need ZRender " + U.dependencies.zrender +
				"+");
			...
			M.isDom(e) ? e = U.getInstanceByDom(e) : "string" == typeof e && (e = F[e]), e instanceof r && !e.isDisposed() &&
				e.dispose()
			...
			var r = M.isObject(e) ? e.type : [e, e = {
				event: t
			}][0];
			e.event = (e.event || r).toLowerCase(), t = e.event, R[r] || (R[r] = {
				action: i,
				actionInfo: e
			}), O[t] = r
			...
			M.createCanvas = e
		}, U.registerVisualCoding("echarts", M.curry(e("./visual/seriesColor"), "", "itemStyle")), U.registerPreprocessor(
			e("./preprocessor/backwardCompat")), U.registerAction({
			type: "highlight",
			event: "highlight",
			update: "highlight"
			...
			event: "downplay",
			update: "downplay"
		}, M.noop), U.graphic = e("echarts/util/graphic"), U.number = e("echarts/util/number"), U.format = e(
			"echarts/util/format"), U.util = {}, L(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter",
			"bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend"
		], function(e) {
			U.util[e] = M[e]
		}), U
			...
			execute: function() {
				...
				for (var l in s)
					if (s.hasOwnProperty(l)) {
						...
						if (null == c) continue;
						if (c.length)
							for (var e = 0, u = c.length; u > e; e++) this._add && this._add(c[e]);
						else this._add && this._add(c)
					}
			}
		}, i
	}), t("echarts/data/List", ["require", "../model/Model", "./DataDiffer", "zrender/core/util", "../util/model"],
		function(e) {
			function t(e) {
				return c.isArray(e) || (e = [e]), e
			}
			var i = "undefined",
				r = "undefined" == typeof window ? global : window,
				...
				f = function(e, t) {
					...
					this.dimensions = r, this._dimensionInfos = i, this.hostModel = t, this.indices = [], this._storage = {}, this._nameList = [],
						this._idList = [], this._optionModels = [], this.stackedOn = null, this._visual = {}, this._itemVisuals = [],
						this._itemLayouts = [], this._graphicEls = [], this._rawData
				},
				g = f.prototype;
			g.type = "list", g.getDimension = function(e) {
				...
				for (var t = this.dimensions, i = this._dimensionInfos, r = 0, n = t.length; n > r; r++)
					if ("ordinal" !== i[t[r]].type && isNaN(this.get(t[r], e))) return !1;
				return !0
			}, g.getDataExtent = function(e, t) {
				var i = this._storage[e],
					r = this.getDimensionInfo(e);
				t = r && r.stackable && t;
				var n, a = (this._extent || (this._extent = {}))[e + !!t];
				if (a) return a;
				if (i) {
					for (var o = 1 / 0, s = -(1 / 0), l = 0, c = this.count(); c > l; l++) n = this.get(e, l, t), o > n && (o = n),
						n > s && (s = n);
				...
				var r = this._storage,
					n = r[e];
				if (n) {
					for (var a = Number.MAX_VALUE, o = -1, s = 0, l = e.length; l > s; s++)
				...
				for (var l = 0; l < s.length; l++)
					if (0 === o) i.call(n, l);
					else if (1 === o) i.call(n, this.get(e[0], l, r), l);
				else {
				...
				for (var u = 0; u < l.length; u++) {
					var h;
					if (1 === s) h = i.call(n, this.get(e[0], u, r), u);
					else {
				...
				var a = this.dimensions,
					o = new f(c.map(a, this.getDimensionInfo, this), this.hostModel),
			...
			g.getItemModel = function(e, t) {
				...
				return e = this.indices[e], i = t ? new s(null, r) : m, i.option = this._rawData[e], i.parentModel = r, i.ecModel =
					r.ecModel, i
			}, g.diff = function(e) {
				var t = this._idList,
					i = e && e._idList;
				...
				if (h(e))
					for (var i in e) e.hasOwnProperty(i) && this.setVisual(i, e[i]);
			...
			return g.setItemGraphicEl = function(e, t) {
				...
				t && (t.dataIndex = e, t.seriesIndex = i && i.seriesIndex, "group" === t.type && t.traverse(v, t)), this._graphicEls[
					e] = t
				...
				var e = c.map(this.dimensions, this.getDimensionInfo, this),
					t = new f(e, this.hostModel);
				return t._storage = this._storage, p(t, this, this._wrappedMethods), t.indices = this.indices.slice(), t
			}, g.wrapMethod = function(e, t) {
				var i = this[e];
				"function" == typeof i && (this._wrappedMethods = this._wrappedMethods || [], this._wrappedMethods.push(e), this[
					e] = function() {
		...
		var n = e("zrender/core/util");
		return t
	}), t("echarts/chart/helper/createListFromArray", ["require", "../../data/List",
		"../../data/helper/completeDimensions", "zrender/core/util", "../../util/model"
	], function(e) {
		function t(e) {
		...
		function r(e, t, r) {
			e = e || [];
			var n = d[t.get("coordinateSystem")](e, t, r),
				s = n.dimensions,
				l = n.categoryAxisModel,
				c = "ordinal" === s[0].type ? 0 : "ordinal" === s[1].type ? 1 : -1,
				p = new o(s, t),
				f = a(n, e),
		...
		var o = e("../../data/List"),
			s = e("../../data/helper/completeDimensions"),
			l = e("zrender/core/util"),
			c = e("../../util/model"),
			u = c.getDataItemValue,
			h = c.converDataValue,
			d = {
				cartesian2d: function(e, t, i) {
					var r = i.getComponent("xAxis", t.get("xAxisIndex")),
						a = i.getComponent("yAxis", t.get("yAxisIndex")),
						o = r.get("type"),
						l = a.get("type"),
						c = "category" === l,
						u = "category" === o,
					...
					return s(h, e, ["x", "y", "z"]), {
						dimensions: h,
						categoryAxisModel: u ? r : c ? a : null
					}
				},
				polar: function(e, t, i) {
					var r = t.get("polarIndex") || 0,
						a = function(e) {
						...
						c = "category" === l.get("type"),
						u = "category" === o.get("type"),
						h = [{
							name: "radius",
							type: c ? "ordinal" : "float",
		...
		return r
	}), t("echarts/chart/line/LineSeries", ["require", "../helper/createListFromArray", "../../model/Series"], function(
		e) {
		var t = e("../helper/createListFromArray"),
			i = e("../../model/Series");
		return i.extend({
			type: "series.line",
		...
		var t = e("./graphic"),
			...
			a = t.extendShape({
				...
				buildPath: function(e, t) {
					...
					var p = .6 * o,
						f = .7 * o;
					e.bezierCurveTo(i + u - h * p, l + s + d * p, i, r - f, i, r), e.bezierCurveTo(i, r - f, i - u + h * p, l + s +
						d * p, i - u, l + s), e.closePath()
				}
			}),
			o = t.extendShape({
				type: "arrow",
				...
				buildPath: function(e, t) {
					var i = t.height,
						...
						a = t.y,
						o = r / 3 * 2;
					e.moveTo(n, a), e.lineTo(n + o, a + i), e.lineTo(n, a + i / 4 * 3), e.lineTo(n - o, a + i), e.lineTo(n, a), e
						.closePath()
				}
			}),
			s = {
		...
		var h = t.extendShape({
				...
				beforeBrush: function() {
					var e = this.style,
						t = this.shape;
					"pin" === t.symbolType && "inside" === e.textPosition && (e.textPosition = ["50%", "40%"], e.textAlign =
						"center", e.textBaseline = "middle")
				},
				buildPath: function(e, t) {
					var i = t.symbolType,
						r = c[i];
					"none" !== t.symbolType && (r || (i = "rect", r = c[i]), l[i](t.x, t.y, t.width, t.height, r.shape), r.buildPath(
						e, r.shape))
				}
			}),
			d = function(e) {
				if ("image" !== this.type) {
					var t = this.style,
						i = this.shape;
					i && "line" === i.symbolType ? t.stroke = e : this.__isEmptyBrush ? (t.stroke = e, t.fill = "#fff") : (t.fill &&
						(t.fill = e), t.stroke && (t.stroke = e)), this.dirty()
				}
			},
			p = {
		...
		return p
	}), t("echarts/chart/helper/Symbol", ["require", "zrender/core/util", "../../util/symbol", "../../util/graphic",
		"../../util/number"
	], function(e) {
		function t(e) {
		...
		l._createSymbol = function(e, i, n) {
			...
			o.initProps(c, {
				scale: u
			}, s), this._symbolType = e, this.add(c)
			...
			var r = e.getItemVisual(i, "symbol") || "circle",
				n = e.hostModel,
				a = t(e.getItemVisual(i, "symbolSize"));
			if (r !== this._symbolType) this._createSymbol(r, e, i);
			else {
		...
		return l._updateCommon = function(e, i, r) {
			var a = this.childAt(0),
				...
				p = e.getItemModel(i),
				f = p.getModel(c),
				g = e.getItemVisual(i, "color"),
				m = p.getModel(u).getItemStyle();
			...
			var x = p.getModel(h),
				_ = p.getModel(d),
				b = e.dimensions[e.dimensions.length - 1],
				w = l.getFormattedLabel(i, "normal") || e.get(b, i),
				M = a.style;
			x.get("show") ? (o.setText(M, x, g), M.text = w) : M.text = "", _.getShallow("show") ? (o.setText(m, _, g), m.text =
				w) : m.text = "", o.setHoverStyle(a, m);
			var S = t(e.getItemVisual(i, "symbolSize"));
			if (a.off("mouseover").off("mouseout").off("emphasis").off("normal"), p.getShallow("hoverAnimation")) {
				var A = function() {
						var e = S[1] / S[0];
						this.animateTo({
							scale: [Math.max(1.1 * S[0], S[0] + 3), Math.max(1.1 * S[1], S[1] + 3 * e)]
						}, 400, "elasticOut")
					},
					z = function() {
						this.animateTo({
		...
		return a.updateData = function(e, t) {
			...
			e.diff(o).add(function(r) {
				...
				var u = o.getItemGraphicEl(c),
					h = e.getItemLayout(l);
				return i(e, l, t) ? (u ? (u.updateData(e, l), r.updateProps(u, {
					position: h
				}, a)) : (u = new s(e, l), u.attr("position", h)), n.add(u), void e.setItemGraphicEl(l, u)) : void n.remove(
					u)
			}).remove(function(e) {
		...
		function a(e, t, i, o, s, l, c, u, h) {
			...
			if (g)
				...
				for (d = 0; g > d; d++) r(f, "-", d + i);
			else
				for (p = 0; m > p; p++) r(f, "+", p + s);
			return f
		}
		...
		function i(e, i, r) {
			for (var n, a = e.getBaseAxis(), o = e.getOtherAxis(a), s = a.onZero ? 0 : o.scale.getExtent()[0], l = o.dim, c =
					"x" === l || "radius" === l ? 1 : 0, u = i.stackedOn, h = i.get(l, r); u && t(u.get(l, r)) === t(h);) {
				n = u;
				break
			}
			var d = [];
		...
		return function(e, t, n, a, o, s) {
			for (var l = t.mapArray(t.getId), c = e.mapArray(e.getId), u = [], h = [], d = [], p = [], f = [], g = [], m = [],
					v = r(c, l), y = s.dimensions, x = 0; x < v.length; x++) {
				var _ = v[x],
					b = !0;
				switch (_.cmd) {
					case "=":
						u.push(e.getItemLayout(_.idx)), h.push(t.getItemLayout(_.idx1)), d.push(n[_.idx]), p.push(a[_.idx1]), m.push(
							t.getRawIndex(_.idx1));
						break;
					case "+":
						var w = _.idx;
					...
					case "-":
						var w = _.idx,
							M = e.getRawIndex(w);
						M !== w ? (u.push(e.getItemLayout(w)), h.push(s.dataToPoint([e.get(y[0], w, !0), e.get(y[1], w, !0)])), d.push(
							n[w]), p.push(i(s, e, w)), m.push(M)) : b = !1
				}
		...
		function t(e, t, i, r, f, g, m, v, y) {
			for (var x = i, _ = 0; f > _; _++) {
				...
				if (x === i) e[g > 0 ? "moveTo" : "lineTo"](b[0], b[1]), u(d, b);
				else if (y > 0) {
					var w = x - g,
						M = x + g;
					...
					var S = t[w],
						A = t[M];
					(isNaN(A[0]) || isNaN(A[1])) && (A = b), n.sub(h, A, S), c(p, b, h, -y / 2), s(d, d, v), l(d, d, m), s(p, p, v),
						l(p, p, m), e.bezierCurveTo(d[0], d[1], p[0], p[1], b[0], b[1]), c(d, b, h, y / 2)
		...
		function i(e) {
			for (var t = [1 / 0, 1 / 0], i = [-(1 / 0), -(1 / 0)], r = 0; r < e.length; r++) {
				var n = e[r];
				n[0] < t[0] && (t[0] = n[0]), n[1] < t[1] && (t[1] = n[1]), n[0] > i[0] && (i[0] = n[0]), n[1] > i[1] && (i[1] =
					n[1])
			}
			return {
				min: t,
		...
		var r = e("zrender/graphic/Path"),
			n = e("zrender/core/vector"),
			a = Math.min,
			o = Math.max,
			s = n.min,
			l = n.max,
		...
		return {
			Polyline: r.extend({
				...
				buildPath: function(e, r) {
					for (var n = r.points, a = 0, o = n.length, s = i(n); o > a;) a += t(e, n, a, o, o, 1, s.min, s.max, r.smooth) +
						1
				}
			}),
			Polygon: r.extend({
	...
	}), t("echarts/chart/line/LineView", ["require", "zrender/core/util", "../helper/SymbolDraw", "../helper/Symbol",
		"./lineAnimationDiff", "../../util/graphic", "./poly", "../../view/Chart"
	], function(e) {
		function t(e, t) {
		...
		function a(e, t) {
			var i = e.getBaseAxis(),
				r = e.getOtherAxis(i),
				a = i.onZero ? 0 : r.scale.getExtent()[0],
				o = r.dim,
				s = "x" === o || "radius" === o ? 1 : 0;
		...
		function s(e, t, i) {
			...
			return t && (h.shape[o ? "width" : "height"] = 0, f.initProps(h, {
				shape: {
					width: c,
					height: u
				}
		...
		function l(e, t, i) {
			...
			return t && (l.shape.endAngle = -o[0] * s, f.initProps(l, {
				shape: {
					endAngle: -o[1] * s
				}
			}, i)), l
		...
		var u = e("zrender/core/util"),
			h = e("../helper/SymbolDraw"),
			d = e("../helper/Symbol"),
			p = e("./lineAnimationDiff"),
			f = e("../../util/graphic"),
			g = e("./poly"),
			m = e("../../view/Chart");
		return m.extend({
			...
			render: function(e, r, n) {
				var o = e.coordinateSystem,
					s = this.group,
					l = e.getData(),
					h = e.getModel("lineStyle.normal"),
					d = e.getModel("areaStyle.normal"),
					...
					w = a(o, l),
					M = e.get("showSymbol"),
					S = M && !f && !e.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, o),
					A = this._data;
				A && A.eachItemGraphicEl(function(e, t) {
					e.__temp && (s.remove(e), A.setItemGraphicEl(t, null))
				}), M || m.remove(), v && g.type === o.type ? (_ && x.setClipPath(c(o, !1, e)), M && m.updateData(l, S), l.eachItemGraphicEl(
					function(e) {
						e.stopAnimation(!0)
					}), t(this._stackedOnPoints, w) && t(this._points, p) || (_ ? this._updateAnimation(l, w, o, n) : (v.setShape({
					points: p
				}), y && y.setShape({
					points: p,
					stackedOnPoints: w
				}))), s.add(x)) : (M && m.updateData(l, S), v = this._newPolyline(s, p, o, _), b && (y = this._newPolygon(s,
					p, w, o, _)), x.setClipPath(c(o, !0, e))), v.setStyle(u.defaults(h.getLineStyle(), {
			...
			highlight: function(e, t, i, r) {
				...
				if (null != a && a >= 0) {
					...
					if (!s) {
						...
						s = new d(n, a, i), s.position = l, s.setZ(e.get("zlevel"), e.get("z")), s.ignore = isNaN(l[0]) || isNaN(l[
							1]), s.__temp = !0, n.setItemGraphicEl(a, s), s.stopSymbolAnimation(!0), this.group.add(s)
					}
					s.highlight()
			...
			_updateAnimation: function(e, t, i, r) {
				...
				n.shape.points = s.current, f.updateProps(n, {
					shape: {
						points: s.next
					}
				}, o), a && (a.setShape({
	...
	}), t("echarts/chart/line", ["require", "zrender/core/util", "../echarts", "./line/LineSeries", "./line/LineView",
		"../visual/symbol", "../layout/points"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../echarts");
		e("./line/LineSeries"), e("./line/LineView"), i.registerVisualCoding("chart", t.curry(e("../visual/symbol"),
			"line", "circle", "line")), i.registerLayout(t.curry(e("../layout/points"), "line"))
		...
		return r.contain = function(e) {
			...
			return e
		}, i.enableClassExtend(t), i.enableClassManagement(t, {
			registerWhenExtend: !0
		}), t
			...
			o = r.extend({
				...
				getTicks: function() {
					...
					if (e) {
						...
						i[0] < a[0] && r.push(i[0]);
						for (var o = a[0]; o <= a[1];)
							if (r.push(o), o = t.round(o + e), r.length > n) return [];
						i[1] > a[1] && r.push(i[1])
					}
					return r
				},
				...
				niceTicks: function(e) {
					...
					var i = this._extent,
						r = i[1] - i[0];
					if (!(r === 1 / 0 || 0 >= r)) {
						var o = Math.pow(10, Math.floor(Math.log(r / e) / Math.LN10)),
							s = e / r * o;
				...
				niceExtent: function(e, i, r) {
					...
					if (o[1] === -(1 / 0) && o[0] === 1 / 0) return o[1] = 1, o[0] = -1, this._niceExtent = [-1, 1], void(this._interval =
						.5);
		...
		var t = e("zrender/core/util"),
			...
			c = function(e, t) {
				...
				var r = i.parseDate(t),
					...
					c = r.getMinutes(),
					u = r.getSeconds();
				return e = e.replace("MM", l(a)).toLowerCase().replace("yyyy", n).replace("yy", n % 100).replace("dd", l(o)).replace(
					"d", o).replace("hh", l(s)).replace("h", s).replace("mm", l(c)).replace("m", c).replace("ss", l(u)).replace(
					"s", u)
			},
			u = r.extend({
				type: "time",
	...
	}), t("echarts/coord/axisHelper", ["require", "../scale/Ordinal", "../scale/Interval", "../scale/Time",
		"../scale/Log", "../scale/Scale", "../util/number", "zrender/core/util", "zrender/contain/text"
	], function(e) {
		var t = e("../scale/Ordinal"),
			i = e("../scale/Interval");
		e("../scale/Time"), e("../scale/Log");
		var r = e("../scale/Scale"),
			n = e("../util/number"),
			a = e("zrender/core/util"),
			o = e("zrender/contain/text"),
			s = {};
		return s.niceScaleExtent = function(e, t) {
			...
			if ("ordinal" !== i.type) {
				...
				var l = i.getExtent(),
					...
					u = !0,
					h = !0;
				null == r && (r = l[0] - s[0] * c, u = !1), null == o && (o = l[1] + s[1] * c, h = !1), "dataMin" === r && (r =
					l[0]), "dataMax" === o && (o = l[1]), i.setExtent(r, o), i.niceExtent(t.get("splitNumber"), u, h);
			...
			var t = e.scale.getExtent(),
				...
				n = e.model.get("min"),
				a = e.model.get("max");
			return isNaN(n) || (i = Math.min(n, i)), isNaN(a) || (r = Math.max(a, r)), !(i > 0 && r > 0 || 0 > i && 0 > r) ||
				s.ifAxisNeedsCrossZero(e)
			...
			for (var n, a = 0, s = 0, l = 0; l < e.length; l++) {
				var c = e[l],
					u = o.getBoundingRect(t[l], i, "center", "top");
				u[r ? "x" : "y"] += c, u[r ? "width" : "height"] *= 1.5, n ? n.intersect(u) ? (s++, a = Math.max(a, s)) : (n.union(
					u), s = 0) : n = u.clone()
			}
			return a
		...
		return a.prototype = {
			...
			getBands: function() {
				for (var e = this.getExtent(), t = [], i = this.scale.count(), r = e[0], n = e[1], a = n - r, o = 0; i > o; o++)
					t.push([a * o / i + r, a * (o + 1) / i + r]);
				return t
			},
		...
		return function(e) {
			var r = e.model,
				...
				a = n.get("interval");
			return "category" !== e.type || "auto" !== a ? "auto" === a ? 0 : a : i.getAxisLabelInterval(t.map(e.scale.getTicks(),
				e.dataToCoord, e), r.getFormattedLabels(), n.getModel("textStyle").getFont(), e.isHorizontal())
		}
	}), t("echarts/coord/cartesian/Axis2D", ["require", "zrender/core/util", "../Axis", "./axisLabelInterval"], function(
		e) {
		var t = e("zrender/core/util"),
			i = e("../Axis"),
	...
	}), t("echarts/coord/axisModelCreator", ["require", "./axisDefault", "zrender/core/util", "../model/Component"],
		function(e) {
			var t = e("./axisDefault"),
				i = e("zrender/core/util"),
				r = e("../model/Component"),
	...
	}), t("echarts/coord/cartesian/AxisModel", ["require", "../../model/Component", "zrender/core/util",
		"../axisModelCreator", "../axisModelCommonMixin"
	], function(e) {
		function t(e, t) {
		...
		var i = e("../../model/Component"),
			r = e("zrender/core/util"),
			n = e("../axisModelCreator"),
			a = i.extend({
				type: "cartesian2dAxis",
				axis: null,
				setNeedsCrossZero: function(e) {
					this.option.scale = !e
				},
				setMin: function(e) {
					this.option.min = e
	...
	}), t("echarts/coord/cartesian/Grid", ["require", "exports", "module", "../../util/layout", "../../coord/axisHelper",
		"zrender/core/util", "./Cartesian2D", "./Axis2D", "./GridModel", "../../CoordinateSystem"
	], function(e, t) {
		function i(e, t, i) {
		...
		function r(e) {
			for (var t, i = e.model, r = i.getFormattedLabels(), n = 0; n < r.length; n++)
				if (!e.isLabelIgnored(n)) {
		...
		return g.type = "grid", g.getRect = function() {
			...
			var n = o.getLayoutRect(e.getBoxLayoutParams(), {
				width: t.getWidth(),
				height: t.getHeight()
			});
			this._rect = n;
			...
			i(), e.get("containLabel") && (h(s, function(e) {
				if (!e.model.get("axisLabel.inside")) {
					...
					if (t) {
						...
						n[i] -= t[i] + a, "top" === e.position ? n.y += t.height + a : "left" === e.position && (n.x += t.width +
							a)
					}
				}
			}), i())
			...
			for (var r = this._axesList, n = 0; n < r.length; n++)
				if (r[n].dim === e) return r[n]
			...
			function a(r) {
				return function(n, a) {
					if (i(n, e, t)) {
						...
						"x" === r ? ("top" !== c && "bottom" !== c && (c = "bottom"), o[c] && (c = "top" === c ? "bottom" : "top")) :
							("left" !== c && "right" !== c && (c = "left"), o[c] && (c = "left" === c ? "right" : "left")), o[c] = !0;
						var h = new u(r, s.createScaleByModel(n), [0, 0], n.get("type"), c),
							d = "category" === h.type;
						h.onBand = d && n.get("boundaryGap"), h.inverse = n.get("inverse"), h.onZero = n.get("axisLine.onZero"), n.axis =
							h, h.model = n, h.index = a, this._axesList.push(h), this._axesMap[r + a] = h, l[r][a] = h, g[r]++
					}
				}
			}
			var o = {
			...
			return t.eachComponent("xAxis", a("x"), this), t.eachComponent("yAxis", a("y"), this), g.x && g.y ? (h(l.x,
				function(e, t) {
					h(l.y, function(i, r) {
						var n = "x" + t + "y" + r,
							a = new c(n);
			...
			e.eachSeries(function(n) {
				if ("cartesian2d" === n.get("coordinateSystem")) {
					var a = n.get("xAxisIndex"),
						o = n.get("yAxisIndex"),
						s = e.getComponent("xAxis", a),
			...
			return e.eachComponent("grid", function(r, a) {
				...
				if ("cartesian2d" === t.get("coordinateSystem")) {
					var r = t.get("xAxisIndex"),
						n = e.getComponent("xAxis", r),
						a = i[n.get("gridIndex")];
		...
		var t = e("../../model/Series"),
			i = e("../helper/createListFromArray");
		return t.extend({
			type: "series.bar",
			dependencies: ["grid", "polar"],
		...
		return {
			getBarItemStyle: e("../../model/mixin/makeStyleMapper")([
				["fill", "color"],
	...
	}), t("echarts/chart/bar/BarView", ["require", "zrender/core/util", "../../util/graphic", "../../model/Model",
		"./barItemStyle", "../../echarts"
	], function(e) {
		function t(e, t) {
			var i = e.width > 0 ? 1 : -1,
				r = e.height > 0 ? 1 : -1;
		...
		return i.extend(e("../../model/Model").prototype, e("./barItemStyle")), e("../../echarts").extendChartView({
			...
			_renderOnCartesian: function(e, n, a) {
				function o(n, a) {
					var o = l.getItemLayout(n),
						s = l.getItemModel(n).get(f) || 0;
					t(o, s);
					var c = new r.Rect({
						shape: i.extend({}, o)
					});
					if (p) {
						var u = c.shape,
							h = d ? "height" : "width",
							g = {};
						u[h] = 0, g[h] = o[h], r[a ? "updateProps" : "initProps"](c, {
							shape: g
						}, e)
					}
					return c
				...
				l.diff(c).add(function(e) {
					...
					a || (a = o(i, !0));
					var u = l.getItemLayout(i),
						h = l.getItemModel(i).get(f) || 0;
					t(u, h), r.updateProps(a, {
						shape: u
					}, e), l.setItemGraphicEl(i, a), s.add(a)
				}).remove(function(t) {
			...
			_updateStyle: function(e, t, n) {
				...
				t.eachItemGraphicEl(function(o, s) {
					var l = t.getItemModel(s),
						c = l.getModel("label.normal"),
						u = t.getItemVisual(s, "color"),
						h = t.getItemLayout(s),
						d = l.getModel("itemStyle.emphasis").getItemStyle();
					o.setStyle(i.defaults({
						fill: u
					...
					var p = n ? h.height > 0 ? "bottom" : "top" : h.width > 0 ? "left" : "right",
						...
						g = o.style;
					c.get("show") ? a(g, c, u, e.getFormattedLabel(s, "normal") || e.getRawValue(s), p) : g.text = "", f.get(
						"show") ? a(d, f, u, e.getFormattedLabel(s, "emphasis") || e.getRawValue(s), p) : d.text = "", r.setHoverStyle(
						o, d)
				})
			},
			remove: function(e, t) {
		...
		function i(e, i) {
			...
			n.each(e, function(e, i) {
				...
				var c = e.get("barWidth"),
					u = e.get("barMaxWidth"),
					h = e.get("barGap"),
					d = e.get("barCategoryGap");
				c && !s[l].width && (c = Math.min(o.remainedWidth, c), s[l].width = c, o.remainedWidth -= c), u && (s[l].maxWidth =
					u), null != h && (o.gap = h), null != d && (o.categoryGap = d)
			});
			var a = {};
			...
			r.eachSeriesByType(e, function(e) {
				...
				s[a] = s[a] || [], i.each(h.dim, function(e, t) {
					if (!isNaN(e)) {
						...
						var r, n, o, l, g = e >= 0 ? "p" : "n",
							m = f[t],
							v = s[a][t][g];
						h.isHorizontal() ? (r = v, n = m[1] + c, o = m[0] - v, l = u, Math.abs(o) < d && (o = (0 > o ? -1 : 1) * d),
							s[a][t][g] += o) : (r = m[0] + c, n = v, o = u, l = m[1] - v, Math.abs(l) < d && (l = (0 >= l ? -1 : 1) *
							d), s[a][t][g] += l), i.setItemLayout(t, {
							x: r,
							y: n,
							width: o,
							height: l
		...
		var n = e("zrender/core/util"),
			...
			o = a.parsePercent;
		return r
	}), t("echarts/chart/bar", ["require", "zrender/core/util", "../coord/cartesian/Grid", "./bar/BarSeries",
		"./bar/BarView", "../layout/barGrid", "../echarts"
	], function(e) {
		var t = e("zrender/core/util");
		e("../coord/cartesian/Grid"), e("./bar/BarSeries"), e("./bar/BarView");
		var i = e("../layout/barGrid"),
			r = e("../echarts");
	...
	}), t("echarts/component/axis/AxisBuilder", ["require", "zrender/core/util", "../../util/graphic",
		"../../model/Model", "../../util/number"
	], function(e) {
		function t(e, t, i) {
			var r, n, a = s(t - e.rotation);
			return l(a) ? (n = i > 0 ? "top" : "bottom", r = "center") : l(a - c) ? (n = i > 0 ? "bottom" : "top", r =
				"center") : (n = "middle", r = a > 0 && c > a ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"), {
				rotation: a,
				textAlign: r,
				textBaseline: n
			}
		...
		function i(e, t, i) {
			var r, n, a = s(-e.rotation),
				o = i[0] > i[1],
				u = "start" === t && !o || "start" !== t && o;
			return l(a - c / 2) ? (n = u ? "bottom" : "top", r = "center") : l(a - 1.5 * c) ? (n = u ? "top" : "bottom", r =
				"center") : (n = "middle", r = 1.5 * c > a && a > c / 2 ? u ? "left" : "right" : u ? "right" : "left"), {
				rotation: a,
				textAlign: r,
				textBaseline: n
			}
		}
		var r = e("zrender/core/util"),
			n = e("../../util/graphic"),
			a = e("../../model/Model"),
			o = e("../../util/number"),
			s = o.remRadian,
		...
		var h = {
				...
				axisTick: function() {
					...
					if (e.get("axisTick.show")) {
						for (var t = e.axis, i = e.getModel("axisTick"), r = this.opt, a = i.getModel("lineStyle"), o = i.get(
								"length"), s = p(i, r.labelInterval), l = t.getTicksCoords(), c = [], u = 0; u < l.length; u++)
							if (!d(t, u, s)) {
								var h = l[u];
				...
				axisLabel: function() {
					function e(e, t) {
						...
						return i && r ? (i.applyTransform(e.getLocalTransform()), r.applyTransform(t.getLocalTransform()), i.intersect(
							r)) : void 0
					}
					...
					if (i.get("axisLabel.show")) {
						...
						for (var g = t(r, f, r.labelDirection), m = i.get("data"), v = [], y = 0; y < h.length; y++)
							if (!d(o, y, r.labelInterval)) {
								var x = l;
								m && m[y] && m[y].textStyle && (x = new a(m[y].textStyle, l, i.ecModel));
								var _ = o.dataToCoord(h[y]),
									b = [_, r.labelOffset + r.labelDirection * u],
									w = new n.Text({
										style: {
											text: p[y],
				...
				axisName: function() {
					...
					if (null == a && (a = r.get("name")), a) {
						var o, s = r.get("nameLocation"),
							l = e.nameDirection,
							c = r.getModel("nameTextStyle"),
							u = r.get("nameGap") || 0,
							h = this.axisModel.axis.getExtent(),
							d = h[0] > h[1] ? -1 : 1,
							p = ["start" === s ? h[0] - d * u : "end" === s ? h[1] + d * u : (h[0] + h[1]) / 2, "middle" === s ? e.labelOffset +
								l * u : 0
							];
		...
		return u
	}), t("echarts/component/axis/AxisView", ["require", "zrender/core/util", "../../util/graphic", "./AxisBuilder",
		"../../echarts"
	], function(e) {
		function t(e, t) {
			function i(e, t) {
			...
			h.x.onZero = Math.max(Math.min(i("y"), h.x.bottom), h.x.top), h.y.onZero = Math.max(Math.min(i("x"), h.y.right),
				h.y.left), a.position = ["y" === l ? h.y[s] : u[0], "x" === l ? h.x[s] : u[3]];
			var d = {
				x: 0,
				y: 1
			};
			...
			a.labelDirection = a.tickDirection = a.nameDirection = p[o], n.onZero && (a.labelOffset = h[l][o] - h[l].onZero),
				t.getModel("axisTick").get("inside") && (a.tickDirection = -a.tickDirection), t.getModel("axisLabel").get(
					"inside") && (a.labelDirection = -a.labelDirection);
			...
			c = e("../../echarts").extendComponentView({
				...
				render: function(e, r) {
					if (this.group.removeAll(), e.get("show")) {
						var a = r.getComponent("grid", e.get("gridIndex")),
							o = t(a, e),
							c = new n(e, o);
				...
				_splitLine: function(e, t, i) {
					var n = e.axis,
						s = e.getModel("splitLine"),
						l = s.getModel("lineStyle"),
						c = l.get("width"),
						u = l.get("color"),
						h = o(s, i);
					u = u instanceof Array ? u : [u];
					for (var d = t.coordinateSystem.getRect(), p = n.isHorizontal(), f = [], g = 0, m = n.getTicksCoords(), v = [],
							y = [], x = 0; x < m.length; x++)
						if (!a(n, x, h)) {
							var _ = n.toGlobalCoord(m[x]);
							p ? (v[0] = _, v[1] = d.y, y[0] = _, y[1] = d.y + d.height) : (v[0] = d.x, v[1] = _, y[0] = d.x + d.width,
								y[1] = _);
							var b = g++ % u.length;
	...
	}), t("echarts/component/grid", ["require", "../util/graphic", "zrender/core/util", "../coord/cartesian/Grid",
		"./axis", "../echarts"
	], function(e) {
		var t = e("../util/graphic"),
			i = e("zrender/core/util");
	...
	}), t("echarts/chart/pie/PieSeries", ["require", "../../data/List", "zrender/core/util", "../../util/model",
		"../../data/helper/completeDimensions", "../helper/dataSelectableMixin", "../../echarts"
	], function(e) {
		var t = e("../../data/List"),
			i = e("zrender/core/util"),
			r = e("../../util/model"),
			n = e("../../data/helper/completeDimensions"),
			a = e("../helper/dataSelectableMixin"),
			o = e("../../echarts").extendSeriesModel({
				...
				getInitialData: function(e, i) {
					var r = n(["value"], e.data),
						a = new t(r, this);
					return a.initData(e.data), a
				},
				getDataParams: function(e) {
					var t = this._data,
						i = this.$superCall("getDataParams", e);
				...
				_defaultLabelLine: function(e) {
					...
					var t = e.labelLine.normal,
						i = e.labelLine.emphasis;
	...
	}), t("echarts/chart/pie/PieView", ["require", "../../util/graphic", "zrender/core/util", "../../view/Chart"],
		function(e) {
			function t(e, t, r, n) {
				var a = t.getData(),
					o = this.dataIndex,
			...
			function r(e, t) {
				...
				var n = new a.Sector({
					...
					o = new a.Polyline,
					s = new a.Text;
				this.add(n), this.add(o), this.add(s), this.updateData(e, t, !0), this.on("emphasis", i).on("normal", r).on(
					"mouseover", i).on("mouseout", r)
			}

			function n(e, t, i, r) {
				var n = r.getModel("textStyle"),
					a = r.get("position"),
					o = "inside" === a || "inner" === a;
				return {
			...
			var a = e("../../util/graphic"),
				o = e("zrender/core/util"),
				s = r.prototype;
			s.updateData = function(e, t, r) {
				...
				var l = this.childAt(0),
					...
					h = e.getItemLayout(t),
					d = o.extend({}, h);
				d.label = null, r ? (l.setShape(d), l.shape.endAngle = h.startAngle, a.updateProps(l, {
					shape: {
						endAngle: h.endAngle
					}
				}, c)) : a.updateProps(l, {
				...
				var p = u.getModel("itemStyle"),
					f = e.getItemVisual(t, "color");
				l.setStyle(o.defaults({
						fill: f
					}, p.getModel("normal").getItemStyle())), l.hoverStyle = p.getModel("emphasis").getItemStyle(), i(this, e.getItemLayout(
						t), u.get("selected"), c.get("selectedOffset"), c.get("animation")), l.off("mouseover").off("mouseout").off(
						"emphasis").off("normal"), u.get("hoverAnimation") && l.on("mouseover", n).on("mouseout", s).on("emphasis", n)
					.on("normal", s), this._updateLabel(e, t), a.setHoverStyle(this)
				...
				r.setStyle(n(e, t, "normal", h)), r.ignore = r.normalIgnore = !h.get("show"), r.hoverIgnore = !d.get("show"), i.ignore =
					i.normalIgnore = !p.get("show"), i.hoverIgnore = !f.get("show"), i.setStyle({
						stroke: u
					}), i.setStyle(p.getModel("lineStyle").getLineStyle()), r.hoverStyle = n(e, t, "emphasis", d), i.hoverStyle = f
					.getModel("lineStyle").getLineStyle();
				var g = p.get("smooth");
				g && g === !0 && (g = .4), i.setShape({
					smooth: g
				})
		...
		function t(e, t, i, r, n, a, o) {
			function s(t, i, r, n) {
				for (var a = t; i > a; a++)
					if (e[a].y += r, a > t && i > a + 1 && e[a + 1].y > e[a].y + e[a].height) return void l(a, r / 2);
				l(i - 1, r / 2)
			}
			...
			for (var c, u = 0, h = e.length, d = [], p = [], f = 0; h > f; f++) c = e[f].y - u, 0 > c && s(f, h, -c, n), u =
				e[f].y + e[f].height;
			0 > o - u && l(h - 1, u - o);
		...
		return function(e, t, n, a) {
			var o, s, l = e.getData(),
				...
				u = !1;
			l.each(function(i) {
				var n, a, h, d, p = l.getItemLayout(i),
					f = l.getItemModel(i),
					...
					b = Math.cos(_),
					w = Math.sin(_);
				if (o = p.cx, s = p.cy, "center" === m) n = p.cx, a = p.cy, d = "center";
				else {
				...
				var T = "middle",
					D = g.getModel("textStyle").getFont(),
					P = g.get("rotate") ? 0 > b ? -_ + Math.PI : -_ : 0,
					k = e.getFormattedLabel(i, "normal") || l.getName(i),
					V = r.getBoundingRect(k, D, d, T);
				u = !!P, p.label = {
					x: n,
					y: a,
					height: V.height,
	...
	}), t("echarts/chart/pie/pieLayout", ["require", "../../util/number", "./labelLayout", "zrender/core/util"],
		function(e) {
			var t = e("../../util/number"),
				i = t.parsePercent,
				r = e("./labelLayout"),
		...
		return function(e, t) {
			...
			i && i.length && t.eachSeriesByType(e, function(e) {
				...
				t.filterSelf(function(e) {
					for (var r = t.getName(e), n = 0; n < i.length; n++)
						if (!i[n].isSelected(r)) return !1;
					return !0
				}, this)
			}, this)
		}
	}), t("echarts/chart/pie", ["require", "zrender/core/util", "../echarts", "./pie/PieSeries", "./pie/PieView",
		"../action/createDataSelectAction", "../visual/dataColor", "./pie/pieLayout", "../processor/dataFilter"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../echarts");
		e("./pie/PieSeries"), e("./pie/PieView"), e("../action/createDataSelectAction")("pie", [{
			...
			event: "pieunselected",
			method: "unSelect"
		}]), i.registerVisualCoding("chart", t.curry(e("../visual/dataColor"), "pie")), i.registerLayout(t.curry(e(
			"./pie/pieLayout"), "pie")), i.registerProcessor("filter", t.curry(e("../processor/dataFilter"), "pie"))
	}), t("echarts/chart/scatter/ScatterSeries", ["require", "../helper/createListFromArray", "../../model/Series"],
		function(e) {
			var t = e("../helper/createListFromArray"),
				i = e("../../model/Series");
			return i.extend({
		...
		}), t("echarts/chart/helper/LargeSymbolDraw", ["require", "../../util/graphic", "../../util/symbol",
		"zrender/core/util"
	], function(e) {
		function t() {
			...
			a = i.extendShape({
				...
				buildPath: function(e, t) {
					for (var i = t.points, r = t.sizes, n = this.symbolProxy, a = n.shape, o = 0; o < i.length; o++) {
						var s = i[o],
							l = r[o];
						l[0] < 4 ? e.rect(s[0] - l[0] / 2, s[1] - l[1] / 2, l[0], l[1]) : (a.x = s[0] - l[0] / 2, a.y = s[1] - l[1] /
							2, a.width = l[0], a.height = l[1], n.buildPath(e, a))
					}
				}
			}),
			o = t.prototype;
		return o.updateData = function(e) {
			this.group.removeAll();
			var t = this._symbolEl,
				i = e.hostModel;
			t.setShape({
				points: e.mapArray(e.getItemLayout),
				sizes: e.mapArray(function(t) {
					var i = e.getItemVisual(t, "symbolSize");
					return n.isArray(i) || (i = [i, i]), i
				})
			}), t.symbolProxy = r.createSymbol(e.getVisual("symbol"), 0, 0, 0, 0), t.setColor = t.symbolProxy.setColor, t.setStyle(
	...
	}), t("echarts/chart/scatter/ScatterView", ["require", "../helper/SymbolDraw", "../helper/LargeSymbolDraw",
		"../../echarts"
	], function(e) {
		var t = e("../helper/SymbolDraw"),
			i = e("../helper/LargeSymbolDraw");
	...
	}), t("echarts/chart/scatter", ["require", "zrender/core/util", "../echarts", "./scatter/ScatterSeries",
		"./scatter/ScatterView", "../visual/symbol", "../layout/points"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../echarts");
		e("./scatter/ScatterSeries"), e("./scatter/ScatterView"), i.registerVisualCoding("chart", t.curry(e(
			"../visual/symbol"), "scatter", "circle", null)), i.registerLayout(t.curry(e("../layout/points"), "scatter"))
	...
	}), t("echarts/component/tooltip/TooltipContent", ["require", "zrender/core/util", "zrender/tool/color",
		"zrender/core/event", "../../util/format"
	], function(e) {
		function t(e) {
			var t = "cubic-bezier(0.23, 1, 0.32, 1)",
				i = "left " + e + "s " + t + ",top " + e + "s " + t;
		...
		function i(e) {
			var t = [],
				i = e.get("fontSize"),
				r = e.getTextColor();
			return r && t.push("color:" + r), t.push("font:" + e.getFont()), i && t.push("line-height:" + Math.round(3 * i /
				2) + "px"), u(["decoration", "align"], function(i) {
				var r = e.get(i);
				r && t.push("text-" + i + ":" + r)
			}), t.join(";")
		}
		...
		function r(e) {
			...
			var r = [],
				...
				l = e.get("padding");
			return n && r.push(t(n)), a && (r.push("background-Color:" + s.toHex(a)), r.push("filter:alpha(opacity=70)"), r.push(
				"background-Color:" + a)), u(["width", "color", "radius"], function(t) {
				var i = "border-" + t,
					n = h(i),
					a = e.get(n);
		...
		function n(e, t) {
			var i = document.createElement("div"),
				r = t.getZr();
			this.el = i, this._x = t.getWidth() / 2, this._y = t.getHeight() / 2, e.appendChild(i), this._container = e, this
				._show = !1, this._hideTimeout;
			var n = this;
		...
		function a(e, t) {
			...
			l.addEventListener(t, "touchstart", i), l.addEventListener(t, "touchmove", i), l.addEventListener(t, "touchend",
				i)
		}
		var o = e("zrender/core/util"),
			s = e("zrender/tool/color"),
			l = e("zrender/core/event"),
			c = e("../../util/format"),
			u = o.each,
			h = c.toCamelCase,
			d = ["", "-webkit-", "-moz-", "-o-"],
		...
		return n.prototype = {
			...
			show: function(e) {
				clearTimeout(this._hideTimeout), this.el.style.cssText = p + r(e) + ";left:" + this._x + "px;top:" + this._y +
					"px;", this._show = !0
			},
			...
			hideLater: function(e) {
				!this._show || this._inContent && this.enterable || (e ? (this._hideDelay = e, this._show = !1, this._hideTimeout =
					setTimeout(o.bind(this.hide, this), e)) : this.hide())
			},
			isShow: function() {
				return this._show
			}
		}, n
	}), t("echarts/component/tooltip/TooltipView", ["require", "./TooltipContent", "../../util/graphic",
		"zrender/core/util", "../../util/format", "../../util/number", "../../echarts"
	], function(e) {
		function t(e, t) {
			if (!e || !t) return !1;
			var i = p.round;
		...
		function s(e, t, i, r, n, s, l) {
			...
			if (s && d.applyTransform(s.transform), "function" == typeof e && (e = e([t, i], n, d)), h.isArray(e)) t = f(e[0],
				c), i = f(e[1], u);
		...
		var c = e("./TooltipContent"),
			u = e("../../util/graphic"),
			h = e("zrender/core/util"),
			d = e("../../util/format"),
			p = e("../../util/number"),
			f = p.parsePercent;
		e("../../echarts").extendComponentView({
			...
			render: function(e, t, i) {
				this.group.removeAll(), this._axisPointers = {}, this._tooltipModel = e, this._ecModel = t, this._api = i,
					this._lastHover = {};
				var r = this._tooltipContent;
				r.update(), r.enterable = e.get("enterable"), this._alwaysShowContent = e.get("alwaysShowContent"), this._seriesGroupByAxis =
					this._prepareAxisTriggerData(e, t);
				var n = this._crossText;
				n && this.group.add(n);
				var a = this._api.getZr(),
					o = this._tryShow;
				a.off("click", o), a.off("mousemove", o), a.off("mouseout", this._hide), "click" === e.get("triggerOn") ? a.on(
					"click", o, this) : (a.on("mousemove", o, this), a.on("mouseout", this._hide, this))
			},
			_manuallyShowTip: function(e) {
				if (e.from !== this.uid) {
					...
					} else a.getZr().handler.dispatch("mousemove", {
						zrX: e.x,
						zrY: e.y
					})
				}
			...
			_prepareAxisTriggerData: function(e, t) {
				...
				return t.eachSeries(function(e) {
					if (l(e)) {
						...
						"cartesian2d" === n.type ? (t = n.getBaseAxis(), r = t.dim + t.index) : (t = n.getBaseAxis(), r = t.dim +
							n.name), i[r] = i[r] || {
							coordSys: [],
							series: []
			...
			_tryShow: function(e) {
				...
				if (i)
					if (t && null != t.dataIndex) {
						var o = t.hostModel || n.getSeriesByIndex(t.seriesIndex),
							s = t.dataIndex,
							l = o.getData().getItemModel(s);
						"axis" === (l.get("tooltip.trigger") || r) ? this._showAxisTooltip(i, n, e): (this._ticket = "", this._hideAxisPointer(),
							this._resetLastHover(), this._showItemTooltipContent(o, s, e)), a.dispatchAction({
							type: "showTip",
							from: this.uid,
			...
			_showAxisTooltip: function(e, i, r) {
				...
				h.each(this._seriesGroupByAxis, function(e) {
					...
					var f = !1,
						g = this._lastHover;
					if ("cross" === a) t(g.data, u) && (f = !0), g.data = u;
					else {
						var m = h.indexOf(l, p);
						g.data === u[m] && (f = !0), g.data = u[m]
					}
					"cartesian2d" !== o.type || f ? "polar" !== o.type || f || this._showPolarPointer(n, o, p, s) : this._showCartesianPointer(
						n, o, p, s), "cross" !== a && this._showSeriesTooltipContent(o, e.series, s, u, f)
				}, this), c && this._hide()
			},
			_showCartesianPointer: function(e, t, n, a) {
				...
				if ("cross" === c) o("x", a, t.getAxis("y").getGlobalExtent()), o("y", a, t.getAxis("x").getGlobalExtent()),
					this._updateCrossText(t, a, e);
				else {
					var d = t.getAxis("x" === n ? "y" : "x"),
						p = d.getGlobalExtent();
			...
			_showPolarPointer: function(e, t, r, a) {
				function o(r, n, a) {
					...
					if ("angle" === r) {
						var c = t.coordToPoint([a[0], s[1]]),
							h = t.coordToPoint([a[1], s[1]]);
						o = i(c[0], c[1], h[0], h[1])
					} else o = {
						cx: t.cx,
						cy: t.cy,
				...
				function s(i, r, a) {
					var o, s = t.getAxis(i),
						...
						h = t.pointToCoord(r),
						d = Math.PI / 180;
					o = "angle" === i ? n(t.cx, t.cy, a[0], a[1], (-h[1] - c / 2) * d, (-h[1] + c / 2) * d) : n(t.cx, t.cy, h[0] -
						c / 2, h[0] + c / 2, 0, 2 * Math.PI);
				...
				var l = this,
					...
					d = t.getRadiusAxis(),
					p = "cross" !== c;
				if ("cross" === c) o("angle", a, d.getExtent()), o("radius", a, h.getExtent()), this._updateCrossText(t, a, e);
				else {
					var f = t.getAxis("radius" === r ? "angle" : "radius"),
						g = f.getExtent();
					("line" === c ? o : s)(r, a, g)
				}
			},
			_updateCrossText: function(e, t, i) {
				var r = i.getModel("crossStyle"),
					n = r.getModel("textStyle"),
			...
			_showSeriesTooltipContent: function(e, t, i, r, n) {
				var a = this._tooltipModel,
					...
					l = e.getBaseAxis(),
					c = r["x" === l.dim || "radius" === l.dim ? 0 : 1],
					u = h.map(t, function(e) {
						return {
				...
				if (f.payloadBatch && !n && this._api.dispatchAction({
					...
					var g, m = a.get("formatter"),
						v = a.get("position"),
						y = h.map(t, function(e, t) {
					...
					if (!n) {
						if (this._ticket = "", m) {
							if ("string" == typeof m) g = d.formatTpl(m, y);
			...
			_showItemTooltipContent: function(e, t, i) {
				...
				if (c.parentModel ? c.parentModel.parentModel = o : c.parentModel = this._tooltipModel, c.get("showContent")) {
					var u, h = c.get("formatter"),
						p = c.get("position"),
						f = e.getDataParams(t);
					if (h) {
						if ("string" == typeof h) u = d.formatTpl(h, f);
			...
			_hide: function() {
				this._hideAxisPointer(), this._resetLastHover(), this._alwaysShowContent || this._tooltipContent.hideLater(
					this._tooltipModel.get("hideDelay"))
			},
			dispose: function(e, t) {
				var i = t.getZr();
				i.off("click", this._tryShow), i.off("mousemove", this._tryShow), i.off("mouseout", this._hide), t.off(
					"showTip")
			}
		})
	}), t("echarts/component/tooltip", ["require", "./tooltip/TooltipModel", "./tooltip/TooltipView", "../echarts",
		"../echarts"
	], function(e) {
		e("./tooltip/TooltipModel"), e("./tooltip/TooltipView"), e("../echarts").registerAction({
			...
			event: "showTip",
			update: "none"
		}, function() {}), e("../echarts").registerAction({
			type: "hideTip",
			event: "hideTip",
			update: "none"
		}, function() {})
		...
		var t = e("./RadiusAxis"),
			i = e("./AngleAxis"),
			r = function(e) {
				this.name = e || "", this.cx = 0, this.cy = 0, this.dimensions = ["radius", "angle"], this._radiusAxis = new t,
		...
		return r.prototype = {
			...
			coordToPoint: function(e) {
				var t = e[0],
					...
					n = -Math.sin(i) * t + this.cy;
				return [r, n]
			}
		}, r
	}), t("echarts/coord/polar/AxisModel", ["require", "zrender/core/util", "../../model/Component",
		"../axisModelCreator", "../axisModelCommonMixin"
	], function(e) {
		function t(e, t) {
			return t.type || (t.data ? "category" : "value")
	...
	}), t("echarts/coord/polar/polarCreator", ["require", "./Polar", "../../util/number", "zrender/core/util",
		"../../coord/axisHelper", "./PolarModel", "../../CoordinateSystem"
	], function(e) {
		function t(e, t) {
			var i = e.get("center"),
				r = e.get("radius"),
		...
		function i(e, t) {
			if (e.type = t.get("type"), e.scale = s.createScaleByModel(t), e.onBand = t.get("boundaryGap") && "category" ===
				e.type, "angleAxis" === t.mainType) {
		...
		function r(e, t, i) {
			t.eachSeries(function(t) {
				if ("polar" === t.get("coordinateSystem")) {
					var i = t.get("polarIndex") || 0,
						r = e[i];
					if (!r) return;
					t.coordinateSystem = r;
					var n = r.getRadiusAxis(),
						a = r.getAngleAxis(),
						o = t.getData();
					n.scale.unionExtent(o.getDataExtent("radius", "category" !== n.type)), a.scale.unionExtent(o.getDataExtent(
						"angle", "category" !== a.type))
				}
			}), o.each(e, function(e) {
	...
	}), t("echarts/component/axis/AngleAxisView", ["require", "zrender/core/util", "../../util/graphic",
		"../../model/Model", "../../echarts"
	], function(e) {
		function t(e, t, i, r) {
			var n = e.coordToPoint([t, r]),
				a = e.coordToPoint([i, r]);
			return {
				x1: n[0],
				y1: n[1],
				x2: a[0],
		...
		e("../../echarts").extendComponentView({
			...
			render: function(e, t) {
				if (this.group.removeAll(), e.get("show")) {
					var r = t.getComponent("polar", e.get("polarIndex")),
						n = e.axis,
			...
			_axisLine: function(e, t, i, n) {
				var a = e.getModel("axisLine.lineStyle"),
					o = new r.Circle({
						shape: {
							cx: t.cx,
							cy: t.cy,
			...
			_axisLabel: function(e, t, i, a) {
				for (var o = e.axis, s = e.get("data"), l = e.getModel("axisLabel"), c = l.getModel("textStyle"), u = e.getFormattedLabels(),
						h = l.get("margin"), d = o.getLabelsCoords(), p = 0; p < i.length; p++) {
					var f = a[1],
						g = t.coordToPoint([f + h, d[p]]),
						m = t.cx,
						v = t.cy,
			...
			_splitLine: function(e, n, a, o) {
				...
				for (var h = [], d = 0; d < a.length; d++) {
					var p = u++ % c.length;
					h[p] = h[p] || [], h[p].push(new r.Line({
						shape: t(n, o[0], o[1], a[d])
					}))
				}
			...
			_splitArea: function(e, t, n, a) {
				var o = e.getModel("splitArea"),
					...
					c = 0;
				l = l instanceof Array ? l : [l];
				for (var u = [], h = Math.PI / 180, d = -n[0] * h, p = Math.min(a[0], a[1]), f = Math.max(a[0], a[1]), g = e.get(
						"clockwise"), m = 1; m < n.length; m++) {
					var v = c++ % l.length;
	...
	}), t("echarts/component/axis/RadiusAxisView", ["require", "zrender/core/util", "../../util/graphic",
		"./AxisBuilder", "../../echarts"
	], function(e) {
		function t(e, t, i) {
			return {
		...
		e("../../echarts").extendComponentView({
			...
			render: function(e, r) {
				if (this.group.removeAll(), e.get("show")) {
					var s = r.getComponent("polar", e.get("polarIndex")),
	...
	}), t("echarts/component/radiusAxis", ["require", "../coord/polar/polarCreator", "./axis/RadiusAxisView"], function(
		e) {
		e("../coord/polar/polarCreator"), e("./axis/RadiusAxisView")
	}), t("echarts/component/polar", ["require", "../coord/polar/polarCreator", "./angleAxis", "./radiusAxis",
		"../echarts"
	], function(e) {
		e("../coord/polar/polarCreator"), e("./angleAxis"), e("./radiusAxis"), e("../echarts").extendComponentView({
			type: "polar"
		})
	}), t("echarts/chart/radar/RadarSeries", ["require", "../helper/createListFromArray", "../../model/Series",
		"zrender/core/util", "../../util/number", "../../component/polar"
	], function(e) {
		var t = e("../helper/createListFromArray"),
			i = e("../../model/Series"),
			r = e("zrender/core/util"),
	...
	}), t("echarts/chart/radar/RadarView", ["require", "../helper/SymbolDraw", "../../util/graphic", "zrender/core/util",
		"../../echarts"
	], function(e) {
		var t = e("../helper/SymbolDraw"),
			i = e("../../util/graphic"),
		...
		return e("../../echarts").extendChartView({
			...
			render: function(e, t, n) {
				...
				var o = e.coordinateSystem,
					s = this.group,
					l = e.getData(),
					c = l.mapArray(l.getItemLayout, !0);
				if (!(c.length < 1)) {
					c.push(c[0].slice());
					var u = this._polygon || (this._polygon = new i.Polygon({
							shape: {
								points: []
							}
						})),
					...
					d.points.length !== c.length ? (p.points = a(), d.points = a(), i.initProps(h, f, e), i.initProps(u, f, e)) :
						(i.updateProps(h, f, e), i.updateProps(u, f, e)), this._symbolDraw.updateData(l), h.setStyle(r.extend(e.getModel(
							"lineStyle.normal").getLineStyle(), {
							stroke: l.getVisual("color")
						}));
					var g = e.getModel("areaStyle.normal");
					u.ignore = g.isEmpty(), i.setHoverStyle(h, e.getModel("lineStyle.emphasis").getLineStyle()), u.ignore || (u.setStyle(
						r.defaults(g.getAreaStyle(), {
							fill: l.getVisual("color"),
							opacity: .7
						})), i.setHoverStyle(u, e.getModel("areaStyle.emphasis").getLineStyle())), s.add(h), s.add(u), s.add(this._symbolDraw
						.group), this._data = l
				}
			}
		})
		...
		return function(e) {
			var o = e.polar,
				s = e.radiusAxis,
				l = e.angleAxis,
				c = a(e.series, function(e) {
					return "radar" === e.type
				}) || [];
			o && c.length && (r(o) || (o = [o]), s ? r(s) || (s = [s]) : s = e.radiusAxis = [], l ? r(l) || (l = [l]) : l =
				e.angleAxis = [], n(o, function(r, o) {
					if (r.indicator) {
						var u = t.map(r.indicator, function(e) {
								var t = e.min,
									i = e.max;
								return null != i && i >= 0 && (t = 0), {
									name: e.text,
									min: t,
									max: i
								}
						...
						h || (h = {
							...
							}), d.startAngle = r.startAngle || 90, r.axisLine && (d.splitLine = r.axisLine), r.axisLabel && (d.axisLabel =
								r.axisLabel), r.splitLine && (h.splitLine = r.splitLine), r.splitArea && (h.splitArea = r.splitArea), h.splitLine =
							h.splitLine || {}, h.splitArea = h.splitArea || {}, null == h.splitLine.show && (h.splitLine.show = !0),
							null == h.splitArea.show && (h.splitArea.show = !0), d.boundaryGap = !1, h.min = 0, h.max = 1, h.interval =
							1 / (r.splitNumber || 5), h.axisLine = {
								show: !1
							}, h.axisLabel = {
								show: !1
							}, h.axisTick = {
						...
						n(p, function(i) {
							if (i.indicator = u, i.data[0] && t.isArray(i.data[0].value)) {
								...
								for (var a = 0; a < n.value.length; a++)
									for (var s = 0; s < r.length; s++) f[a].push(r[s].value[a])
							}
						}), n(f, function(e, t) {
							var n = new i,
								a = 1 / 0,
	...
	}), t("echarts/chart/radar", ["require", "zrender/core/util", "../echarts", "./radar/RadarSeries",
		"./radar/RadarView", "../visual/symbol", "../layout/points", "./radar/backwardCompat"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../echarts");
		e("./radar/RadarSeries"), e("./radar/RadarView"), i.registerVisualCoding("chart", t.curry(e("../visual/symbol"),
			"radar", "circle", null)), i.registerLayout(t.curry(e("../layout/points"), "radar")), i.registerPreprocessor(e(
			"./radar/backwardCompat"))
	}), t("echarts/component/legend/LegendModel", ["require", "zrender/core/util", "../../model/Model", "../../echarts"],
		function(e) {
			var t = e("zrender/core/util"),
				i = e("../../model/Model");
		...
		var i = e("../../echarts"),
			r = e("zrender/core/util");
		i.registerAction("legendToggleSelect", "legendselectchanged", r.curry(t, "toggleSelected")), i.registerAction(
			"legendSelect", "legendselected", r.curry(t, "select")), i.registerAction("legendUnSelect", "legendunselected",
			r.curry(t, "unSelect"))
	}), t("echarts/component/helper/listComponent", ["require", "../../util/layout", "../../util/format",
		"../../util/graphic"
	], function(e) {
		function t(e, t, r) {
			i.positionGroup(e, t.getBoxLayoutParams(), {
				width: r.getWidth(),
				height: r.getHeight()
			}, t.get("padding"))
		}
		...
		return {
			...
			addBackground: function(e, t) {
				var i = r.normalizeCssArray(t.get("padding")),
					a = e.getBoundingRect(),
	...
	}), t("echarts/component/legend/LegendView", ["require", "zrender/core/util", "../../util/symbol",
		"../../util/graphic", "../helper/listComponent", "../../echarts"
	], function(e) {
		function t(e, t) {
			t.dispatchAction({
		...
		function i(e, t, i) {
			e.get("legendHoverLink") && i.dispatchAction({
				type: "highlight",
				seriesName: e.name,
				name: t
			})
		...
		return e("../../echarts").extendComponentView({
			...
			render: function(e, a, u) {
				var h = e.get("selectedMode"),
					d = e.get("itemWidth"),
					p = e.get("itemHeight"),
					f = e.get("align"),
					g = this.group;
				g.removeAll(), "auto" === f && (f = "right" === e.get("left") && "vertical" === e.get("orient") ? "right" :
					"left");
				var m = {},
					v = {};
				n.each(e.getData(), function(n) {
					...
					if (m[s] = n, y && !v[s]) {
						...
						var b = x.getVisual("legendSymbol") || "roundRect",
							w = x.getVisual("symbol"),
					...
					if (n.legendDataProvider) {
						...
						a.each(function(o) {
							...
							if (m[s] && !v[s]) {
								...
								e.isSelected(s) || (g = c);
								var y = "roundRect",
									x = this._createItem(s, m[s], e, y, null, d, p, f, g, h);
	...
	}), t("echarts/component/legend", ["require", "./legend/LegendModel", "./legend/legendAction", "./legend/LegendView",
		"../echarts", "./legend/legendFilter"
	], function(e) {
		e("./legend/LegendModel"), e("./legend/legendAction"), e("./legend/LegendView");
		var t = e("../echarts");
		t.registerProcessor("filter", e("./legend/legendFilter"))
	}), t("echarts/chart/map/MapSeries", ["require", "../../data/List", "../../echarts", "../../model/Series",
		"zrender/core/util", "../../data/helper/completeDimensions", "../../util/format", "../helper/dataSelectableMixin"
	], function(e) {
		function t(e, t) {
		...
		var i = e("../../data/List"),
			...
			n = e("../../model/Series"),
			a = e("zrender/core/util"),
			o = e("../../data/helper/completeDimensions"),
			s = e("../../util/format"),
			l = s.encodeHTML,
			c = s.addCommas,
			u = e("../helper/dataSelectableMixin"),
			h = n.extend({
				type: "series.map",
				needsDrawMap: !1,
				seriesGroup: [],
				...
				formatTooltip: function(e) {
					for (var t = this._data, i = c(this.getRawValue(e)), r = t.getName(e), n = this.seriesGroup, a = [], o = 0; o <
						n.length; o++) isNaN(n[o].getRawValue(e)) || a.push(l(n[o].name));
		...
		return r
	}), t("echarts/component/helper/RoamController", ["require", "zrender/mixin/Eventful", "zrender/core/util",
		"zrender/core/event", "./interactionMutex"
	], function(e) {
		function t(e) {
		...
		function s(e, o, s) {
			...
			l.call(this), this.enable = function(t) {
				this.disable(), null == t && (t = !0), t && "scale" !== t && (e.on("mousedown", h), e.on("mousemove", d), e.on(
					"mouseup", p)), t && "move" !== t && (e.on("mousewheel", f), e.on("pinch", g))
		...
		var l = e("zrender/mixin/Eventful"),
			c = e("zrender/core/util"),
			u = e("zrender/core/event"),
			h = e("./interactionMutex");
		return c.mixin(s, l), s
	}), t("echarts/component/helper/MapDraw", ["require", "./RoamController", "../../util/graphic", "zrender/core/util"],
		function(e) {
			function t(e, t) {
			...
			var a = e("./RoamController"),
				o = e("../../util/graphic"),
				s = e("zrender/core/util");
			return n.prototype = {
				constructor: n,
				draw: function(e, n, a, l) {
					var c = e.getData && e.getData(),
						u = e.coordinateSystem,
						h = this.group;
					h.removeAll();
					var d = u.scale;
					h.position = u.position.slice(), h.scale = d.slice();
					var p, f, g, m, v, y, x = ["itemStyle", "normal"],
						_ = ["itemStyle", "emphasis"],
						b = ["label", "normal"],
						w = ["label", "emphasis"];
					c || (p = e.getModel(x), f = e.getModel(_), g = t(p, d), m = t(f, d), v = e.getModel(b), y = e.getModel(w)), s
						.each(u.regions, function(i) {
							var r, n = new o.Group;
							if (c) {
								r = c.indexOfName(i.name);
								var a = c.getItemModel(r),
									l = c.getItemVisual(r, "color", !0);
								p = a.getModel(x), f = a.getModel(_), g = t(p, d), m = t(f, d), v = a.getModel(b), y = a.getModel(w), l &&
									(g.fill = l)
							}
							...
							var S = v.get("show"),
								A = y.get("show"),
								z = c && isNaN(c.get("value", r)),
								C = c && c.getItemLayout(r);
							if (!c || z && (S || A) || C && C.showLabel) {
								var L = c ? r : i.name,
									I = e.getFormattedLabel(L, "normal"),
									T = e.getFormattedLabel(L, "emphasis"),
									D = new o.Text({
										style: {
											text: S ? I || i.name : "",
											fill: u.getTextColor(),
		...
		}), t("echarts/chart/map/MapView", ["require", "../../util/graphic", "../../component/helper/MapDraw",
		"../../echarts"
	], function(e) {
		var t = e("../../util/graphic"),
			i = e("../../component/helper/MapDraw");
		e("../../echarts").extendChartView({
			type: "map",
		...
		r.registerAction(n, function(e, r) {
			...
			r.eachComponent(n, function(r) {
				if (r.name === e.name) {
					...
					var o = r.getModel("roamDetail"),
						s = i.calcPanAndZoom(o, e);
					r.setRoamPan && r.setRoamPan(s.x, s.y), r.setRoamZoom && r.setRoamZoom(s.zoom), a && a.setPan(s.x, s.y), a &&
						a.setZoom(s.zoom), "series" === n && t.each(r.seriesGroup, function(e) {
		...
		i.extend({
			...
			coordinateSystem: null,
			init: function(e) {
				i.prototype.init.apply(this, arguments), t.defaultEmphasis(e.label, ["position", "show", "textStyle",
					"distance", "formatter"
				])
			},
			defaultOption: {
			...
			getFormattedLabel: function(e, t) {
				...
				return "function" == typeof i ? (r.status = t, i(r)) : "string" == typeof i ? i.replace("{a}", r.seriesName) :
					void 0
			},
			setRoamZoom: function(e) {
				var t = this.option.roamDetail;
	...
	}), t("echarts/coord/geo/Region", ["require", "zrender/contain/polygon", "zrender/core/BoundingRect",
		"zrender/core/bbox", "zrender/core/vector"
	], function(e) {
		function t(e, t, i) {
			if (this.name = e, this.contours = t, i) i = [i[0], i[1]];
			else {
		...
		var i = e("zrender/contain/polygon"),
			r = e("zrender/core/BoundingRect"),
			n = e("zrender/core/bbox"),
		...
		return t.prototype = {
			...
			getBoundingRect: function() {
				var e = this._rect;
				if (e) return e;
				for (var t = Number.MAX_VALUE, i = [t, t], o = [-t, -t], s = [], l = [], c = this.contours, u = 0; u < c.length; u++)
					n.fromPoints(c[u], s, l), a.min(i, i, s), a.max(o, o, l);
			...
			contain: function(e) {
				...
				if (t.contain(e[0], e[1]))
					for (var n = 0, a = r.length; a > n; n++)
						if (i.contain(r[n], e[0], e[1])) return !0;
				return !1
			},
			transformTo: function(e, t, i, n) {
				var o = this.getBoundingRect(),
					s = o.width / o.height;
				i ? n || (n = i / s) : i = s * n;
				for (var l = new r(e, t, i, n), c = o.calculateTransform(l), u = this.contours, h = 0; h < u.length; h++)
					for (var d = 0; d < u[h].length; d++) a.applyTransform(u[h][d], u[h][d], c);
		...
		function t(e) {
			...
			for (var t = e.features, r = 0; r < t.length; r++)
				for (var n = t[r], a = n.geometry, o = a.coordinates, s = a.encodeOffsets, l = 0; l < o.length; l++) {
					var c = o[l];
					if ("Polygon" === a.type) o[l] = i(c, s[l]);
		...
		function i(e, t) {
			for (var i = [], r = t[0], n = t[1], a = 0; a < e.length; a += 2) {
				var o = e.charCodeAt(a) - 64,
					s = e.charCodeAt(a + 1) - 64;
		...
		function r(e) {
			for (var t = [], i = 0; i < e.length; i++)
				for (var r = 0; r < e[i].length; r++) t.push(e[i][r]);
			return t
		}
		var n = e("zrender/core/util"),
			a = e("./Region");
	...
	}), t("echarts/coord/View", ["require", "zrender/core/vector", "zrender/core/matrix", "zrender/mixin/Transformable",
		"zrender/core/util", "zrender/core/BoundingRect"
	], function(e) {
		function t() {
			a.call(this)
		}
		...
		var r = e("zrender/core/vector"),
			n = e("zrender/core/matrix"),
			a = e("zrender/mixin/Transformable"),
			o = e("zrender/core/util"),
			s = e("zrender/core/BoundingRect"),
			l = r.applyTransform;
		return o.mixin(t, a), i.prototype = {
			constructor: i,
			type: "view",
			setBoundingRect: function(e, t, i, r) {
			...
			_updateTransform: function() {
				var e = this._roamTransform,
					t = this._viewTransform;
				t.parent = e, e.updateTransform(), t.updateTransform(), t.transform && n.copy(this.transform || (this.transform = []),
		...
		for (var t = e("../Region"), i = [126, 25], r = [
			...
			for (var a = 0; a < r[n].length; a++) r[n][a][0] /= 10.5, r[n][a][1] /= -14, r[n][a][0] += i[0], r[n][a][1] += i[
				1];
		return function(e) {
	...
	}), t("echarts/coord/geo/Geo", ["require", "./parseGeoJson", "zrender/core/util", "zrender/core/BoundingRect",
		"../View", "./fix/nanhai", "./fix/textCoord", "./fix/geoCoord"
	], function(e) {
		function t(e, t, i, r, n) {
			a.call(this, e), this.map = t, this.dimensions = ["lng", "lat"], this._nameCoordMap = {}, this.loadGeoJson(i, r,
				n)
		}
		var i = e("./parseGeoJson"),
			r = e("zrender/core/util"),
			n = e("zrender/core/BoundingRect"),
			a = e("../View"),
			o = [e("./fix/nanhai"), e("./fix/textCoord"), e("./fix/geoCoord")];
		return t.prototype = {
			constructor: t,
			type: "geo",
			loadGeoJson: function(e, t, n) {
				try {
					this.regions = e ? i(e) : []
				} catch (a) {
	...
	}), t("echarts/coord/geo/geoCreator", ["require", "./GeoModel", "./Geo", "../../util/layout", "zrender/core/util",
		"../../echarts"
	], function(e) {
		function t(e, t) {
			var i = this.getBoundingRect(),
				r = e.getBoxLayoutParams();
			r.aspect = i.width / i.height * .75;
			var a = n.getLayoutRect(r, {
				width: t.getWidth(),
				height: t.getHeight()
			});
			this.setViewRect(a.x, a.y, a.width, a.height);
			var o = e.getModel("roamDetail"),
				s = o.get("x") || 0,
				l = o.get("y") || 0,
				c = o.get("zoom") || 1;
		...
		var r = e("./Geo"),
			...
			s = {
				...
				registerMap: function(e, t, i) {
					t.geoJson && !t.features && (i = t.specialAreas, t = t.geoJson), "string" == typeof t && (t = "undefined" !=
						typeof JSON && JSON.parse ? JSON.parse(t) : new Function("return (" + t + ");")()), o[e] = {
						geoJson: t,
						specialAreas: i
					}
				},
		...
		function t(e, t) {
			...
			return e[0].map(r, function(r, n) {
				for (var a = e[0].getName(n), o = 0, s = 1 / 0, l = -(1 / 0), c = i[a].length, u = 0; c > u; u++) s = Math.min(
					s, i[a][u]), l = Math.max(l, i[a][u]), o += i[a][u];
				var h;
		...
		var i = e("zrender/core/util"),
			r = ["x", "y", "x2", "y2", "width", "height", "map", "roam", "roamDetail", "label", "itemStyle"],
			n = {};
		return function(e) {
			var r = [];
				...
				if (r.map = r.map || r.mapType, i.defaults(r, r.mapLocation), r.markPoint) {
					...
					if (o.data = i.map(o.data, function(e) {
						...
						l.type = e.effect && e.effect.show ? "effectScatter" : "scatter", l.coordinateSystem = "geo", l.geoIndex =
							i.indexOf(e.geo, s), l.name = r.name, e.series.splice(i.indexOf(e.series, r), 1, l)
					}
				}
			})
		}
	}), t("echarts/chart/map", ["require", "../echarts", "./map/MapSeries", "./map/MapView", "../action/geoRoam",
		"../coord/geo/geoCreator", "./map/mapSymbolLayout", "./map/mapVisual", "./map/mapDataStatistic",
		"./map/backwardCompat", "../action/createDataSelectAction"
	], function(e) {
		var t = e("../echarts");
		e("./map/MapSeries"), e("./map/MapView"), e("../action/geoRoam"), e("../coord/geo/geoCreator"), t.registerLayout(e(
			"./map/mapSymbolLayout")), t.registerVisualCoding("chart", e("./map/mapVisual")), t.registerProcessor(
			"statistic", e("./map/mapDataStatistic")), t.registerPreprocessor(e("./map/backwardCompat")), e(
			"../action/createDataSelectAction")("map", [{
			type: "mapToggleSelect",
	...
	}), t("echarts/data/Tree", ["require", "zrender/core/util", "../model/Model", "./List", "./helper/linkList",
		...
		var r = e("zrender/core/util"),
			...
			a = e("./List"),
			o = e("./helper/linkList"),
			s = e("./helper/completeDimensions"),
			l = function(e, t, i) {
				this.name = e || "", this.depth = 0, this.height = 0, this.parentNode = null, this.dataIndex = null == t ? -1 :
					t, this.children = [], this.viewChildren = [], this.hostTree = i
			};
		return l.prototype = {
			constructor: l,
			isRemoved: function() {
			...
			eachNode: function(e, t, i) {
				"function" == typeof e && (i = t, t = e, e = null), e = e || {}, r.isString(e) && (e = {
					order: e
				});
				var n, a = e.order || "preorder",
			...
			function c(e, t) {
				...
				var n = e.children;
				if (n)
					for (var a = 0; a < n.length; a++) c(n[a], r)
			}
			var u = new t(r, n),
				h = [];
	...
	}), t("echarts/chart/treemap/TreemapSeries", ["require", "../../model/Series", "../../data/Tree",
		"zrender/core/util", "../../model/Model", "../../util/format"
	], function(e) {
		function t(e, i) {
			var r = 0;
			...
			var n = e.value;
			i >= 0 && (a.isArray(n) ? n = n[0] : e.value = new Array(i)), (null == n || isNaN(n)) && (n = r), 0 > n && (n = 0),
				i >= 0 ? e.value[0] = n : e.value = n
		}
		...
		return r.extend({
			...
			getViewRoot: function() {
				var e = this.option.root,
					t = this.getData().tree.root;
				return e && t.getNodeById(e) || t
			},
			formatTooltip: function(e) {
				var t = this.getData(),
					i = this.getRawValue(e),
					r = c(a.isArray(i) ? i[0] : i),
					n = t.getName(e);
				return l(n) + ": " + r
			},
			getDataParams: function(e) {
				for (var t = r.prototype.getDataParams.apply(this, arguments), i = this.getData(), n = i.tree.getNodeByDataIndex(
						e), a = t.treePathInfo = []; n;) {
					var o = n.dataIndex;
					a.push({
						name: n.name,
						dataIndex: o,
						value: this.getRawValue(o)
					}), n = n.parentNode
				}
				return a.reverse(), t
			},
		...
		var t = {
			retrieveTargetInfo: function(e, t) {
				if (e && "treemapZoomToNode" === e.type) {
					var i = t.getData().tree.root,
						r = e.targetNode;
					if (r && i.contains(r)) return {
						node: r
					};
					var n = e.targetNodeId;
					return null != n && (r = i.getNodeById(n)) ? {
						node: r
					} : null
				}
			}
		...
		return t
	}), t("echarts/chart/treemap/Breadcrumb", ["require", "../../util/graphic", "../../util/layout", "zrender/core/util"],
		function(e) {
			function t(e, t) {
			...
			return t.prototype = {
				...
				_renderContent: function(e, t, o, l, c) {
					for (var u = 0, h = o.emptyItemWidth, d = e.get("height"), p = n.getAvailableSize(o.pos, o.box), f = o.totalWidth,
							g = o.renderList, m = g.length - 1; m >= 0; m--) {
						var v = g[m],
							y = v.width,
							x = v.text;
						f > p.width && (f -= y - h, y = h, x = ""), this.group.add(new r.Polygon({
							shape: {
								points: i(u, 0, y, d, m === g.length - 1, 0 === m)
							},
	...
	}), t("echarts/chart/treemap/TreemapView", ["require", "zrender/core/util", "../../util/graphic",
		"../../data/DataDiffer", "./helper", "./Breadcrumb", "../../component/helper/RoamController",
		"zrender/core/BoundingRect", "zrender/core/matrix", "../../util/animation", "../../echarts"
	], function(e) {
		function t() {
			return {
				nodeGroup: [],
		...
		var i = e("zrender/core/util"),
			...
			l = e("zrender/core/BoundingRect"),
			c = e("zrender/core/matrix"),
			u = e("../../util/animation"),
			h = i.bind,
			d = r.Group,
			p = r.Rect,
		...
		return e("../../echarts").extendChartView({
			type: "treemap",
			init: function(e, i) {
				this._containerGroup, this._storage = t(), this._oldTree, this._breadcrumb, this._controller, this._state =
					"ready", this._mayClick
			},
			render: function(e, t, r, n) {
				...
				if (!(i.indexOf(o, e) < 0)) {
					...
					c || s && "treemapZoomToNode" !== s ? h.renderFinally() : this._doAnimation(u, h, e), this._resetController(
						r);
			...
			_giveContainerGroup: function(e) {
				...
				return t || (t = this._containerGroup = new d, this._initEvents(t), this.group.add(t)), t.position = [e.x, e.y],
					t
			},
			_doRender: function(e, r) {
				...
				var l = r.getData().tree,
					...
					m = [],
					v = [],
					y = h(this._renderNode, this, d, p, u, g, m),
					x = r.getViewRoot();
			...
			_renderNode: function(e, t, r, n, a, o, s, l) {
				...
				function h(e, t, i) {
					if ("background" === i) t.invisible = !0, t.__tmWillVisible = !0, a.push(t);
					else {
						var n, s = o.parentNode,
							l = 0,
							c = 0;
				...
				if (o) {
					...
					if (b) {
						...
						w && (w.setShape({
							...
							fill: o.getVisual("borderColor", !0)
						}), b.add(w));
						...
						if (!M || !M.length) {
							var S = v.borderWidth,
								A = c("content", p);
							if (A) {
								var z = Math.max(y - 2 * S, 0),
									C = Math.max(x - 2 * S, 0),
									L = o.getModel("label.normal"),
									I = o.getModel("label.normal.textStyle"),
									T = o.getModel().get("name"),
									D = I.getTextRect(T),
									P = L.get("show");
								!P || D.height > C ? T = "" : D.width > z && (T = I.get("ellipsis") ? I.ellipsis(T, z) : ""), A.dataIndex =
									o.dataIndex, A.seriesIndex = this.seriesModel.seriesIndex, A.culling = !0, A.setShape({
										x: S,
										y: S,
										width: z,
										height: C
			...
			_doAnimation: function(e, t, r) {
				if (r.get("animation")) {
					var n = r.get("animationDurationUpdate"),
						a = r.get("animationEasing"),
						o = u.createWrap(),
					...
					l && l.traverse(function(e) {
						...
						f(e, function(e, s) {
							...
							c && ("nodeGroup" === r ? (l = {
								...
								shape: i.extend({}, e.shape)
							}, e.setShape(c.old), c.fadein ? (e.setStyle("opacity", 0), l.style = {
								opacity: 1
							}) : 1 !== e.style.opacity && (l.style = {
								opacity: 1
							})), o.add(e, l, n, a))
						})
			...
			_resetController: function(e) {
				...
				return i || (i = this._controller = new s(e.getZr()), i.enable(), i.on("pan", h(t, this, this._onPan)), i.on(
					"zoom", h(t, this, this._onZoom))), i.rect = new l(0, 0, e.getWidth(), e.getHeight()), this.seriesModel.get(
					"roam") ? void 0 : (i.off("pan").off("zoom"), void(this._controller = null))
			},
			_onPan: function(e, t) {
			...
			_onZoom: function(e, t, i) {
				if ("animating" !== this._state) {
					...
					var n = r.getLayout();
					if (!n) return;
					var a = new l(n.x, n.y, n.width, n.height),
			...
			_renderBreadcrumb: function(e, t, i) {
				...
				i || (i = this.findTarget(t.getWidth() / 2, t.getHeight() / 2), i || (i = {
					node: e.getData().tree.root
				})), (this._breadcrumb || (this._breadcrumb = new o(this.group, h(r, this)))).render(e, t, i.node)
			},
			remove: function() {
	...
	}), t("echarts/visual/VisualMapping", ["require", "zrender/core/util", "zrender/tool/color", "../util/number"],
		function(e) {
			function t(e) {
				var t = e.pieceList;
			...
			function r(e) {
				return {
					applyVisual: function(t, i, r) {
						var n = i("color"),
							a = l.isArray(t);
						if (t = a ? [this.mapValueToVisual(t[0]), this.mapValueToVisual(t[1])] : this.mapValueToVisual(t), l.isArray(n))
							for (var o = 0, s = n.length; s > o; o++) n[o].color = e(n[o].color, a ? t[o] : t);
						else r("color", e(n, t))
					},
					mapValueToVisual: function(e) {
						var t = this._normalizeData(e),
							i = this._getSpecifiedVisual(e),
							r = this.option.visual;
			...
			var l = e("zrender/core/util"),
				c = e("zrender/tool/color"),
				u = e("../util/number").linearMap,
				h = l.each,
				d = l.isObject,
				p = -1,
				f = function(e) {
					var r = e.mappingMethod,
						n = e.type;
					this.type = n, this.mappingMethod = r;
					var a = this.option = l.clone(e);
					this._normalizeData = m[r], this._getSpecifiedVisual = l.bind(v[r], this, n), l.extend(this, g[n]), "piecewise" ===
						r && t(a), "category" === r && i(a)
				};
			f.prototype = {
				constructor: f,
				applyVisual: null,
			...
			var g = f.visualHandlers = {
					color: {
						...
						mapValueToVisual: function(e) {
							...
							if (l.isArray(e)) return e = [this._normalizeData(e[0]), this._normalizeData(e[1])], c.mapIntervalToColor(e,
								t);
							var i = this._normalizeData(e),
								r = this._getSpecifiedVisual(e);
		...
		}), t("echarts/chart/treemap/treemapVisual", ["require", "../../visual/VisualMapping", "zrender/tool/color",
		"zrender/core/util"
	], function(e) {
		...
		function r(e) {
			var t = a(e, "color");
			if (t) {
				var i = a(e, "colorAlpha"),
					r = a(e, "colorSaturation");
		...
		function o(e, t, i, r, n, a) {
			if (a && a.length) {
				...
				if (o) {
					var l = t.get("colorMappingBy"),
						u = {
							type: o.name,
							dataExtent: i.dataExtent,
							visual: o.range
						};
					"color" !== u.type || "index" !== l && "id" !== l ? u.mappingMethod = "linear" : (u.mappingMethod = "category",
						u.loop = !0);
					var h = new c(u);
	...
	}), t("echarts/chart/treemap/treemapLayout", ["require", "zrender/core/util", "../../util/number",
		"../../util/layout", "zrender/core/BoundingRect", "./helper"
	], function(e) {
		function t(e, t, r) {
			var n = {
				mainType: "series",
			...
			e.eachComponent(n, function(e) {
				var n = t.getWidth(),
					a = t.getHeight(),
					o = e.get("size") || [],
					s = v(y(e.get("width"), o[0]), n),
					l = v(y(e.get("height"), o[1]), a),
					d = m.getLayoutRect(e.getBoxLayoutParams(), {
						width: t.getWidth(),
						height: t.getHeight()
					}),
					p = r && r.type,
					f = _.retrieveTargetInfo(r, e),
					g = "treemapRender" === p || "treemapMove" === p ? r.rootRect : null,
					b = e.getViewRoot();
				if ("treemapMove" !== p) {
		...
		function i(e, t) {
			...
			if (!e.isRemoved()) {
				...
				var c = e.getModel("itemStyle.normal"),
					u = c.get("borderWidth"),
					h = c.get("gapWidth") / 2,
					g = u - h,
					m = e.getModel();
				...
				if (y.length) {
					...
					for (var M = 0, S = y.length; S > M;) {
						...
						b >= z ? (M++, b = z) : (w.area -= w.pop().getLayout().area, l(w, _, x, h, !1), _ = p(x.width, x.height), w.length =
							w.area = 0, b = 1 / 0)
					}
		...
		function r(e, t, i, r) {
			...
			return e.viewChildren = s, e.setLayout({
		...
		function o(e, t, i) {
			...
			if (t && t.length)
				if ("value" === s && i) o = [t[t.length - 1].getValue(), t[0].getValue()], "asc" === i && o.reverse();
				else {
					var o = [1 / 0, -(1 / 0)];
					f.each(t, function(e) {
						var t = e.getValue(s);
		...
		function s(e, t, i) {
			for (var r, n = 0, a = 1 / 0, o = 0, s = e.length; s > o; o++) r = e[o].getLayout().area, r && (a > r && (a = r),
				r > n && (n = r));
			var l = e.area * e.area,
				c = t * t * i;
		...
		function c(e, t, i, r) {
			...
			for (var o, s = i * r, l = s * e.get("zoomToNodeRatio"); o = n.parentNode;) {
				...
				isFinite(f) && (l += 4 * f * f + 4 * f * Math.pow(l, .5)), l > g.MAX_SAFE_INTEGER && (l = g.MAX_SAFE_INTEGER), n =
					o
			}
			s > l && (l = s);
		...
		var d = Math.max,
			p = Math.min,
			f = e("zrender/core/util"),
			g = e("../../util/number"),
			m = e("../../util/layout"),
			v = g.parsePercent,
			y = f.retrieve,
			x = e("zrender/core/BoundingRect"),
			_ = e("./helper");
		return t
	}), t("echarts/chart/treemap", ["require", "../echarts", "./treemap/TreemapSeries", "./treemap/TreemapView",
		"./treemap/treemapAction", "./treemap/treemapVisual", "./treemap/treemapLayout"
	], function(e) {
		var t = e("../echarts");
		e("./treemap/TreemapSeries"), e("./treemap/TreemapView"), e("./treemap/treemapAction"), t.registerVisualCoding(
			"chart", e("./treemap/treemapVisual")), t.registerLayout(e("./treemap/treemapLayout"))
		...
		a.type = "graph", a.isDirected = function() {
			...
			if (e instanceof t || (e = a[e]), r instanceof t || (r = a[r]), e && r) {
				...
				if (!o[s]) {
					var l = new i(e, r, n);
					return l.hostGraph = this, this._directed && (e.outEdges.push(l), r.inEdges.push(l)), e.edges.push(l), e !==
						r && r.edges.push(l), this.edges.push(l), o[s] = l, l
				}
			}
			...
			for (var i = this.edges, r = i.length, n = 0; r > n; n++) i[n].dataIndex >= 0 && i[n].node1.dataIndex >= 0 && i[
				n].node2.dataIndex >= 0 && e.call(t, i[n], n)
		}, a.breadthFirstTraverse = function(e, i, r, n) {
			if (!i instanceof t && (i = this._nodesMap[i]), i) {
				for (var a = "out" === r ? "outEdges" : "in" === r ? "inEdges" : "edges", o = 0; o < this.nodes.length; o++)
			...
			for (var e = this.data, t = this.edgeData, i = this.nodes, r = this.edges, n = 0, a = i.length; a > n; n++) i[n]
				.dataIndex = -1;
			...
			for (var e = new n(this._directed), t = this.nodes, i = this.edges, r = 0; r < t.length; r++) e.addNode(t[r].id,
				t[r].dataIndex);
			for (var r = 0; r < i.length; r++) {
				var a = i[r];
	...
	}), t("echarts/chart/helper/createGraphFromNodeEdge", ["require", "../../data/List", "../../data/Graph",
		"../../data/helper/linkList", "../../data/helper/completeDimensions", "zrender/core/util"
	], function(e) {
		var t = e("../../data/List"),
			i = e("../../data/Graph"),
			r = e("../../data/helper/linkList"),
			n = e("../../data/helper/completeDimensions"),
			a = e("zrender/core/util");
	...
	}), t("echarts/chart/graph/GraphSeries", ["require", "../../data/List", "zrender/core/util",
		"../helper/createGraphFromNodeEdge", "../../echarts"
	], function(e) {
		var t = e("../../data/List"),
			i = e("zrender/core/util"),
			r = e("../helper/createGraphFromNodeEdge");
		return e("../../echarts").extendSeriesModel({
			...
			_updateCategoriesData: function() {
				var e = i.map(this.option.categories || [], function(e) {
						return null != e.value ? e : i.extend({
							value: 0
						}, e)
					}),
					r = new t(["value"], this);
	...
	}), t("echarts/chart/helper/Line", ["require", "../../util/symbol", "zrender/core/vector", "./LinePath",
		"../../util/graphic", "zrender/core/util", "../../util/number"
	], function(e) {
		function t(e, t, i) {
			var r = t.getItemVisual(i, "color"),
				n = t.getItemVisual(i, "symbol"),
				a = t.getItemVisual(i, "symbolSize");
			if ("none" !== n) {
				d.isArray(a) || (a = [a, a]);
		...
		function a() {
			var e = this,
				t = e.childOfName("line");
			if (this.__dirty || t.__dirty) {
				var i = e.childOfName("fromSymbol"),
					r = e.childOfName("toSymbol"),
					a = e.childOfName("label"),
					s = t.pointAt(0),
					l = t.pointAt(t.shape.percent),
					u = c.sub([], l, s);
				c.normalize(u, u), i && (i.attr("position", s), n(r) && r.attr("rotation", o(s, l))), r && (r.attr("position", l),
					n(i) && i.attr("rotation", o(l, s))), a.attr("position", l);
				var h, d, p;
				"end" === a.__position ? (h = [5 * u[0] + l[0], 5 * u[1] + l[1]], d = u[0] > .8 ? "left" : u[0] < -.8 ? "right" :
					"center", p = u[1] > .8 ? "top" : u[1] < -.8 ? "bottom" : "middle") : (h = [5 * -u[0] + s[0], 5 * -u[1] + s[1]],
					d = u[0] > .8 ? "right" : u[0] < -.8 ? "left" : "center", p = u[1] > .8 ? "bottom" : u[1] < -.8 ? "top" :
					"middle"), a.attr({
					style: {
		...
		var l = e("../../util/symbol"),
			c = e("zrender/core/vector"),
			u = e("./LinePath"),
			h = e("../../util/graphic"),
			d = e("zrender/core/util"),
			p = e("../../util/number"),
			f = s.prototype;
		return f.beforeUpdate = a, f._createLine = function(e, r, n, a) {
			...
			var n = e.hostModel,
				...
				u = c.getModel("textStyle"),
				f = p.round(n.getRawValue(r));
			isNaN(f) && (f = e.getName(r)), a.setStyle(d.extend({
				stroke: e.getItemVisual(r, "color")
			...
			g.setStyle({
				...
				textFont: l.getFont(),
				fill: u.getTextColor()
			}, g.__textAlign = l.get("align"), g.__textBaseline = l.get("baseline"), g.__position = s.get("position"), h.setHoverStyle(
				this, o.getModel("lineStyle.emphasis").getLineStyle())
		}, f.updateLayout = function(e, t, i, n) {
			var a = e.getItemLayout(n),
				o = this.childOfName("line");
			r(o.shape, a), o.dirty(!0), t && t.getItemGraphicEl(n).attr("position", a[0]), i && i.getItemGraphicEl(n).attr(
				"position", a[1])
	...
	}), t("echarts/chart/graph/GraphView", ["require", "../helper/SymbolDraw", "../helper/LineDraw",
		"../../component/helper/RoamController", "../../util/model", "../../util/graphic", "../../echarts"
	], function(e) {
		var t = e("../helper/SymbolDraw"),
			i = e("../helper/LineDraw"),
			r = e("../../component/helper/RoamController"),
			n = e("../../util/model"),
			a = e("../../util/graphic");
		e("../../echarts").extendChartView({
			type: "graph",
			init: function(e, n) {
				var a = new t,
					...
					s = this.group,
					l = new r(n.getZr(), s);
				s.add(a.group), s.add(o.group), this._symbolDraw = a, this._lineDraw = o, this._controller = l, this._firstRender = !
					0
			},
			render: function(e, t, i) {
				var r = e.coordinateSystem;
				if ("geo" === r.type || "view" === r.type) {
					...
					var c = o.graph.edgeData,
						u = e.option,
						h = n.createDataFormatModel(e, c, u.edges || u.links);
					h.formatTooltip = function(e) {
						var t = this.getDataParams(e),
							i = t.data,
							r = i.source + " > " + i.target;
					...
					this._firstRender ? d.attr(p) : a.updateProps(d, p, e), this._nodeScaleRatio = e.get("nodeScaleRatio"), this
						._updateNodeAndLinkScale(), this._updateController(e, r, i), clearTimeout(this._layoutTimeout);
					var f = e.forceLayout,
						g = e.get("force.layoutAnimation");
					f && this._startForceLayoutIteration(f, g), o.eachItemGraphicEl(function(e, t) {
						...
						i && f ? e.on("drag", function() {
							f.warmUp(), !this._layouting && this._startForceLayoutIteration(f, g), f.setFixed(t), o.setItemLayout(
								t, e.position)
		...
		t.registerAction(r, function(e, t) {
			t.eachComponent({
				...
				var r = t.coordinateSystem,
					n = t.getModel("roamDetail"),
					a = i.calcPanAndZoom(n, e);
				t.setRoamPan && t.setRoamPan(a.x, a.y), t.setRoamZoom && t.setRoamZoom(a.zoom), r && r.setPan(a.x, a.y), r &&
					r.setZoom(a.zoom)
			})
		})
			...
			t && t.length && e.eachSeriesByType("graph", function(e) {
				...
				n.filterSelf(function(e) {
					var i = n.getItemModel(e),
						r = i.getShallow("category");
					if (null != r) {
						"number" == typeof r && (r = a[r]);
						for (var o = 0; o < t.length; o++)
							if (!t[o].isSelected(r)) return !1
					}
					return !0
				})
			}, this)
		...
		return function(e) {
			...
			if (!t || "view" === t.type) {
				...
				i.eachNode(function(e) {
					...
					var t, i = e.getModel().get("lineStyle.normal.curveness") || 0,
						r = e.node1.getLayout(),
						n = e.node2.getLayout();
					i > 0 && (t = [(r[0] + n[0]) / 2 - (r[1] - n[1]) * i, (r[1] + n[1]) / 2 - (n[0] - r[0]) * i]), e.setLayout([
						r, n, t
					])
				})
			}
		...
		var t = e("zrender/core/vector"),
			i = t.scaleAndAdd;
		return function(e, r, n) {
			for (var a = n.rect, o = a.width, s = a.height, l = [a.x + o / 2, a.y + s / 2], c = null == n.gravity ? .1 : n.gravity,
					u = 0; u < e.length; u++) {
				var h = e[u];
				h.p || (h.p = t.create(o * (Math.random() - .5) + l[0], s * (Math.random() - .5) + l[1])), h.pp = t.clone(h.p),
					h.edges = null
			}
			var d = .6;
			return {
	...
	}), t("echarts/chart/graph/forceLayout", ["require", "./forceHelper", "../../util/number", "./simpleLayoutHelper",
		"./circularLayoutHelper", "zrender/core/vector"
	], function(e) {
		var t = e("./forceHelper"),
			i = e("../../util/number"),
			r = e("./simpleLayoutHelper"),
			n = e("./circularLayoutHelper"),
			a = e("zrender/core/vector");
		return function(e, o) {
			e.eachSeriesByType("graph", function(e) {
				if ("force" === e.get("layout")) {
					var o = e.preservedPoints || {},
						s = e.getGraph(),
						l = s.data,
						c = s.edgeData,
						u = e.getModel("force"),
					...
					var d = l.getDataExtent("value"),
						...
						g = l.mapArray("value", function(e, t) {
							var r = l.getItemLayout(t),
								n = i.linearMap(e, d, [0, p]) || p / 2;
							return {
								w: n,
								rep: n,
					...
					x.step = function(e) {
						...
						_(function(t, i, r) {
							for (var n = 0, a = t.length; a > n; n++) t[n].fixed || s.getNodeByIndex(n).setLayout(t[n].p), o[l.getId(
								n)] = t[n].p;
							for (var n = 0, a = i.length; a > n; n++) {
								var c = i[n],
									...
									h = c.n2.p,
									d = [u, h];
								c.curveness > 0 && d.push([(u[0] + h[0]) / 2 - (u[1] - h[1]) * c.curveness, (u[1] + h[1]) / 2 - (h[0] -
									u[0]) * c.curveness]), s.getEdgeByIndex(n).setLayout(d)
							}
							e && e(r)
						})
	...
	}), t("echarts/chart/graph/createView", ["require", "../../coord/View", "../../util/layout", "zrender/core/bbox"],
		function(e) {
			function t(e, t, i) {
		...
		}), t("echarts/chart/graph", ["require", "../echarts", "zrender/core/util", "./graph/GraphSeries",
		"./graph/GraphView", "./graph/roamAction", "./graph/categoryFilter", "../visual/symbol", "./graph/categoryVisual",
		"./graph/simpleLayout", "./graph/circularLayout", "./graph/forceLayout", "./graph/createView"
	], function(e) {
		var t = e("../echarts"),
			i = e("zrender/core/util");
		e("./graph/GraphSeries"), e("./graph/GraphView"), e("./graph/roamAction"), t.registerProcessor("filter", e(
				"./graph/categoryFilter")), t.registerVisualCoding("chart", i.curry(e("../visual/symbol"), "graph", "circle",
				null)), t.registerVisualCoding("chart", e("./graph/categoryVisual")), t.registerLayout(e("./graph/simpleLayout")),
			t.registerLayout(e("./graph/circularLayout")), t.registerLayout(e("./graph/forceLayout")), t.registerCoordinateSystem(
				"graphView", {
					create: e("./graph/createView")
				})
	}), t("echarts/chart/gauge/GaugeSeries", ["require", "../../data/List", "../../model/Series", "zrender/core/util"],
		function(e) {
			var t = e("../../data/List"),
				i = e("../../model/Series"),
				r = e("zrender/core/util"),
		...
		return e("zrender/graphic/Path").extend({
			...
			buildPath: function(e, t) {
				...
				o = t.angle - Math.PI / 2, e.moveTo(s, l), e.lineTo(t.x + i(o) * a, t.y + r(o) * a), e.lineTo(t.x + i(t.angle) *
					n, t.y + r(t.angle) * n), e.lineTo(t.x - i(o) * a, t.y - r(o) * a), e.lineTo(s, l)
			}
		})
	}), t("echarts/chart/gauge/GaugeView", ["require", "./PointerPath", "../../util/graphic", "../../util/number",
		"../../view/Chart"
	], function(e) {
		function t(e, t) {
			var i = e.get("center"),
		...
		var r = e("./PointerPath"),
			...
			l = e("../../view/Chart").extend({
				...
				_renderMain: function(e, t, i, r, a) {
					for (var o = this.group, l = e.getModel("axisLine"), c = l.getModel("lineStyle"), u = e.get("clockwise"), h = -
							e.get("startAngle") / 180 * Math.PI, d = -e.get("endAngle") / 180 * Math.PI, p = (d - h) % s, f = h, g = c.get(
								"width"), m = 0; m < r.length; m++) {
						var d = h + p * r[m][0],
							v = new n.Sector({
								shape: {
									startAngle: f,
						...
						v.setStyle({
							fill: r[m][1]
						}), v.setStyle(c.getLineStyle(["color", "borderWidth", "borderColor"])), o.add(v), f = d
					}
					var y = function(e) {
						if (0 >= e) return r[0][1];
					...
					this._renderTicks(e, t, i, y, a, h, d, u), this._renderPointer(e, t, i, y, a, h, d, u), this._renderTitle(e,
						t, i, y, a), this._renderDetail(e, t, i, y, a)
				},
				_renderTicks: function(e, t, r, o, s, l, c, u) {
					for (var h = this.group, d = s.cx, p = s.cy, f = s.r, g = e.get("min"), m = e.get("max"), v = e.getModel(
								"splitLine"), y = e.getModel("axisTick"), x = e.getModel("axisLabel"), _ = e.get("splitNumber"), b = y.get(
								"splitNumber"), w = v.get("length"), M = y.get("length"), S = l, A = (c - l) / _, z = A / b, C = v.getModel(
								"lineStyle").getLineStyle(), L = y.getModel("lineStyle").getLineStyle(), I = x.getModel("textStyle"), T =
							0; _ >= T; T++) {
						var D = Math.cos(S),
							P = Math.sin(S);
						if (v.get("show")) {
							...
							"auto" === C.stroke && k.setStyle({
								stroke: o(T / _)
							}), h.add(k)
						}
						if (x.get("show")) {
							var V = i(a.round(T / _ * (m - g) + g), x.get("formatter")),
								R = new n.Text({
									style: {
										text: V,
										x: D * (f - w - 5) + d,
				...
				_renderPointer: function(e, t, i, s, l, c, u, h) {
					...
					g.diff(m).add(function(t) {
						...
						n.updateProps(i, {
							shape: {
								angle: d(g.get("value", t), p, f)
							}
						}, e), v.add(i), g.setItemGraphicEl(t, i)
					}).update(function(t, i) {
						...
						e.attr({
							shape: {
								...
								y: l.cy,
								width: r.get("width"),
								r: o(r.get("length"), l.r)
							},
							style: i.getModel("itemStyle.normal").getItemStyle()
						}), "auto" === e.style.fill && e.setStyle("fill", s((g.get("value", t) - p[0]) / (p[1] - p[0]))), n.setHoverStyle(
							e, i.getModel("itemStyle.emphasis").getItemStyle())
					}), this._data = g
				},
				...
				_renderDetail: function(e, t, r, a, s) {
					...
					if (l.get("show")) {
						var h = l.getModel("textStyle"),
							...
							f = s.cy + o(d[1], s.r),
							g = o(l.get("width"), s.r),
							m = o(l.get("height"), s.r),
							v = e.getData().get("value", 0),
							y = new n.Rect({
								shape: {
									x: p - g / 2,
									y: f - m / 2,
						...
						"auto" === y.style.textFill && y.setStyle("textFill", a((v - c) / (u - c))), y.setStyle(l.getItemStyle([
							"color"
						])), this.group.add(y)
					}
				}
	...
	}), t("echarts/chart/funnel/FunnelSeries", ["require", "../../data/List", "../../util/model",
		"../../data/helper/completeDimensions", "../../echarts"
	], function(e) {
		var t = e("../../data/List"),
			i = e("../../util/model"),
			r = e("../../data/helper/completeDimensions");
	...
	}), t("echarts/chart/funnel/FunnelView", ["require", "../../util/graphic", "zrender/core/util", "../../view/Chart"],
		function(e) {
			function t(e, t) {
				function i() {
					o.ignore = o.hoverIgnore, s.ignore = s.hoverIgnore
				...
				var a = new r.Polygon,
					o = new r.Polyline,
					s = new r.Text;
				this.add(a), this.add(o), this.add(s), this.updateData(e, t, !0), this.on("emphasis", i).on("normal", n).on(
			...
			a.updateData = function(e, t, i) {
				...
				a.setStyle(n.defaults({
					fill: d
				}, h.getModel("normal").getItemStyle())), a.hoverStyle = h.getModel("emphasis").getItemStyle(), this._updateLabel(
					e, t), r.setHoverStyle(this)
				...
				var h = s.getModel("label.normal"),
					...
					p = s.getModel("labelLine.normal"),
					f = s.getModel("labelLine.emphasis");
				a.setStyle(i(e, t, "normal", h)), a.ignore = a.normalIgnore = !h.get("show"), a.hoverIgnore = !d.get("show"), n.ignore =
					n.normalIgnore = !p.get("show"), n.hoverIgnore = !f.get("show"), n.setStyle({
						stroke: u
					}), n.setStyle(p.getModel("lineStyle").getLineStyle()), a.hoverStyle = i(e, t, "emphasis", d), n.hoverStyle = f
					.getModel("lineStyle").getLineStyle()
		...
		function t(e, t) {
			return n.getLayoutRect(e.getBoxLayoutParams(), {
				width: t.getWidth(),
				height: t.getHeight()
			})
		}
		...
		function r(e) {
			e.each(function(t) {
				var i, r, n, a, o = e.getItemModel(t),
					s = o.getModel("label.normal"),
					l = s.get("position"),
				...
				if (d) r = (h[0][0] + h[1][0] + h[2][0] + h[3][0]) / 4, n = (h[0][1] + h[1][1] + h[2][1] + h[3][1]) / 4, i =
					"center", a = [
						[r, n],
						[r, n]
					];
					...
					"left" === l ? (p = (h[3][0] + h[0][0]) / 2, f = (h[3][1] + h[0][1]) / 2, g = p - m, r = g - 5, i = "right") :
						(p = (h[1][0] + h[2][0]) / 2, f = (h[1][1] + h[2][1]) / 2, g = p + m, r = g + 5, i = "left");
					var v = f;
					a = [
						[p, f],
						[g, v]
		...
		return function(e, n) {
			e.eachSeriesByType("funnel", function(e) {
				var s = e.getData(),
					...
					c = t(e, n),
					u = i(s, l),
					h = [o(e.get("minSize"), c.width), o(e.get("maxSize"), c.width)],
				...
				var g = e.get("funnelAlign"),
					m = e.get("gap"),
					v = (c.height - m * (s.count() - 1)) / s.count(),
					y = c.y,
					x = function(e, t) {
						var i, r = s.get("value", e) || 0,
							n = a.linearMap(r, [p, f], h, !0);
						switch (g) {
							case "left":
								i = c.x;
								break;
	...
	}), t("echarts/chart/funnel", ["require", "zrender/core/util", "../echarts", "./funnel/FunnelSeries",
		"./funnel/FunnelView", "../visual/dataColor", "./funnel/funnelLayout", "../processor/dataFilter"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../echarts");
		e("./funnel/FunnelSeries"), e("./funnel/FunnelView"), i.registerVisualCoding("chart", t.curry(e(
			"../visual/dataColor"), "funnel")), i.registerLayout(e("./funnel/funnelLayout")), i.registerProcessor("filter",
			t.curry(e("../processor/dataFilter"), "funnel"))
	...
	}), t("echarts/coord/parallel/Parallel", ["require", "../../util/layout", "../../coord/axisHelper",
		"zrender/core/util", "./ParallelAxis", "zrender/core/matrix", "zrender/core/vector"
	], function(e) {
		function t(e, t, i) {
		...
		var i = e("../../util/layout"),
			...
			n = e("zrender/core/util"),
			a = e("./ParallelAxis"),
			o = e("zrender/core/matrix"),
			s = e("zrender/core/vector"),
			l = n.each,
			c = Math.PI;
		return t.prototype = {
			type: "parallel",
			...
			_init: function(e, t, i) {
				var n = e.dimensions,
					o = e.parallelAxisIndex;
				l(n, function(e, i) {
					var n = o[i],
						s = t.getComponent("parallelAxis", n),
			...
			eachActiveState: function(e, t, i) {
				for (var r = this.dimensions, n = this._axesMap, a = !1, o = 0, s = r.length; s > o; o++) "normal" !== n[r[o]]
					.model.getActiveState() && (a = !0);
				for (var l = 0, c = e.count(); c > l; l++) {
					...
					if (a) {
						...
						for (var o = 0, s = r.length; s > o; o++) {
							var d = r[o],
								p = n[d].model.getActiveState(h[o], o);
							if ("inactive" === p) {
								u = "inactive";
								break
							}
		...
		var i = e("./Parallel");
		e("../../CoordinateSystem").register("parallel", {
			create: t
		})
	}), t("echarts/coord/parallel/AxisModel", ["require", "../../model/Component", "zrender/core/util",
		"../../model/mixin/makeStyleMapper", "../axisModelCreator", "../../util/number", "../axisModelCommonMixin"
	], function(e) {
		function t(e, t) {
			return t.type || (t.data ? "category" : "value")
		}
		var i = e("../../model/Component"),
			r = e("zrender/core/util"),
			n = e("../../model/mixin/makeStyleMapper"),
			a = e("../axisModelCreator"),
			o = e("../../util/number"),
			s = i.extend({
				...
				setActiveIntervals: function(e) {
					...
					if (t)
						for (var i = t.length - 1; i >= 0; i--) o.asc(t[i])
				},
	...
	}), t("echarts/coord/parallel/ParallelModel", ["require", "zrender/core/util", "../../model/Component",
		"./AxisModel"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../../model/Component");
	...
	}), t("echarts/component/helper/SelectController", ["require", "zrender/mixin/Eventful", "zrender/core/util",
		"../../util/graphic"
	], function(e) {
		function t(e, t, i) {
			f.call(this), this.type = e, this.zr = t, this.opt = g.clone(i), this.group = new m.Group, this._containerRect =
				null, this._track = [], this._dragging, this._cover, this._disabled = !0, this._handlers = {
					mousedown: v(n, this),
					mousemove: v(a, this),
					mouseup: v(o, this)
				}, y(M, function(e) {
		...
		function n(e) {
			if (!(this._disabled || e.target && e.target.draggable)) {
				...
				var t = e.offsetX,
					n = e.offsetY;
				i.call(this, t, n) && (this._dragging = !0, this._track = [
					[t, n]
				])
			}
		}
		...
		function c(e) {
			var t = S[this.type];
			e && e.length ? (this._cover || (this._cover = t.create.call(this), this.group.add(this._cover)), t.update.call(
				this, e)) : (this.group.remove(this._cover), this._cover = null)
		}
		...
		var f = e("zrender/mixin/Eventful"),
			g = e("zrender/core/util"),
			m = e("../../util/graphic"),
			v = g.bind,
			y = g.each,
			x = Math.min,
		...
		t.prototype = {
			constructor: t,
			enable: function(e, t) {
				this._disabled = !1, u.call(this), this._containerRect = t !== !1 ? t || e.getBoundingRect() : null, e.add(
					this.group)
			},
			update: function(e) {
		...
		return t
	}), t("echarts/component/axis/ParallelAxisView", ["require", "zrender/core/util", "./AxisBuilder",
		"../helper/SelectController", "../../echarts"
	], function(e) {
		function t(e, t, i) {
			return i && "axisAreaSelect" === i.type && t.findComponents({
				mainType: "parallelAxis",
				query: i
			})[0] === e
		}
		var i = e("zrender/core/util"),
			r = e("./AxisBuilder"),
			n = e("../helper/SelectController"),
			a = ["axisLine", "axisLabel", "axisTick", "axisName"],
			o = e("../../echarts").extendComponentView({
				type: "parallelAxis",
				...
				render: function(e, n, o, s) {
					if (!t(e, n, s) && (this.axisModel = e, this.api = o, this.group.removeAll(), e.get("show"))) {
						var l = n.getComponent("parallel", e.get("parallelIndex")).coordinateSystem,
							c = e.getAreaSelectStyle(),
							u = c.width,
							h = l.getAxisLayout(e.axis.dim),
							d = i.extend({
				...
				_buildSelectController: function(e, t, r, a) {
					...
					s || (s = this._selectController = new n("line", a.getZr(), t), s.on("selected", i.bind(this._onSelected,
						this))), s.enable(e);
		...
		return o
	}), t("echarts/component/parallelAxis", ["require", "../coord/parallel/parallelCreator", "./axis/parallelAxisAction",
		"./axis/ParallelAxisView"
	], function(e) {
		e("../coord/parallel/parallelCreator"), e("./axis/parallelAxisAction"), e("./axis/ParallelAxisView")
	}), t("echarts/coord/parallel/parallelPreprocessor", ["require", "zrender/core/util", "../../util/model"], function(
		e) {
		function t(e) {
			if (!e.parallel) {
				var t = !1;
			...
			r.each(t, function(t) {
				if (r.isObject(t)) {
					var i = t.parallelIndex || 0,
						a = n.normalizeToArray(e.parallel)[i];
	...
	}), t("echarts/component/parallel", ["require", "../coord/parallel/parallelCreator",
		"../coord/parallel/ParallelModel", "./parallelAxis", "../echarts", "../coord/parallel/parallelPreprocessor"
	], function(e) {
		e("../coord/parallel/parallelCreator"), e("../coord/parallel/ParallelModel"), e("./parallelAxis");
		var t = e("../echarts");
		t.extendComponentView({
			type: "parallel"
		}), t.registerPreprocessor(e("../coord/parallel/parallelPreprocessor"))
	}), t("echarts/chart/parallel/ParallelSeries", ["require", "../../data/List", "zrender/core/util",
		"../../model/Series"
	], function(e) {
		function t(e, t, i) {
			var n = e.get("data"),
		...
		return n.extend({
			...
			getInitialData: function(e, n) {
				var a = n.getComponent("parallel", this.get("parallelIndex")),
					o = a.dimensions,
					s = a.parallelAxisIndex,
					l = e.data,
					c = r.map(o, function(e, i) {
						var r = n.getComponent("parallelAxis", s[i]);
						return "category" === r.get("type") ? (t(r, e, l), {
							name: e,
							type: "ordinal"
						}) : e
					}),
	...
	}), t("echarts/chart/parallel/ParallelView", ["require", "../../util/graphic", "zrender/core/util",
		"../../view/Chart"
	], function(e) {
		function t(e, t, i) {
			var r = e.model,
			...
			return o.setShape(s, 0), a.initProps(o, {
				shape: {
					width: n.width,
					height: n.height
				}
		...
		var a = e("../../util/graphic"),
			...
			s = e("../../view/Chart").extend({
				...
				render: function(e, n, s, l) {
					...
					function u(t, n) {
						var o = p.getValues(m, t),
							s = f.getItemGraphicEl(n),
							l = [],
							c = 0;
						i(o, m, g, function(t, i) {
							var n = s.childAt(c++);
							t && !n ? l.push(r(t)) : t && a.updateProps(n, {
								shape: {
									points: t
								}
							}, e)
		...
		return function(e, t) {
			e.eachSeriesByType("parallel", function(t) {
				var i = t.getModel("itemStyle.normal"),
					r = e.get("color"),
					n = i.get("color") || r[t.seriesIndex % r.length],
					a = t.get("inactiveOpacity"),
					o = t.get("activeOpacity"),
					s = t.getModel("lineStyle.normal").getLineStyle(),
	...
	}), t("echarts/chart/parallel", ["require", "../echarts", "../component/parallel", "./parallel/ParallelSeries",
		"./parallel/ParallelView", "./parallel/parallelVisual"
	], function(e) {
		var t = e("../echarts");
		e("../component/parallel"), e("./parallel/ParallelSeries"), e("./parallel/ParallelView"), t.registerVisualCoding(
			"chart", e("./parallel/parallelVisual"))
	}), t("echarts/chart/sankey/SankeySeries", ["require", "../../model/Series", "../helper/createGraphFromNodeEdge"],
		function(e) {
			var t = e("../../model/Series"),
				i = e("../helper/createGraphFromNodeEdge");
			return t.extend({
				type: "series.sankey",
				layoutInfo: null,
				getInitialData: function(e, t) {
				...
				defaultOption: {
					...
					color: ["#9e0142", "#d53e4f", "#f46d43", "#fdae61", "#fee08b", "#ffffbf", "#e6f598", "#abdda4", "#66c2a5",
						"#3288bd", "#5e4fa2"
					],
					animationEasing: "linear",
					animationDuration: 1e3
		...
		}), t("echarts/chart/sankey/SankeyView", ["require", "../../util/graphic", "../../util/model", "zrender/core/util",
		"../../echarts"
	], function(e) {
		function t(e, t, r) {
			var n = new i.Rect({
		...
		var i = e("../../util/graphic"),
			...
			a = i.extendShape({
				...
				buildPath: function(e, t) {
					var i = t.extent / 2;
					e.moveTo(t.x1, t.y1 - i), e.bezierCurveTo(t.cpx1, t.cpy1 - i, t.cpx2, t.cpy2 - i, t.x2, t.y2 - i), e.lineTo(t
						.x2, t.y2 + i), e.bezierCurveTo(t.cpx2, t.cpy2 + i, t.cpx1, t.cpy1 + i, t.x1, t.y1 + i), e.closePath()
				}
			});
		return e("../../echarts").extendChartView({
			type: "sankey",
			...
			render: function(e, o, s) {
				...
				var h = l.edgeData,
					d = e.option,
					p = r.createDataFormatModel(e, h, d.edges || d.links);
				p.formatTooltip = function(e) {
					...
					var r = t.getLayout(),
						a = t.getModel(),
						o = a.getModel("label.normal"),
						s = o.getModel("textStyle"),
						l = a.getModel("label.emphasis"),
					...
					h.setStyle(n.defaults({
						fill: t.getVisual("color")
					}, a.getModel("itemStyle.normal").getItemStyle())), i.setHoverStyle(h, n.extend(t.getModel(
						"itemStyle.emphasis"), {
					...
					var r = e.getModel("lineStyle.normal"),
						n = r.get("curveness"),
						o = e.node1.getLayout(),
						s = e.node2.getLayout(),
						l = e.getLayout();
					...
					t.setShape({
						...
						cpx2: v,
						cpy2: y
					}), t.setStyle(r.getItemStyle()), i.setHoverStyle(t, e.getModel("lineStyle.emphasis").getItemStyle()), c.add(
						t)
		...
		var i = e("zrender/core/util");
		return t
	}), t("echarts/chart/sankey/sankeyLayout", ["require", "../../util/layout", "../../util/array/nest",
		"zrender/core/util"
	], function(e) {
		function t(e, t) {
			return w.getLayoutRect(e.getBoxLayoutParams(), {
				width: t.getWidth(),
				height: t.getHeight()
			})
		}
		...
		function n(e, t, i) {
			for (var r = e, n = null, s = 0, l = 0; r.length;) n = [], S.each(r, function(e) {
				e.setLayout({
					...
					dx: t
				}, !0), S.each(e.outEdges, function(e) {
					n.push(e.node2)
				})
			}), r = n, ++s;
		...
		function c(e, t, i) {
			S.each(e, function(e) {
				...
				if (n = o - t - i, n > 0) {
					...
					for (r.setLayout({
							y: l
						}, !0), o = r.getLayout().y, a = s - 2; a >= 0; --a) r = e[a], n = r.getLayout().y + r.getLayout().dy + t -
						o, n > 0 && (l = r.getLayout().y - n, r.setLayout({
							y: l
						}, !0)), o = r.getLayout().y
				}
			})
			...
			S.each(e.slice().reverse(), function(e) {
				S.each(e, function(e) {
					if (e.outEdges.length) {
						var i = v(e.outEdges, h) / v(e.outEdges, b),
							r = e.getLayout().y + (i - y(e)) * t;
						e.setLayout({
							y: r
						}, !0)
					}
		...
		function d(e, t) {
			S.each(e, function(e) {
				S.each(e, function(e) {
					if (e.inEdges.length) {
						var i = v(e.inEdges, p) / v(e.inEdges, b),
							r = e.getLayout().y + (i - y(e)) * t;
						e.setLayout({
							y: r
						}, !0)
		...
		function v(e, t) {
			...
			if (1 === arguments.length)
				for (; ++a < n;) i = +e[a], isNaN(i) || (r += i);
			else
				for (; ++a < n;) i = +t.call(e, e[a], a), isNaN(i) || (r += i);
			return r
		}
		...
		return function(e, i) {
			e.eachSeriesByType("sankey", function(e) {
				...
				var n = r[0].getLayout().value,
					a = r[r.length - 1].getLayout().value;
	...
	}), t("echarts/chart/sankey", ["require", "../echarts", "./sankey/SankeySeries", "./sankey/SankeyView",
		"./sankey/sankeyLayout", "./sankey/sankeyVisual"
	], function(e) {
		var t = e("../echarts");
		e("./sankey/SankeySeries"), e("./sankey/SankeyView"), t.registerLayout(e("./sankey/sankeyLayout")), t.registerVisualCoding(
			"chart", e("./sankey/sankeyVisual"))
	}), t("echarts/chart/helper/WhiskerBoxDraw", ["require", "zrender/core/util", "../../util/graphic",
		"zrender/graphic/Path"
	], function(e) {
		function t(e, t, i, r) {
			o.Group.call(this), this.bodyIndex, this.whiskerIndex, this.styleUpdater = i, this._createContent(e, t, r), this.updateData(
				e, t, r), this._seriesModel
		}
		...
		var a = e("zrender/core/util"),
			o = e("../../util/graphic"),
			s = e("zrender/graphic/Path"),
			l = s.extend({
				type: "whiskerInBox",
				shape: {},
				buildPath: function(e, t) {
		...
		c._createContent = function(e, t, n) {
			var s = e.getItemLayout(t),
				c = "horizontal" === s.chartLayout ? 1 : 0,
				u = 0;
			this.add(new o.Polygon({
				shape: {
					points: n ? i(s.bodyEnds, c, s) : s.bodyEnds
				},
				style: {
					strokeNoScale: !0
				},
			...
			var n = this._seriesModel = e.hostModel,
				a = e.getItemLayout(t),
				s = o[i ? "initProps" : "updateProps"];
			s(this.childAt(this.bodyIndex), {
				shape: {
					points: a.bodyEnds
				}
			}, n), s(this.childAt(this.whiskerIndex), {
				shape: r(a.whiskerEnds)
			}, n), this.styleUpdater.call(null, this, e, t)
		...
		return u.updateData = function(e) {
			...
			e.diff(r).add(function(r) {
				...
				var s = r.getItemGraphicEl(o);
				return e.hasValue(a) ? (s ? s.updateData(e, a) : s = new t(e, a, n), i.add(s), void e.setItemGraphicEl(a, s)) :
					void i.remove(s)
			}).remove(function(e) {
	...
	}), t("echarts/chart/helper/whiskerBoxCommon", ["require", "../../data/List", "../../data/helper/completeDimensions",
		...
		var i = e("../../data/List"),
			r = e("../../data/helper/completeDimensions"),
			n = e("../helper/WhiskerBoxDraw"),
			a = {
				_baseAxisDim: null,
				getInitialData: function(e, n) {
					var a, o, s = n.getComponent("xAxis", this.get("xAxisIndex")),
						l = n.getComponent("yAxis", this.get("yAxisIndex")),
						c = s.get("type"),
						u = l.get("type");
					"category" === c ? (e.layout = "horizontal", a = s.getCategories(), o = !0) : "category" === u ? (e.layout =
							"vertical", a = l.getCategories(), o = !0) : e.layout = e.layout || "horizontal", this._baseAxisDim =
						"horizontal" === e.layout ? "x" : "y";
					var h = e.data,
	...
	}), t("echarts/chart/boxplot/BoxplotSeries", ["require", "zrender/core/util", "../../model/Series",
		"../helper/whiskerBoxCommon"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../../model/Series"),
			r = e("../helper/whiskerBoxCommon"),
			n = i.extend({
				type: "series.boxplot",
	...
	}), t("echarts/chart/boxplot/BoxplotView", ["require", "zrender/core/util", "../../view/Chart", "../../util/graphic",
		"../helper/whiskerBoxCommon"
	], function(e) {
		function t(e, t, i) {
			var r = t.getItemModel(i),
				a = r.getModel(s),
				o = t.getItemVisual(i, "color"),
				c = a.getItemStyle(["borderColor"]),
				u = e.childAt(e.whiskerIndex);
		...
		return function(e, i) {
			...
			e.eachRawSeriesByType("boxplot", function(i) {
				var n = r[i.seriesIndex % r.length],
					a = i.getData();
				a.setVisual({
		...
		function t(e) {
			...
			return e.eachSeriesByType("boxplot", function(e) {
				var r = e.getBaseAxisModel().axis,
					a = n.indexOf(i, r);
				0 > a && (a = i.length, i[a] = r, t[a] = {
					axis: r,
					seriesModels: []
	...
	}), t("echarts/chart/boxplot", ["require", "../echarts", "./boxplot/BoxplotSeries", "./boxplot/BoxplotView",
		"./boxplot/boxplotVisual", "./boxplot/boxplotLayout"
	], function(e) {
		var t = e("../echarts");
		e("./boxplot/BoxplotSeries"), e("./boxplot/BoxplotView"), t.registerVisualCoding("chart", e(
			"./boxplot/boxplotVisual")), t.registerLayout(e("./boxplot/boxplotLayout"))
	}), t("echarts/chart/candlestick/CandlestickSeries", ["require", "zrender/core/util", "../../model/Series",
		"../helper/whiskerBoxCommon", "../../util/format"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../../model/Series"),
			r = e("../helper/whiskerBoxCommon"),
	...
	}), t("echarts/chart/candlestick/CandlestickView", ["require", "zrender/core/util", "../../view/Chart",
		"../../util/graphic", "../helper/whiskerBoxCommon"
	], function(e) {
		function t(e, t, i) {
			var r = t.getItemModel(i),
				a = r.getModel(s),
				...
				u = a.getItemStyle(["color", "color0", "borderColor", "borderColor0"]),
				h = e.childAt(e.whiskerIndex);
		...
		var t = ["itemStyle", "normal", "borderColor"],
			...
			n = ["itemStyle", "normal", "color0"];
		return function(e, a) {
			e.eachRawSeriesByType("candlestick", function(a) {
				var o = a.getData();
				o.setVisual({
					legendSymbol: "roundRect"
				}), e.isSeriesFiltered(a) || o.each(function(e) {
					var a = o.getItemModel(e),
						s = o.getItemLayout(e).sign;
					o.setItemVisual(e, {
						color: a.get(s > 0 ? r : n),
						borderColor: a.get(s > 0 ? t : i)
					})
				})
			})
		}
	...
	}), t("echarts/chart/candlestick", ["require", "../echarts", "./candlestick/CandlestickSeries",
		"./candlestick/CandlestickView", "./candlestick/preprocessor", "./candlestick/candlestickVisual",
		"./candlestick/candlestickLayout"
	], function(e) {
		var t = e("../echarts");
		e("./candlestick/CandlestickSeries"), e("./candlestick/CandlestickView"), t.registerPreprocessor(e(
			"./candlestick/preprocessor")), t.registerVisualCoding("chart", e("./candlestick/candlestickVisual")), t.registerLayout(
			e("./candlestick/candlestickLayout"))
	}), t("echarts/chart/effectScatter/EffectScatterSeries", ["require", "../helper/createListFromArray",
		"../../model/Series"
	], function(e) {
		var t = e("../helper/createListFromArray"),
			i = e("../../model/Series");
	...
	}), t("echarts/chart/helper/EffectSymbol", ["require", "zrender/core/util", "../../util/symbol",
		"../../util/graphic", "../../util/number", "./Symbol"
	], function(e) {
		function t(e) {
		...
		return u.stopEffectAnimation = function() {
			...
			for (var s = this._symbolType, l = this._color, u = this.childAt(1), h = 0; c > h; h++) {
				...
				d.animate("", !0).when(e, {
					scale: [i, i]
				}).delay(p).start(), d.animateStyle(!0).when(e, {
					opacity: 0
				}).delay(p).start(), u.add(d)
			}
			...
			var s = this.childAt(1),
				l = e.getItemModel(i),
				c = e.getItemVisual(i, "symbol"),
				u = t(e.getItemVisual(i, "symbolSize")),
				h = e.getItemVisual(i, "color");
			...
			var f = a.get("showEffectOn"),
				g = l.get("rippleEffect.scale"),
	...
	}), t("echarts/chart/effectScatter/EffectScatterView", ["require", "../helper/SymbolDraw", "../helper/EffectSymbol",
		"../../echarts"
	], function(e) {
		var t = e("../helper/SymbolDraw"),
			i = e("../helper/EffectSymbol");
		e("../../echarts").extendChartView({
			type: "effectScatter",
			init: function() {
	...
	}), t("echarts/chart/effectScatter", ["require", "zrender/core/util", "../echarts",
		"./effectScatter/EffectScatterSeries", "./effectScatter/EffectScatterView", "../visual/symbol", "../layout/points"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../echarts");
		e("./effectScatter/EffectScatterSeries"), e("./effectScatter/EffectScatterView"), i.registerVisualCoding("chart",
			t.curry(e("../visual/symbol"), "effectScatter", "circle", null)), i.registerLayout(t.curry(e("../layout/points"),
			"effectScatter"))
	}), t("echarts/chart/lines/LinesSeries", ["require", "../../model/Series", "../../data/List", "zrender/core/util"],
		function(e) {
			var t = e("../../model/Series"),
				i = e("../../data/List"),
				r = e("zrender/core/util");
			return t.extend({
				...
				getInitialData: function(e, t) {
					...
					r.each(e.data, function(e) {
						a.push(e[0]), o.push(e[1]), s.push(r.extend(r.extend({}, r.isArray(e[0]) ? null : e[0]), r.isArray(e[1]) ?
							null : e[1]))
					});
					var l = e.coordinateSystem;
					if ("cartesian2d" !== l && "geo" !== l) throw new Error(
				...
				formatTooltip: function(e) {
					var t = this.fromData.getName(e),
						i = this.toData.getName(e);
					return t + " > " + i
				},
				defaultOption: {
					coordinateSystem: "geo",
		...
		}), t("echarts/chart/helper/EffectLine", ["require", "../../util/graphic", "./Line", "zrender/core/util",
		"../../util/symbol", "zrender/core/curve"
	], function(e) {
		function t(e, t, i, r) {
			n.Group.call(this);
			var o = new a(e, t, i, r);
		...
		function r() {
			...
			var s = o(e[0], i[0], t[0], r),
				c = o(e[1], i[1], t[1], r);
			this.rotation = -Math.atan2(c, s) - Math.PI / 2, this.ignore = !1
		}
		var n = e("../../util/graphic"),
			a = e("./Line"),
			o = e("zrender/core/util"),
			s = e("../../util/symbol"),
			l = e("zrender/core/curve"),
			c = t.prototype;
		return c._updateEffectSymbol = function(e, t) {
			var n = e.getItemModel(t),
				...
				c = a.get("symbol");
			o.isArray(l) || (l = [l, l]);
			var u = a.get("color") || e.getItemVisual(t, "color"),
				h = this.childAt(1),
				d = 1e3 * a.get("period");
			(this._symbolType !== c || d !== this._period) && (h = s.createSymbol(c, -.5, -.5, 1, 1, u), h.ignore = !0, h.z2 =
				100, this._symbolType = c, this._period = d, this.add(h), h.__t = 0, h.animate("", !0).when(d, {
					__t: 1
				}).delay(t / e.count() * d / 2).during(o.bind(r, h)).start()), h.setStyle("shadowColor", u), h.setStyle(a.getItemStyle(
				["color"])), h.attr("scale", l);
	...
	}), t("echarts/chart/lines/LinesView", ["require", "../helper/LineDraw", "../helper/EffectLine", "../helper/Line",
		"../../echarts"
	], function(e) {
		var t = e("../helper/LineDraw"),
			i = e("../helper/EffectLine"),
			r = e("../helper/Line");
		e("../../echarts").extendChartView({
			type: "lines",
			init: function() {},
		...
		return function(e) {
			e.eachSeriesByType("lines", function(e) {
				...
				i.each(a, function(e, r, n) {
					...
					var t, a = i.getItemLayout(e),
						o = r.getItemLayout(e),
						s = n.getItemModel(e).get("lineStyle.normal.curveness");
					s > 0 && (t = [(a[0] + o[0]) / 2 - (a[1] - o[1]) * s, (a[1] + o[1]) / 2 - (o[0] - a[0]) * s]), n.setItemLayout(
						e, [a, o, t])
				})
			})
		}
	}), t("echarts/chart/lines", ["require", "./lines/LinesSeries", "./lines/LinesView", "zrender/core/util",
		"../echarts", "./lines/linesLayout", "../visual/seriesColor"
	], function(e) {
		e("./lines/LinesSeries"), e("./lines/LinesView");
		var t = e("zrender/core/util"),
			i = e("../echarts");
		i.registerLayout(e("./lines/linesLayout")), i.registerVisualCoding("chart", t.curry(e("../visual/seriesColor"),
			"lines", "lineStyle"))
	}), t("echarts/chart/heatmap/HeatmapSeries", ["require", "../../model/Series", "../helper/createListFromArray"],
		function(e) {
			var t = e("../../model/Series"),
				i = e("../helper/createListFromArray");
			return t.extend({
		...
		return t.prototype = {
			update: function(e, t, n, a, o, s) {
				var l = this._getBrush(),
					c = this._getGradient(e, o, "inRange"),
					u = this._getGradient(e, o, "outOfRange"),
					h = i + this.blurSize,
					d = this.canvas,
					p = d.getContext("2d"),
					f = e.length;
			...
			_getBrush: function() {
				...
				return a.clearRect(0, 0, r, r), a.shadowOffsetX = r, a.shadowBlur = this.blurSize, a.shadowColor = "#000", a.beginPath(),
					a.arc(-t, t, i, 0, 2 * Math.PI, !0), a.closePath(), a.fill(), e
			},
			_getGradient: function(e, t, i) {
				for (var r = this._gradientPixels, n = r[i] || (r[i] = new Uint8ClampedArray(1024)), a = [], o = 0, s = 0; 256 >
					s; s++) t[i](s / 255, !0, a), n[o++] = a[0], n[o++] = a[1], n[o++] = a[2], n[o++] = a[3];
				return n
			}
		}, t
	}), t("echarts/chart/heatmap/HeatmapView", ["require", "../../util/graphic", "./HeatmapLayer", "zrender/core/util",
		"../../echarts"
	], function(e) {
		function t(e, t, i) {
			var r = e[1] - e[0];
			t = a.map(t, function(t) {
				return {
					interval: [(t.interval[0] - e[0]) / r, (t.interval[1] - e[0]) / r]
				}
			});
			var n = t.length,
				o = 0;
		...
		return e("../../echarts").extendChartView({
			...
			render: function(e, t, i) {
				...
				this.group.removeAll();
				var n = e.coordinateSystem;
				"cartesian2d" === n.type ? this._renderOnCartesian(n, e, i) : "geo" === n.type && this._renderOnGeo(n, e, r,
					i)
			},
			_renderOnCartesian: function(e, t, i) {
				var n = e.getAxis("x"),
					a = e.getAxis("y"),
					o = this.group;
				if ("category" !== n.type || "category" !== a.type) throw new Error(
				...
				c.each(["x", "y", "z"], function(i, n, a, u) {
					...
					if (!isNaN(a)) {
						var p = new r.Rect({
								...
								style: {
									fill: c.getItemVisual(u, "color")
								}
							}),
							f = h.getModel("itemStyle.normal").getItemStyle(["color"]),
							g = h.getModel("itemStyle.emphasis").getItemStyle(),
							m = h.getModel("label.normal"),
							v = h.getModel("label.emphasis"),
							y = t.getRawValue(u),
							x = "-";
						y && null != y[2] && (x = y[2]), m.get("show") && (r.setText(f, m), f.text = t.getFormattedLabel(u,
								"normal") || x), v.get("show") && (r.setText(g, v), g.text = t.getFormattedLabel(u, "emphasis") || x),
							p.setStyle(f), r.setHoverStyle(p, g), o.add(p), c.setItemGraphicEl(u, p)
					}
				})
			},
			_renderOnGeo: function(e, a, o, s) {
				...
				var d = e.getViewRect().clone(),
					p = e.getRoamTransform();
				d.applyTransform(p);
				var f = Math.max(d.x, 0),
					g = Math.max(d.y, 0),
					m = Math.min(d.width + d.x, s.getWidth()),
	...
	}), t("echarts/component/geo", ["require", "../coord/geo/geoCreator", "./geo/GeoView", "../action/geoRoam"],
		function(e) {
		...
		t.extendComponentModel({
			...
			render: function(e, t, n) {
				if (this.group.removeAll(), e.get("show")) {
					...
					var v = r.getLayoutRect(m, {
						width: n.getWidth(),
						height: n.getHeight()
					}, e.get("padding"));
					if (!l) {
						var y = v.x / n.getWidth(),
							x = (v.x + v.width) / n.getWidth();
					...
					var _ = v.margin,
						b = e.getItemStyle(["color", "opacity"]);
		...
		function i(e, t, i) {
			...
			return o([0, 1], function(e) {
				var o, s = u[e],
					l = !0;
				r(s) && (o = c[e], r(o) && (o = n[e]), s = a.linearMap(o, n, t, !0), l = !1), i && (s = Math[h[e]](s)), l && (
					o = a.linearMap(s, t, n, !0)), u[e] = s, c[e] = o
			}), {
				valueWindow: s(u),
				percentWindow: s(c)
			}
		...
		var n = e("zrender/core/util"),
			...
			s = a.asc,
			l = function(e, t, i, r) {
				this._dimName = e, this._axisIndex = t, this._backup, this._valueWindow, this._percentWindow, this._dataExtent,
					this.ecModel = r, this._model = i
			};
		return l.prototype = {
			constructor: l,
			hostedBy: function(e) {
			...
			reset: function(e) {
				if (e === this._model) {
					var r = this._dimName,
						...
						s = t(r, o),
						l = i(e, s, a);
					this._dataExtent = s.slice(), this._valueWindow = l.valueWindow.slice(), this._percentWindow = l.percentWindow
						.slice()
				}
			},
	...
	}), t("echarts/component/dataZoom/DataZoomModel", ["require", "zrender/core/util", "zrender/core/env",
		"../../echarts", "../../util/model", "./AxisProxy"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("zrender/core/env"),
			r = e("../../echarts"),
			n = e("../../util/model"),
			a = e("./AxisProxy"),
			o = t.each,
		...
		return r.extendComponentModel({
			...
			init: function(e, t, i) {
				this._autoMode, this._dataIntervalByAxis = {}, this._dataInfo = {}, this._axisProxies = {}, this.textStyleModel,
					this.mergeDefaultAndTheme(e, i), this.mergeOption({}, !0)
			},
			mergeOption: function(e, r) {
				var n = this.option;
				e && t.merge(n, e), i.canvasSupported || (n.realtime = !1), this.textStyleModel = this.getModel("textStyle"),
					this._resetTarget(e, r), this._giveAxisProxies(), this._backup()
			},
			...
			_resetAutoMode: function(e, t) {
				var i = t ? this.option : e,
					r = !1;
				s(function(e) {
					null != i[e.axisIndex] && (r = !0)
				}, this);
				var n = i.orient;
				null == n && r ? this._autoMode = "orient" : (null == n && (this.option.orient = "horizontal"), r || (this._autoMode =
					"axisIndex"))
			},
			_autoSetAxisIndex: function() {
				var e = "axisIndex" === this._autoMode,
					i = this.get("orient"),
					r = this.option;
				if (e) {
					var n = "vertical" === i ? {
				...
				e && s(function(t) {
					if (e) {
						var i = [],
							n = this.dependentModels[t.axis];
						if (n.length && !i.length)
							for (var a = 0, o = n.length; o > a; a++) "category" === n[a].get("type") && i.push(a);
			...
			_isSeriesHasAllAxesTypeOf: function(e, t) {
				var i = !0;
				return s(function(r) {
					var n = e.get(r.axisIndex),
						a = this.dependentModels[r.axis][n];
					a && a.get("type") === t || (i = !1)
				}, this), i
			},
			_backup: function() {
			...
			getPercentRange: function() {
				var e = this._axisProxies;
				for (var t in e)
					if (e.hasOwnProperty(t) && e[t].hostedBy(this)) return e[t].getDataPercentWindow();
				for (var t in e)
					if (e.hasOwnProperty(t) && !e[t].hostedBy(this)) return e[t].getDataPercentWindow()
			}
		})
		...
		return e.throttle = function(e, t, i, r) {
			function n(n) {
				...
				var f = function() {
					l = (new Date).getTime(), o = this, s = arguments, a = l - (r ? c : u) - t, clearTimeout(h), r ? i ? h =
						setTimeout(p, t) : a >= 0 && p() : a >= 0 ? p() : i && (h = setTimeout(p, -a)), c = l
				};
		...
		return function(e, t, i, r, n) {
			function a(e, t, i) {
				...
				return t[0] > t[1] && r.reverse(), 0 > e && r[0] + e < i[0] && (e = i[0] - r[0]), e > 0 && r[1] + e > i[1] && (
					e = i[1] - r[1]), e
			}
			return e ? ("rigid" === r ? (e = a(e, t, i), t[0] += e, t[1] += e) : (e = a(e, t[n], i), t[n] += e, "push" ===
				r && t[0] > t[1] && (t[1 - n] = t[n])), t) : t
		}
	}), t("echarts/component/dataZoom/SliderZoomView", ["require", "zrender/core/util", "../../util/graphic",
		"../../util/throttle", "./DataZoomView", "../../util/number", "../../util/layout", "../helper/sliderMove"
	], function(e) {
		function t(e) {
			return "x" === e ? "y" : "x"
		}
		...
		return a.extend({
			type: "dataZoom.slider",
			init: function(e, t) {
				this._displayables = {}, this._orient, this._range, this._handleEnds, this._size, this._halfHandleSize, this._location,
					this._dragging, this._dataShadowInfo, this.api = t
			},
			render: function(e, t, i, r) {
				return this.$superApply("render", arguments), n.createOrUpdate(this, "_dispatchZoomAction", this.dataZoomModel
					.get("throttle"), "fixRate"), this._orient = e.get("orient"), this._halfHandleSize = p(e.get("handleSize") /
					2), this.dataZoomModel.get("show") === !1 ? void this.group.removeAll() : (r && "dataZoom" === r.type && r.from ===
					this.uid || this._buildView(), void this._updateView())
			},
			remove: function() {
			...
			_getViewExtent: function() {
				var e = this._halfHandleSize,
					t = f(this._size[0], 4 * e),
					i = [e, t - e];
				return i
			},
			...
			_renderDataShadow: function() {
				...
				if (e) {
					var t = this._size,
						i = e.series,
						n = i.getRawData(),
						a = i.getShadowDim ? i.getShadowDim() : e.otherDim,
						o = n.getDataExtent(a),
						s = .3 * (o[1] - o[0]);
					o = [o[0] - s, o[1] + s];
					var c = [0, t[1]],
			...
			_updateInterval: function(e, t) {
				...
				u(t, i, r, "all" === e || this.dataZoomModel.get("zoomLock") ? "rigid" : "cross", e), this._range = h(l(i, r,
					[0, 100], !0))
			},
			...
			_updateDataInfo: function() {
				function e(e) {
					var t = r.getTransform(i.handles[e], this.group),
						s = r.transformDirection(0 === e ? "right" : "left", t),
			...
			_formatLabel: function(e, t) {
				var r = this.dataZoomModel,
					n = r.get("labelFormatter");
				if (i.isFunction(n)) return n(e);
				var a = r.get("labelPrecision");
				return (null == a || "auto" === a) && (a = t.getPixelPrecision()), e = null == e && isNaN(e) ? "" :
					"category" === t.type || "time" === t.type ? t.scale.getLabel(Math.round(e)) : e.toFixed(Math.min(a, 20)), i
					.isString(n) && (e = n.replace("{value}", e)), e
			},
			...
			_findCoordRect: function() {
				...
				if (t.cartesians.length) e = t.cartesians[0].model.coordinateSystem.getRect();
				else {
	...
	}), t("echarts/component/dataZoom/InsideZoomView", ["require", "./DataZoomView", "../../util/throttle",
		"zrender/core/util", "../helper/sliderMove", "../../component/helper/RoamController"
	], function(e) {
		function t(e, t, i, n) {
			t = t.slice();
			...
			if (a) {
				var o = r(e, a, i),
					s = o.signal * (t[1] - t[0]) * o.pixel / o.pixelLength;
		...
		function r(e, t, i) {
			var r = t.axis,
				n = i.rect,
				a = {};
			return "x" === r.dim ? (a.pixel = e[0], a.pixelLength = n.width, a.pixelStart = n.x, a.signal = r.inverse ? 1 : -
				1) : (a.pixel = e[1], a.pixelLength = n.height, a.pixelStart = n.y, a.signal = r.inverse ? -1 : 1), a
		}

		function n(e) {
			var t = [0, 100];
			return !(e[0] <= t[1]) && (e[0] = t[1]), !(e[1] <= t[1]) && (e[1] = t[1]), !(e[0] >= t[0]) && (e[0] = t[0]), !(e[
				1] >= t[0]) && (e[1] = t[0]), e
		}
		var a = e("./DataZoomView"),
			o = e("../../util/throttle"),
			s = e("zrender/core/util"),
			l = e("../helper/sliderMove"),
			c = e("../../component/helper/RoamController"),
			u = s.bind;
		return a.extend({
			type: "dataZoom.inside",
			init: function(e, t) {
			...
			render: function(e, t, i, r) {
				this.$superApply("render", arguments), o.createOrUpdate(this, "_dispatchZoomAction", this.dataZoomModel.get(
						"throttle"), "fixRate"), r && "dataZoom" === r.type && r.from === this.uid || (this._range = e.getPercentRange()),
			...
			_resetController: function(e) {
				...
				s.each(i.cartesians, function(i) {
					var r = "cartesian" + i.coordIndex,
						n = t[r];
					n || (n = t[r] = new c(e.getZr()), n.enable(), n.on("pan", u(this._onPan, this, n, i)), n.on("zoom", u(
						this._onZoom, this, n, i))), n.rect = i.model.coordinateSystem.getRect().clone()
				}, this)
			},
		...
		function t(e, t, i, r) {
			var a = e.name,
				o = i.getAxisProxy(a, t);
			o.reset(i);
			var s = o.getDataPercentWindow(),
				l = o.getDataValueWindow(),
				c = r.getComponent(e.axis, t),
				u = 0 === s[0] && 100 === s[1],
				h = o.getBackup(),
				d = n.getPixelPrecision(l, [0, 500]),
				p = !(20 > d && d >= 0);
			c.setNeedsCrossZero && c.setNeedsCrossZero(u ? !h.scale : !1), c.setMin && c.setMin(u || p ? h.min : +l[0].toFixed(
				d)), c.setMax && c.setMax(u || p ? h.max : +l[1].toFixed(d))
		}
	...
	}), t("echarts/component/dataZoom/dataZoomAction", ["require", "zrender/core/util", "../../util/model",
		"../../echarts"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../../util/model"),
	...
	}), t("echarts/component/dataZoom", ["require", "./dataZoom/typeDefaulter", "./dataZoom/DataZoomModel",
		"./dataZoom/DataZoomView", "./dataZoom/SliderZoomModel", "./dataZoom/SliderZoomView", "./dataZoom/InsideZoomModel",
		"./dataZoom/InsideZoomView", "./dataZoom/dataZoomProcessor", "./dataZoom/dataZoomAction"
	], function(e) {
		e("./dataZoom/typeDefaulter"), e("./dataZoom/DataZoomModel"), e("./dataZoom/DataZoomView"), e(
			"./dataZoom/SliderZoomModel"), e("./dataZoom/SliderZoomView"), e("./dataZoom/InsideZoomModel"), e(
			"./dataZoom/InsideZoomView"), e("./dataZoom/dataZoomProcessor"), e("./dataZoom/dataZoomAction")
			...
			i.isArray(n) || (n = n ? [n] : []), r(n, function(e) {
				if (e) {
					...
					n && i.isArray(n) && r(n, function(e) {
						i.isObject(e) && (t(e, "start") && !t(e, "min") && (e.min = e.start), t(e, "end") && !t(e, "max") && (e.max =
							e.end))
					})
				}
			})
		...
		e("../../model/Component").registerSubTypeDefaulter("visualMap", function(e) {
			return e.categories || (e.pieces ? e.pieces.length > 0 : e.splitNumber > 0) && !e.calculable ? "piecewise" :
				"continuous"
		})
	}), t("echarts/component/visualMap/visualCoding", ["require", "../../echarts", "../../visual/VisualMapping",
		"zrender/core/util"
	], function(e) {
		function t(e, t) {
			var i = e.targetVisuals,
				a = {};
		...
		return i
	}), t("echarts/component/visualMap/VisualMapModel", ["require", "zrender/core/util", "zrender/core/env",
		"../../echarts", "../../util/model", "../../visual/visualDefault", "../../visual/VisualMapping",
		"../../util/number"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("zrender/core/env"),
			r = e("../../echarts"),
			n = e("../../util/model"),
			a = e("../../visual/visualDefault"),
			o = e("../../visual/VisualMapping"),
			s = o.mapVisual,
			l = o.eachVisual,
			c = e("../../util/number"),
			u = t.isArray,
		...
		return r.extendComponentModel({
			...
			init: function(e, t, i) {
				this._autoSeriesIndex = !1, this._dataExtent, this.controllerVisuals = {}, this.targetVisuals = {}, this.textStyleModel,
					this.itemSize, this.mergeDefaultAndTheme(e, i), this.doMergeOption({}, !0)
			},
			mergeOption: function(e) {
			...
			doMergeOption: function(e, t) {
				var r = this.option;
				i.canvasSupported || (r.realtime = !1), this.textStyleModel = this.getModel("textStyle"), this.resetItemSize(),
			...
			formatValueText: function(e, i) {
				...
				var n, a, o = this.option,
					...
					l = this.dataBound,
					c = o.formatter;
				return t.isArray(e) && (e = e.slice(), n = !0), a = i ? e : n ? [r(e[0]), r(e[1])] : r(e), t.isString(c) ? c.replace(
						"{value}", n ? a[0] : a).replace("{value2}", n ? a[1] : a) : t.isFunction(c) ? n ? c(e[0], e[1]) : c(e) : n ?
					e[0] === l[0] ? "< " + a[1] : e[1] === l[1] ? "> " + a[0] : a[0] + " - " + a[1] : a
			},
			resetTargetSeries: function(e, t) {
				var i = this.option,
					r = this._autoSeriesIndex = null == (t ? i : e).seriesIndex;
			...
			completeVisualOption: function() {
				...
				function r(e) {
					...
					h(this.stateList, function(a) {
						...
						c || (c = e[a] = {
							color: g ? n : [n]
						}), c.symbol || (c.symbol = i && t.clone(i) || (g ? "roundRect" : ["roundRect"])), c.symbolSize || (c.symbolSize =
							r && t.clone(r) || (g ? o[0] : [o[0], o[0]])), c.symbol = s(c.symbol, function(e) {
				...
				e.call(this, d), e.call(this, f), i.call(this, d, "inRange", "outOfRange"), i.call(this, d, "outOfRange",
					"inRange"), r.call(this, f)
			},
	...
	}), t("echarts/component/visualMap/ContinuousModel", ["require", "./VisualMapModel", "zrender/core/util",
		"../../util/number"
	], function(e) {
		var t = e("./VisualMapModel"),
			i = e("zrender/core/util"),
			r = e("../../util/number"),
			n = [20, 140];
		return t.extend({
			...
			doMergeOption: function(e, t) {
				this.$superApply("doMergeOption", arguments), this.resetTargetSeries(e, t), this.resetExtent(), this.resetVisual(
					function(e) {
			...
			resetItemSize: function() {
				...
				var e = this.itemSize;
				"horizontal" === this._orient && e.reverse(), (null == e[0] || isNaN(e[0])) && (e[0] = n[0]), (null == e[1] ||
					isNaN(e[1])) && (e[1] = n[1])
			},
			...
			getSelected: function() {
				var e = this.getExtent(),
					t = r.asc((this.get("range") || []).slice());
				return t[0] > e[1] && (t[0] = e[1]), t[1] > e[1] && (t[1] = e[1]), t[0] < e[0] && (t[0] = e[0]), t[1] < e[0] &&
					(t[1] = e[0]), t
			},
	...
	}), t("echarts/component/visualMap/VisualMapView", ["require", "../../echarts", "zrender/core/util",
		"../../util/graphic", "../../util/format", "../../util/layout", "../../visual/VisualMapping"
	], function(e) {
		var t = e("../../echarts"),
			i = e("zrender/core/util"),
			r = e("../../util/graphic"),
		...
		return t.extendComponentView({
			...
			render: function(e, t, i, r) {
				return this.visualMapModel = e, e.get("show") === !1 ? void this.group.removeAll() : void this.doRender.apply(
					this, arguments)
			},
			renderBackground: function(e) {
				var t = this.visualMapModel,
					i = n.normalizeCssArray(t.get("padding") || 0),
					a = e.getBoundingRect();
				e.add(new r.Rect({
					z2: -1,
					silent: !0,
			...
			getControllerVisual: function(e, t, r) {
				...
				var c = s.controllerVisuals[t || s.getValueState(e)],
					u = s.get("contentColor"),
					h = {
			...
			positionGroup: function(e) {
				var t = this.visualMapModel,
					i = this.api;
				a.positionGroup(e, t.getBoxLayoutParams(), {
					width: i.getWidth(),
					height: i.getHeight()
				})
			},
			...
			i = {
				getItemAlign: function(e, i, r) {
					...
					for (var o = {
							...
							["left", "right", "width"],
							["top", "bottom", "height"]
						], c = l[s], u = [0, null, 10], h = {}, d = 0; 3 > d; d++) h[l[1 - s][d]] = u[d], h[c[d]] = 2 === d ? r[0] :
						n[c[d]];
					var p = [
							["x", "width", 3],
							["y", "height", 0]
						][s],
						f = t.getLayoutRect(h, o, n.padding);
					return c[(f.margin[p[2]] || 0) + f[p[0]] + .5 * f[p[1]] < .5 * o[p[1]] ? 0 : 1]
				}
			};
		return i
	}), t("echarts/component/visualMap/ContinuousView", ["require", "./VisualMapView", "../../util/graphic",
		"zrender/core/util", "../../util/number", "../helper/sliderMove", "zrender/graphic/LinearGradient", "./helper"
	], function(e) {
		function t(e, t, i) {
			return new n.Polygon({
				shape: {
					points: e
				},
				draggable: !!t,
		...
		var r = e("./VisualMapView"),
			n = e("../../util/graphic"),
			a = e("zrender/core/util"),
			o = e("../../util/number"),
			s = e("../helper/sliderMove"),
			l = o.linearMap,
			c = e("zrender/graphic/LinearGradient"),
			u = e("./helper"),
			h = a.each,
			d = r.extend({
				type: "visualMap.continuous",
				init: function() {
					r.prototype.init.apply(this, arguments), this._shapes = {}, this._dataInterval = [], this._handleEnds = [],
						this._orient, this._useHandle
				},
				...
				_buildView: function() {
					...
					var e = this.visualMapModel,
						t = this.group;
					this._orient = e.get("orient"), this._useHandle = e.get("calculable"), this._resetInterval(), this._renderBar(
						t);
					var i = e.get("text");
					this._renderEndsText(t, i, 0), this._renderEndsText(t, i, 1), this._updateView(!0), this.renderBackground(t),
						this._updateView(), this.positionGroup(t)
				},
				...
				_renderBar: function(e) {
					var i = this.visualMapModel,
						...
						o = this._orient,
						s = this._useHandle,
						l = u.getItemAlign(i, this.api, n),
						c = r.barGroup = this._createBarGroup(l);
					c.add(r.outOfRange = t()), c.add(r.inRange = t(null, a.bind(this._modifyHandle, this, "all"), s ? "move" :
						null));
					var h = i.textStyleModel.getTextRect("国"),
						d = Math.max(h.width, h.height);
					s && (r.handleGroups = [], r.handleThumbs = [], r.handleLabels = [], r.handleLabelPoints = [], this._createHandle(
						c, 0, n, d, o, l), this._createHandle(c, 1, n, d, o, l)), e.add(c)
				},
				_createHandle: function(e, r, o, s, l) {
					var c = new n.Group({
							position: [o[0], 0]
						}),
						u = t(i(r, s), a.bind(this._modifyHandle, this, r), "move");
					c.add(u);
					var h = {
				...
				_updateInterval: function(e, t) {
					...
					var i = this.visualMapModel,
						r = this._handleEnds;
					s(t, r, [0, i.itemSize[1]], "all" === e ? "rigid" : "push", e), this._dataInterval = l(r, [0, i.itemSize[1]],
						i.getExtent(), !0)
				},
				_updateView: function(e) {
					var t = this.visualMapModel,
						i = t.getExtent(),
						r = this._shapes,
						n = this._dataInterval,
						a = [0, t.itemSize[1]],
						o = e ? a : this._handleEnds,
						s = this._createBarVisual(n, i, o, "inRange"),
						l = this._createBarVisual(i, i, a, "outOfRange");
					r.inRange.setStyle("fill", s.barColor).setShape("points", s.barPoints), r.outOfRange.setStyle("fill", l.barColor)
						.setShape("points", l.barPoints), this._useHandle && h([0, 1], function(e) {
				...
				_createBarVisual: function(e, t, i, r) {
					var n = this.getControllerVisual(e, r, "color").color,
						a = [this.getControllerVisual(e[0], r, "symbolSize").symbolSize, this.getControllerVisual(e[1], r,
				...
				_updateHandlePosition: function(e) {
					if (this._useHandle) {
						...
						h([0, 1], function(i) {
							...
							r.position[1] = e[i];
							var a = t.handleLabelPoints[i],
								o = n.applyTransform([a.x, a.y], n.getTransform(r, this.group));
							t.handleLabels[i].setStyle({
								x: o[0],
								y: o[1]
							})
						}, this)
	...
	}), t("echarts/component/visualMapContinuous", ["require", "../echarts", "./visualMap/preprocessor",
		"./visualMap/typeDefaulter", "./visualMap/visualCoding", "./visualMap/ContinuousModel",
		"./visualMap/ContinuousView", "./visualMap/visualMapAction"
	], function(e) {
		e("../echarts").registerPreprocessor(e("./visualMap/preprocessor")), e("./visualMap/typeDefaulter"), e(
			"./visualMap/visualCoding"), e("./visualMap/ContinuousModel"), e("./visualMap/ContinuousView"), e(
			"./visualMap/visualMapAction")
	}), t("echarts/component/visualMap/PiecewiseModel", ["require", "./VisualMapModel", "zrender/core/util",
		...
		var i = e("./VisualMapModel"),
			r = e("zrender/core/util"),
			n = e("../../visual/VisualMapping"),
			a = i.extend({
				...
				doMergeOption: function(e, t) {
					...
					this.resetVisual(function(e, t) {
						"categories" === i ? (e.mappingMethod = "category", e.categories = r.clone(n)) : (e.mappingMethod =
							"piecewise", e.pieceList = r.map(this._pieceList, function(e) {
								var e = r.clone(e);
			...
			o = {
				...
				pieces: function() {
					...
					r.each(e.pieces, function(e, t) {
						...
						if (null != e.label && (a.text = e.label, i = !0), e.hasOwnProperty("value")) a.value = e.value, i || (a.text =
							this.formatValueText(a.value));
						else {
							var o = e.min,
								s = e.max;
							null == o && (o = -(1 / 0)), null == s && (s = 1 / 0), o === s && (a.value = o), a.interval = [o, s], i ||
								(a.text = this.formatValueText([o, s]))
						}
		...
		return a
	}), t("echarts/component/visualMap/PiecewiseView", ["require", "./VisualMapView", "zrender/core/util",
		"../../util/graphic", "../../util/symbol", "../../util/layout", "./helper"
	], function(e) {
		var t = e("./VisualMapView"),
			i = e("zrender/core/util"),
			r = e("../../util/graphic"),
			n = e("../../util/symbol"),
			a = e("../../util/layout"),
			...
			s = t.extend({
				...
				doRender: function() {
					function e(e) {
						var n = new r.Group;
						n.onclick = i.bind(this._onItemClick, this, e.piece), this._createItemSymbol(n, e.piece, [0, 0, h[0], h[1]]),
							p && n.add(new r.Text({
								style: {
									x: "right" === u ? -o : h[0] + o,
									y: h[1] / 2,
					...
					var n = this.visualMapModel,
						...
						p = !d.endsText,
						f = !p;
					f && this._renderEndsText(t, d.endsText[0], h), i.each(d.pieceList, e, this), f && this._renderEndsText(t, d.endsText[
						1], h), a.box(n.get("orient"), t, n.get("itemGap")), this.renderBackground(t), this.positionGroup(t)
				},
				...
				_createItemSymbol: function(e, t, i) {
					var r;
					if (this.visualMapModel.isCategory()) r = t.value;
					else if (null != t.value) r = t.value;
					else {
						var a = t.interval || [];
						r = (a[0] + a[1]) / 2
					}
		...
		return s
	}), t("echarts/component/visualMapPiecewise", ["require", "../echarts", "./visualMap/preprocessor",
		"./visualMap/typeDefaulter", "./visualMap/visualCoding", "./visualMap/PiecewiseModel", "./visualMap/PiecewiseView",
		"./visualMap/visualMapAction"
	], function(e) {
		e("../echarts").registerPreprocessor(e("./visualMap/preprocessor")), e("./visualMap/typeDefaulter"), e(
			"./visualMap/visualCoding"), e("./visualMap/PiecewiseModel"), e("./visualMap/PiecewiseView"), e(
			"./visualMap/visualMapAction")
	...
	}), t("echarts/component/marker/MarkPointModel", ["require", "../../model/globalDefault", "../../util/model",
		"../../echarts"
	], function(e) {
		var t = e("../../model/globalDefault"),
			i = e("../../util/model");
		t.markPoint = {};
		...
		function i(e, i, r, n, a) {
			var o = i.getDataExtent(n),
				s = [],
				l = o[0],
				c = o[1],
				u = (c - l) * e + l,
				h = i.indexOfNearest(n, u);
		...
		var r = e("zrender/core/util"),
			...
			s = function(e, t, i) {
				if ((isNaN(i.x) || isNaN(i.y)) && !r.isArray(i.coord) && t) {
					var n, a, s, l;
					null != i.valueIndex ? (n = t.dimensions[i.valueIndex], a = t.dimensions[1 - i.valueIndex], s = t.getAxis(n), l =
						t.getAxis(a)) : (l = t.getBaseAxis(), s = t.getOtherAxis(l), a = l.dim, n = s.dim);
					var c = null != i.valueIndex ? i.valueIndex : "angle" === n || "x" === n ? 0 : 1;
					i = r.extend({}, i), i.type && o[i.type] && l && s ? i.coord = o[i.type](e, l.dim, n, c) : i.coord = [null != i
						.xAxis ? i.xAxis : i.radiusAxis, null != i.yAxis ? i.yAxis : i.angleAxis
					]
				}
				return i
			},
	...
	}), t("echarts/component/marker/MarkPointView", ["require", "../../chart/helper/SymbolDraw", "zrender/core/util",
		"../../util/format", "../../util/model", "../../util/number", "../../data/List", "./markerHelper", "../../echarts"
	], function(e) {
		function t(e, t, i) {
			var n = t.dimensions,
				a = new c(r.map(n, t.getDimensionInfo, t), i);
			return e && a.initData(r.filter(r.map(i.get("data"), r.curry(u.dataTransform, t, e)), r.curry(u.dataFilter, e)),
				null, u.dimValueGetter), a
		}
		var i = e("../../chart/helper/SymbolDraw"),
			r = e("zrender/core/util"),
			n = e("../../util/format"),
			a = e("../../util/model"),
			o = e("../../util/number"),
			...
			h = {
				...
				formatTooltip: function(e) {
					var t = this.getData(),
						i = this.getRawValue(e),
						n = r.isArray(i) ? r.map(i, s).join(", ") : s(i),
						a = t.getName(e);
		...
		r.defaults(h, a.dataFormatMixin), e("../../echarts").extendComponentView({
			...
			_renderSeriesMP: function(e, n, a) {
				...
				r.mixin(n, h), n.setData(p), p.each(function(e) {
					var t, i = p.getItemModel(e),
						r = i.getShallow("x"),
						l = i.getShallow("y");
					if (null != r && null != l) t = [o.parsePercent(r, a.getWidth()), o.parsePercent(l, a.getHeight())];
					else if (s) {
						var u = p.get(f[0], e),
							h = p.get(f[1], e);
						t = s.dataToPoint([u, h])
	...
	}), t("echarts/component/marker/MarkLineModel", ["require", "../../model/globalDefault", "../../util/model",
		"../../echarts"
	], function(e) {
		var t = e("../../model/globalDefault"),
			i = e("../../util/model");
		...
		return r
	}), t("echarts/component/marker/MarkLineView", ["require", "zrender/core/util", "../../data/List",
		"../../util/format", "../../util/model", "../../util/number", "./markerHelper", "../../chart/helper/LineDraw",
		"../../echarts"
	], function(e) {
		function t(e, t) {
		...
		var r = e("zrender/core/util"),
			...
			d = function(e, t, i, n, a) {
				...
				if (!r.isArray(a) && "min" === o || "max" === o || "average" === o) {
					...
					var f = "average" === o ? .5 : "max" === o ? 1 : 0,
						g = (p[1] - p[0]) * f + p[0];
					g = n.coordToData(n.dataToCoord(g)), h[l] = d[l] = g, a = [h, d, {
						type: o
					}]
				}
				return a = [u.dataTransform(e, t, a[0]), u.dataTransform(e, t, a[1]), {}], r.merge(a[2], a[0]), r.merge(a[2], a[
					1]), a
			},
			p = {
				formatTooltip: function(e) {
		...
		r.defaults(p, o.dataFormatMixin), e("../../echarts").extendComponentView({
			...
			_renderSeriesML: function(e, t, n, a) {
				function o(e, t, i) {
					var r, n = e.getItemModel(t),
						o = n.get("x"),
						c = n.get("y");
					if (null != o && null != c) r = [s.parsePercent(o, a.getWidth()), s.parsePercent(c, a.getHeight())];
					else {
						var h = e.get(m[0], t),
							d = e.get(m[1], t);
						r = l.dataToPoint([h, d])
				...
				r.isArray(_) || (_ = [_, _]), "number" == typeof b && (b = [b, b]), g.from.each(function(e) {
					...
					x.setItemVisual(e, {
						color: t || v.getItemVisual(e, "color")
		...
		function t(e) {
			...
			if (a[t] && (e.axisType = a[t], delete e.type), i(e), r(e, "controlPosition")) {
				...
				r(o, "position") || (o.position = e.controlPosition), "none" !== o.position || r(o, "show") || (o.show = !1,
					delete o.position), delete e.controlPosition
			}
		...
		function i(e) {
			var t = e.itemStyle || (e.itemStyle = {}),
				...
				a = (t.normal || (t.normal = {}), e.label || e.label || {}),
				o = a.normal || (a.normal = {}),
				s = {
					normal: 1,
					emphasis: 1
		...
		t.registerAction({
			...
			i && null != e.currentIndex && (i.setCurrentIndex(e.currentIndex), !i.get("loop", !0) && i.isIndexMax() && i.setPlayState(
				!1)), t.resetOption("timeline")
		}), t.registerAction({
	...
	}), t("echarts/component/timeline/TimelineModel", ["require", "../../model/Component", "../../data/List",
		"zrender/core/util", "../../util/model"
	], function(e) {
		var t = e("../../model/Component"),
			i = e("../../data/List"),
			r = e("zrender/core/util"),
			...
			a = t.extend({
				...
				setCurrentIndex: function(e) {
					...
					this.option.loop ? e = (e % t + t) % t : (e >= t && (e = t - 1), 0 > e && (e = 0)), this.option.currentIndex =
						e
				},
				...
				_initData: function() {
					...
					if ("category" === a) {
						...
						r.each(t, function(e, t) {
							...
							r.isObject(e) ? (i = r.clone(e), i.value = t) : i = t, s.push(i), r.isString(a) || null != a && !isNaN(a) ||
								(a = ""), o.push(a + "")
						}), t = s
					}
					var l = {
	...
	}), t("echarts/component/timeline/TimelineAxis", ["require", "zrender/core/util", "../../coord/Axis",
		"../../coord/axisHelper"
	], function(e) {
		var t = e("zrender/core/util"),
			i = e("../../coord/Axis"),
		...
		return n.prototype = {
			...
			getLabelInterval: function() {
				var e = this.model,
					i = e.getModel("label.normal"),
					n = i.get("interval");
				if (null != n && "auto" != n) return n;
				var n = this._autoLabelInterval;
				return n || (n = this._autoLabelInterval = r.getAxisLabelInterval(t.map(this.scale.getTicks(), this.dataToCoord,
						this), r.getFormattedLabels(this, i.get("formatter")), i.getModel("textStyle").getFont(), "horizontal" ===
					e.get("orient"))), n
			},
			isLabelIgnored: function(e) {
				if ("category" === this.type) {
	...
	}), t("echarts/component/timeline/SliderTimelineView", ["require", "zrender/core/util", "../../util/graphic",
		"../../util/layout", "./TimelineView", "./TimelineAxis", "../../util/symbol", "../../coord/axisHelper",
		"zrender/core/BoundingRect", "zrender/core/matrix", "../../util/number", "../../util/model", "../../util/format"
	], function(e) {
		function t(e, t) {
		...
		function r(e, t, i, r, n, o) {
			...
			return n ? (n.setStyle(d), n.setColor(l), i.add(n), o && o.onUpdate(n)) : (n = u.createSymbol(s, -h, -h, c, c, l),
				i.add(n), o && o.onCreate(n)), r = a.merge({
				rectHover: !0,
				style: d,
				z2: 100
			}, r, !0), n.attr(r), n
		...
		function n(e, t, i, r, n) {
			if (!e.dragging) {
				var a = r.getModel("checkpointStyle"),
					o = i.dataToCoord(r.getData().get(["value"], t));
				n || !a.get("animation", !0) ? e.attr({
					position: [o, 0]
				}) : (e.stopAnimation(!0), e.animateTo({
					position: [o, 0]
		...
		var a = e("zrender/core/util"),
			...
			c = e("./TimelineAxis"),
			u = e("../../util/symbol"),
			h = e("../../coord/axisHelper"),
			d = e("zrender/core/BoundingRect"),
			p = e("zrender/core/matrix"),
			f = e("../../util/number"),
			g = e("../../util/model"),
			m = e("../../util/format"),
			v = m.encodeHTML,
		...
		return l.extend({
			...
			_layout: function(e, i) {
				var r = e.get("label.normal.position"),
					n = e.get("orient"),
					a = t(e, i);
				null == r || "auto" === r ? r = "horizontal" === n ? a.y + a.height / 2 < i.getHeight() / 2 ? "-" : "+" : a.x +
					a.width / 2 < i.getWidth() / 2 ? "+" : "-" : isNaN(r) && (r = {
						horizontal: {
							top: "-",
							bottom: "+"
						},
				...
				var o = {
						horizontal: "center",
						vertical: r >= 0 || "+" === r ? "left" : "right"
					},
					s = {
						horizontal: r >= 0 || "+" === r ? "top" : "bottom",
						vertical: "middle"
					},
					l = {
						horizontal: 0,
					...
					c = "vertical" === n ? a.height : a.width,
					u = e.getModel("controlStyle"),
					h = u.get("show"),
					d = h ? u.get("itemSize") : 0,
					p = h ? u.get("itemGap") : 0,
					f = d + p,
					g = e.get("label.normal.rotate") || 0;
				g = g * _ / 180;
				var m, v, y, x, b = u.get("position", !0),
					h = u.get("show", !0),
					...
					A = 0,
					z = c;
				return "left" === b || "bottom" === b ? (w && (m = [0, 0], A += f), M && (v = [A, 0], A += f), S && (y = [z -
					d, 0
				], z -= f)) : (w && (m = [z - d, 0], z -= f), M && (v = [0, 0], A += f), S && (y = [z - d, 0], z -= f)), x = [
					A, z
				], e.get("inverse") && x.reverse(), {
					viewRect: a,
					mainLength: c,
					orient: n,
					rotation: l[n],
			...
			_position: function(e, t) {
				...
				if ("vertical" === e.orient) {
					var l = p.create(),
						c = s.x,
						u = s.y + s.height;
					p.translate(l, l, [-c, -u]), p.rotate(l, l, -_ / 2), p.translate(l, l, [c, u]), s = s.clone(), s.applyTransform(
						l)
				}
				var h = r(s),
					d = r(a.getBoundingRect()),
					f = r(o.getBoundingRect()),
					g = a.position,
					m = o.position;
				m[0] = g[0] = h[0][0];
				var v = e.labelPosOpt;
			...
			_renderAxisTick: function(e, t, i, n) {
				var a = n.getData(),
					s = i.scale.getTicks(),
					l = this._prepareTooltipHostModel(a, n);
				x(s, function(e, n) {
					var s = i.dataToCoord(e),
						c = a.getItemModel(n),
						...
						p = r(c, u, t, d);
					o.setHoverStyle(p, h.getItemStyle()), c.get("tooltip") ? (p.dataIndex = n, p.hostModel = l) : p.dataIndex =
						p.hostModel = null
				}, this)
			},
			_prepareTooltipHostModel: function(e, t) {
				var i = g.createDataFormatModel({}, e, t.get("data")),
					r = this;
			...
			_renderAxisLabel: function(e, t, i, r) {
				...
				if (n.get("show")) {
					var a = r.getData(),
						s = i.scale.getTicks(),
						l = h.getFormattedLabels(i, n.get("formatter")),
						c = i.getLabelInterval();
					x(s, function(r, n) {
						if (!i.isLabelIgnored(n, c)) {
							var s = a.getItemModel(n),
								u = s.getModel("label.normal.textStyle"),
			...
			_renderControl: function(e, t, r, n) {
				...
				var s = e.controlSize,
					...
					d = n.getPlayState(),
					p = n.get("inverse", !0);
				a(e.nextBtnPosition, "controlStyle.nextIcon", y(this._changeTimeline, this, p ? "-" : "+")), a(e.prevBtnPosition,
					"controlStyle.prevIcon", y(this._changeTimeline, this, p ? "+" : "-")), a(e.playPosition, "controlStyle." +
					(d ? "stopIcon" : "playIcon"), y(this._handlePlayClick, this, !d), !0)
			},
			_renderCurrentPointer: function(e, t, i, a) {
				var o = a.getData(),
					...
					u = {
						onCreate: function(e) {
							e.draggable = !0, e.drift = y(c._handlePointerDrag, c), e.ondragend = y(c._handlePointerDragend, c), n(e,
								s, i, a, !0)
						},
						onUpdate: function(e) {
							n(e, s, i, a)
			...
			_doPlayStop: function() {
				...
				this._clearTimer(), this.model.getPlayState() && (this._timer = setTimeout(y(e, this), this.model.get(
					"playInterval")))
			},
	...
	}), t("echarts/component/timeline", ["require", "../echarts", "./timeline/preprocessor", "./timeline/typeDefaulter",
		"./timeline/timelineAction", "./timeline/SliderTimelineModel", "./timeline/SliderTimelineView"
	], function(e) {
		var t = e("../echarts");
		t.registerPreprocessor(e("./timeline/preprocessor")), e("./timeline/typeDefaulter"), e("./timeline/timelineAction"),
			e("./timeline/SliderTimelineModel"), e("./timeline/SliderTimelineView")
	...
	}), t("echarts/component/toolbox/ToolboxModel", ["require", "./featureManager", "zrender/core/util", "../../echarts"],
		function(e) {
			var t = e("./featureManager"),
				i = e("zrender/core/util");
			e("../../echarts").extendComponentModel({
				type: "toolbox",
		...
		}), t("echarts/component/toolbox/ToolboxView", ["require", "./featureManager", "zrender/core/util",
		"../../util/graphic", "../../model/Model", "../../data/DataDiffer", "../helper/listComponent",
		"zrender/contain/text", "../../echarts"
	], function(e) {
		var t = e("./featureManager"),
			i = e("zrender/core/util"),
			r = e("../../util/graphic"),
			n = e("../../model/Model"),
			a = e("../../data/DataDiffer"),
			o = e("../helper/listComponent"),
			s = e("zrender/contain/text");
		return e("../../echarts").extendComponentView({
			type: "toolbox",
			render: function(e, l, c) {
				function u(i, r) {
					var a, o = m[i],
						s = m[r],
						u = f[o],
						d = new n(u, e, e.ecModel);
					if (o && !s) {
						var p = t.get(o);
						if (!p) return;
						g[o] = a = new p(d)
					...
					return !o && s ? void(a.dispose && a.dispose(l, c)) : d.get("show") ? (h(d, a, o), d.setIconStatus =
						function(e, t) {
							var i = this.option,
								r = this.iconPaths;
				...
				function h(t, n, a) {
					var o = t.getModel("iconStyle"),
						s = n.getIcons ? n.getIcons() : t.get("icon"),
						u = t.get("title") || {};
					if ("string" == typeof s) {
						var h = s,
							f = u;
					...
					i.each(s, function(a, s) {
						var h = o.getModel("normal").getItemStyle(),
							f = o.getModel("emphasis").getItemStyle(),
							m = r.makePath(a, {
								style: h,
								hoverStyle: f,
								rectHover: !0
						...
						})), m.trigger(t.get("iconStatus." + s) || "normal"), d.add(m), m.on("click", i.bind(n.onclick, n, l, c,
							s)), g[s] = m
					})
				}
				var d = this.group;
				if (d.removeAll(), e.get("show")) {
					var p = +e.get("itemSize"),
						f = e.get("feature") || {},
						g = this._features || (this._features = {}),
						m = [];
					i.each(f, function(e, t) {
							m.push(t)
						}), new a(this._featureNames || [], m).add(u).update(u).remove(i.curry(u, null)).execute(), this._featureNames =
						m, o.layout(d, e, c), o.addBackground(d, e), d.eachChild(function(e) {
							var t = e.__title,
								i = e.hoverStyle;
							if (i && t) {
								var r = s.getBoundingRect(t, i.font),
									n = e.position[0] + d.position[0],
									a = e.position[1] + d.position[1] + p,
									o = !1;
								a + r.height > c.getHeight() && (i.textPosition = "top", o = !0);
								var l = o ? -5 - r.height : p + 8;
								n + r.width / 2 > c.getWidth() ? (i.textPosition = ["100%", l], i.textAlign = "right") : n - r.width / 2 <
									0 && (i.textPosition = [0, l], i.textAlign = "left")
							}
						})
				}
			},
	...
	}), t("echarts/component/toolbox/feature/MagicType", ["require", "zrender/core/util", "../../../echarts",
		"../featureManager"
	], function(e) {
		function t(e) {
			this.model = e
	...
	}), t("echarts/component/toolbox/feature/DataView", ["require", "zrender/core/util", "zrender/core/event",
		"../featureManager", "../../../echarts"
	], function(e) {
		function t(e) {
			var t = {},
				i = [],
		...
		function i(e) {
			...
			return d.each(e, function(e, i) {
				var r = e.categoryAxis,
					n = e.valueAxis,
					a = n.dim,
					o = [" "].concat(d.map(e.series, function(e) {
						return e.name
					})),
		...
		function r(e) {
			return d.map(e, function(e) {
				...
				return t.each(t.dimensions, function() {
					for (var e = arguments.length, n = arguments[e - 1], a = t.getName(n), o = 0; e - 1 > o; o++) r[o] =
						arguments[o];
		...
		function h(e, t) {
			return d.map(e, function(e, i) {
				var r = t && t[i];
				return d.isObject(r) && !d.isArray(r) ? (d.isObject(e) && !d.isArray(e) && (e = e.value), d.defaults({
					value: e
				}, r)) : e
			})
		}
		var d = e("zrender/core/util"),
			p = e("zrender/core/event"),
			f = new Array(60).join("-"),
			g = "	",
			m = new RegExp("[" + g + "| ]+", "g");
		return u.defaultOption = {
			...
			o.style.cssText = "position:absolute;left:5px;top:5px;bottom:5px;right:5px;", o.style.backgroundColor = a.get(
				"backgroundColor") || "#fff";
			...
			u.style.cssText =
				"display:block;width:100%;font-size:14px;line-height:1.6rem;font-family:Monaco,Consolas,Courier new,monospace",
				u.readOnly = a.get("readOnly"), u.style.color = a.get("textColor"), u.style.borderColor = a.get(
					"textareaBorderColor"), u.style.backgroundColor = a.get("textareaColor");
			var h = n(e);
			u.value = h.value;
			var d = h.meta,
			...
			}), v.innerHTML = l[1], y.innerHTML = l[2], y.style.cssText = m, v.style.cssText = m, f.appendChild(y), f.appendChild(
				v), p.addEventListener(u, "keydown", function(e) {
				if (9 === (e.keyCode || e.which)) {
					var t = this.value,
						i = this.selectionStart,
						r = this.selectionEnd;
					this.value = t.substring(0, i) + g + t.substring(r), this.selectionStart = this.selectionEnd = i + 1, p.stop(
						e)
				}
			}), o.appendChild(s), o.appendChild(u), o.appendChild(f), u.style.height = r.clientHeight - 80 + "px", r.appendChild(
				o), this._dom = o
		...
		return e("./DataZoomView").extend({
			type: "dataZoom.select"
		})
	}), t("echarts/component/dataZoomSelect", ["require", "./dataZoom/typeDefaulter", "./dataZoom/DataZoomModel",
		"./dataZoom/DataZoomView", "./dataZoom/SelectZoomModel", "./dataZoom/SelectZoomView",
		"./dataZoom/dataZoomProcessor", "./dataZoom/dataZoomAction"
	], function(e) {
		e("./dataZoom/typeDefaulter"), e("./dataZoom/DataZoomModel"), e("./dataZoom/DataZoomView"), e(
			"./dataZoom/SelectZoomModel"), e("./dataZoom/SelectZoomView"), e("./dataZoom/dataZoomProcessor"), e(
			"./dataZoom/dataZoomAction")
	}), t("echarts/component/toolbox/feature/DataZoom", ["require", "zrender/core/util", "../../../util/number",
		"../../helper/SelectController", "zrender/core/BoundingRect", "zrender/container/Group", "../../dataZoom/history",
		"../../helper/interactionMutex", "../../dataZoomSelect", "../featureManager", "../../../echarts"
	], function(e) {
		function t(e) {
		...
		function i(e, t) {
			var i = [{
				axisModel: e.getAxis("x").model,
				axisIndex: 0
			}, {
				axisModel: e.getAxis("y").model,
				axisIndex: 0
			}];
			return i.grid = e, t.eachComponent({
				mainType: "dataZoom",
				subType: "select"
			}, function(e, n) {
				r("xAxis", i[0].axisModel, e, t) && (i[0].dataZoomModel = e), r("yAxis", i[1].axisModel, e, t) && (i[1].dataZoomModel =
					e)
			}), i
		}
		...
		function n(e, t) {
			var i = t.grid,
				r = new u(e[0][0], e[1][0], e[0][1] - e[0][0], e[1][1] - e[1][0]);
			if (r.intersect(i.getRect())) {
				var n = i.getCartesian(t[0].axisIndex, t[1].axisIndex),
					a = n.pointToData([e[0][0], e[1][0]], !0),
		...
		var s = e("zrender/core/util"),
			l = e("../../../util/number"),
			c = e("../../helper/SelectController"),
			u = e("zrender/core/BoundingRect"),
			h = e("zrender/container/Group"),
			d = e("../../dataZoom/history"),
			p = e("../../helper/interactionMutex"),
			f = s.each,
			g = l.asc;
		e("../../dataZoomSelect");
		...
		v.render = function(e, t, i) {
			...
			this._controllerGroup || (r = this._controllerGroup = new h, t.getZr().add(r)), y[i].call(this, r, this.model, e,
				t)
		...
		var y = {
			zoom: function(e, t, i, r) {
				var n = this._isZoomActive = !this._isZoomActive,
					a = r.getZr();
				p[n ? "take" : "release"]("globalPan", a), t.setIconStatus("zoom", n ? "emphasis" : "normal"), n ? (a.setDefaultCursorStyle(
					"crosshair"), this._createController(e, t, i, r)) : (a.setDefaultCursorStyle("default"), this._disposeController())
			},
	...
	}), t("echarts/component/toolbox/feature/Restore", ["require", "../../dataZoom/history", "../featureManager",
		"../../../echarts"
	], function(e) {
		function t(e) {
			this.model = e
	...
	}), t("echarts/component/toolbox", ["require", "./toolbox/ToolboxModel", "./toolbox/ToolboxView",
		"./toolbox/feature/SaveAsImage", "./toolbox/feature/MagicType", "./toolbox/feature/DataView",
		"./toolbox/feature/DataZoom", "./toolbox/feature/Restore"
	], function(e) {
		e("./toolbox/ToolboxModel"), e("./toolbox/ToolboxView"), e("./toolbox/feature/SaveAsImage"), e(
			"./toolbox/feature/MagicType"), e("./toolbox/feature/DataView"), e("./toolbox/feature/DataZoom"), e(
		...
		function t() {
			if (!o) {
				o = !0;
				var e = a.styleSheets;
				e.length < 31 ? a.createStyleSheet().addRule(".zrvml", "behavior:url(#default#VML)") : e[0].addRule(".zrvml",
	...
	}), t("zrender/vml/graphic", ["require", "../core/env", "../core/vector", "../core/BoundingRect",
		"../core/PathProxy", "../tool/color", "../contain/text", "../graphic/mixin/RectText", "../graphic/Displayable",
		"../graphic/Image", "../graphic/Text", "../graphic/Path", "../graphic/Gradient", "./core"
	], function(e) {
		function t(e) {
			e.style.cssText = "position:absolute;left:0;top:0;width:1px;height:1px;", e.coordsize = B + "," + B, e.coordorigin =
				"0,0"
		}
				...
				if (r instanceof L) {
					...
					if (S >= 2) {
						var D = A[0][0],
							...
							k = A[0][1] * t.opacity,
							V = A[1][1] * t.opacity;
						e.type = n, e.method = "none", e.focus = "100%", e.angle = a, e.color = D, e.color2 = P, e.colors = z.join(","),
							e.opacity = V, e.opacity2 = k
					}
		...
		function u(e, t) {
			null != t.lineJoin && (e.joinstyle = t.lineJoin), null != t.miterLimit && (e.miterlimit = t.miterLimit * B), null !=
				t.lineCap && (e.endcap = t.lineCap), null != t.lineDash && (e.dashstyle = t.lineDash.join(" ")), null == t.stroke ||
				t.stroke instanceof L || s(e, t.stroke, t.opacity)
		}

		function h(e, t, i, r) {
			var o = "fill" == t,
				s = e.getElementsByTagName(t)[0];
			null != i[t] && "none" !== i[t] && (o || !o && i.lineWidth) ? (e[o ? "filled" : "stroked"] = "true", i[t] instanceof L &&
				a(e, s), s || (s = I.createNode(t)), o ? c(s, i, r) : u(s, i), n(e, s)) : (e[o ? "filled" : "stroked"] =
				"false", a(e, s))
		}

		function d(e, t) {
			var i, r, n, a, o, s, l = _.M,
				c = _.C,
				u = _.L,
				h = _.A,
				d = _.Q,
				...
				switch (n = e[a++], r = "", i = 0, n) {
					...
					case c:
						...
						var f, g, m = e[a++],
							...
							y = e[a++],
							x = e[a++];
						n === d ? (f = y, g = x, y = (y + 2 * m) / 3, x = (x + 2 * v) / 3, m = (o + 2 * m) / 3, v = (s + 2 * v) / 3) :
							(f = e[a++], g = e[a++]), Z[0][0] = m, Z[0][1] = v, Z[1][0] = y, Z[1][1] = x, Z[2][0] = f, Z[2][1] = g, o = f,
							s = g;
						break;
					case h:
						var b = 0,
							...
							S = 1,
							A = 0;
						t && (b = t[4], w = t[5], M = D(t[0] * t[0] + t[1] * t[1]), S = D(t[2] * t[2] + t[3] * t[3]), A = Math.atan2(-
							t[1] / S, t[0] / M));
						var z = e[a++],
							C = e[a++],
							L = e[a++],
						...
						var q = e[a++],
							...
							v = C + V(R) * I,
							H = q ? " wa " : " at ";
						p.push(H, T(((z - L) * M + b) * B - N), E, T(((C - I) * S + w) * B - N), E, T(((z + L) * M + b) * B - N), E, T(
								((C + I) * S + w) * B - N), E, T((G * M + b) * B - N), E, T((F * S + w) * B - N), E, T((m * M + b) * B - N),
							E, T((v * S + w) * B - N)), o = m, s = v;
						break;
					case _.R:
						var W = Z[0],
							j = Z[1];
						W[0] = e[a++], W[1] = e[a++], j[0] = W[0] + e[a++], j[1] = W[1] + e[a++], t && (O(W, W, t), O(j, j, t)), W[0] =
							T(W[0] * B - N), j[0] = T(j[0] * B - N), W[1] = T(W[1] * B - N), j[1] = T(j[1] * B - N), p.push(" m ", W[0],
								E, W[1], " l ", j[0], E, W[1], " l ", j[0], E, j[1], " l ", W[0], E, j[1]);
						break;
					case _.Z:
						p.push(" x ")
				}
		...
		function g(e, r, a, s) {
			var l = this.style,
				c = l.text;
			if (c) {
				var u, d, p = l.textAlign,
					g = f(l.textFont),
					m = g.style + " " + g.variant + " " + g.weight + " " + g.size + 'px "' + g.family + '"',
					v = l.textBaseline;
				a = a || w.getBoundingRect(c, m, p, v);
				var y = this.transform;
				if (y && !s && (K.copy(r), K.applyTransform(y), r = K), s) u = r.x, d = r.y;
				else {
					var x = l.textPosition,
						_ = l.textDistance;
					if (x instanceof Array) u = r.x + x[0], d = r.y + x[1], p = p || "left", v = v || "top";
					else {
				...
				var S, A, z, C = I.createNode,
					L = this._textVmlEl;
				L ? (z = L.firstChild, S = z.nextSibling, A = S.nextSibling) : (L = C("line"), S = C("path"), A = C("textpath"),
					z = C("skew"), A.style["v-text-align"] = "left", t(L), S.textpathok = !0, A.on = !0, L.from = "0 0", L.to =
					"1000 0.05", n(L, z), n(L, S), n(L, A), this._textVmlEl = L);
				var D = [u, d],
					P = L.style;
				y && s ? (O(D, D, y), z.on = !0, z.matrix = y[0].toFixed(3) + E + y[2].toFixed(3) + E + y[1].toFixed(3) + E + y[
						3].toFixed(3) + ",0,0", z.offset = (T(D[0]) || 0) + "," + (T(D[1]) || 0), z.origin = "0 0", P.left = "0px", P
					.top = "0px") : (z.on = !1, P.left = T(u) + "px", P.top = T(d) + "px"), A.string = i(c);
				try {
					A.style.font = m
				} catch (k) {}
				h(L, "fill", {
		...
		if (!e("../core/env").canvasSupported) {
			var y = e("../core/vector"),
				x = e("../core/BoundingRect"),
				_ = e("../core/PathProxy").CMD,
				b = e("../tool/color"),
				w = e("../contain/text"),
				M = e("../graphic/mixin/RectText"),
				S = e("../graphic/Displayable"),
				A = e("../graphic/Image"),
				z = e("../graphic/Text"),
				C = e("../graphic/Path"),
				L = e("../graphic/Gradient"),
				I = e("./core"),
				T = Math.round,
				D = Math.sqrt,
				P = Math.abs,
				...
				O = y.applyTransform,
				E = ",",
				q = "progid:DXImageTransform.Microsoft",
				B = 21600,
				N = B / 2,
				G = 1e5,
				F = 1e3,
			...
			C.prototype.brush = function(e) {
				...
				var a = this.transform,
					s = null != a,
					l = r.getElementsByTagName("stroke")[0];
				if (l) {
					var c = i.lineWidth;
				...
				var p = this.path;
				this.__dirtyPath && (p.beginPath(), this.buildPath(p, this.shape), this.__dirtyPath = !1), r.path = d(p.data,
					this.transform), r.style.zIndex = o(this.zlevel, this.z, this.z2), n(e, r), i.text && this.drawRectText(e,
				...
				var i, r, a = this.style,
					s = a.image;
				if (p(s)) {
					var l = s.src;
					if (l === this._imageSrc) i = this._imageWidth, r = this._imageHeight;
					else {
						var c = s.runtimeStyle,
							u = c.width,
							h = c.height;
						c.width = "auto", c.height = "auto", i = s.width, r = s.height, c.width = u, c.height = h, this._imageSrc = l,
							this._imageWidth = i, this._imageHeight = r
					}
					s = l
				...
				if (s) {
					...
					var M, S = w.style,
						...
						z = 1,
						C = 1;
					if (this.transform && (M = this.transform, z = D(M[0] * M[0] + M[1] * M[1]), C = D(M[2] * M[2] + M[3] * M[3]),
							A = M[1] || M[2]), A) {
						var L = [d, f],
							P = [d + g, f],
							k = [d, f + m],
						...
						var B = R(L[0], P[0], k[0], V[0]),
							N = R(L[1], P[1], k[1], V[1]),
							G = [];
						G.push("M11=", M[0] / z, E, "M12=", M[2] / C, E, "M21=", M[1] / z, E, "M22=", M[3] / C, E, "Dx=", T(d * z + M[
								4]), E, "Dy=", T(f * C + M[5])), S.padding = "0 " + T(B) + "px " + T(N) + "px 0", S.filter = q + ".Matrix(" +
							G.join("") + ", SizingMethod=clip)"
					...
					var H = F.style;
					if (b) {
						if (i && r) H.width = T(z * i * g / v) + "px", H.height = T(C * r * m / y) + "px";
						else {
							var W = new Image,
								j = this;
							W.onload = function() {
								W.onload = null, i = W.width, r = W.height, H.width = T(z * i * g / v) + "px", H.height = T(C * r * m / y) +
									"px", j._imageWidth = i, j._imageHeight = r, j._imageSrc = s
							}, W.src = s
						}
						Z || (Z = I.doc.createElement("div"), Z.style.overflow = "hidden", this._cropEl = Z);
						var U = Z.style;
						U.width = T((g + x * g / v) * z), U.height = T((m + _ * m / y) * C), U.filter = q + ".Matrix(Dx=" + -x * g /
							v * z + ",Dy=" + -_ * m / y * C + ")", Z.parentNode || w.appendChild(Z), F.parentNode != Z && Z.appendChild(
								F)
					} else H.width = T(z * g) + "px", H.height = T(C * m) + "px", w.appendChild(F), Z && Z.parentNode && (w.removeChild(
						Z), this._cropEl = null);
					var Y = "",
						X = a.opacity;
					1 > X && (Y += ".Alpha(opacity=" + T(100 * X) + ") "), Y += q + ".AlphaImageLoader(src=" + s +
						", SizingMethod=scale)", H.filter = Y, w.style.zIndex = o(this.zlevel, this.z, this.z2), n(e, w), a.text &&
			...
			w.measureText = function(e, t) {
				var i = I.doc;
				H || (H = i.createElement("div"), H.style.cssText =
					"position:absolute;top:-20000px;left:0;                padding:0;margin:0;border:none;white-space:pre;", I.doc
					.body.appendChild(H));
				try {
					H.style.font = t
				} catch (r) {}
				return H.innerHTML = "", H.appendChild(i.createTextNode(e)), {
					width: H.offsetWidth
				}
			};
		...
		function i(e, t) {
			...
			i.style.cssText = "display:inline-block;overflow:hidden;position:relative;width:300px;height:150px;", r.style.cssText =
				"position:absolute;left:0;top:0;", e.appendChild(i), this._vmlRoot = r, this._vmlViewport = i, this.resize();
			var n = t.delFromMap,
				o = t.addToMap;
		...
		i.prototype = {
			...
			_paintList: function(e) {
				for (var t = this._vmlRoot, i = 0; i < e.length; i++) {
					var r = e[i];
					r.__dirty && !r.invisible && (r.beforeBrush && r.beforeBrush(), r.brush(t), r.afterBrush && r.afterBrush()),
						r.__dirty = !1
				}
		...
		for (var o = ["getLayer", "insertLayer", "eachLayer", "eachBuildinLayer", "eachOtherLayer", "getLayers",
	...
	var i = e("echarts");
	return e("echarts/chart/line"), e("echarts/chart/bar"), e("echarts/component/grid"), e("echarts/chart/pie"), e(
			"echarts/chart/scatter"), e("echarts/component/tooltip"), e("echarts/component/polar"), e("echarts/chart/radar"), e(
			"echarts/component/legend"), e("echarts/chart/map"), e("echarts/chart/treemap"), e("echarts/chart/graph"), e(
			"echarts/chart/gauge"), e("echarts/chart/funnel"), e("echarts/chart/parallel"), e("echarts/chart/sankey"), e(
			"echarts/chart/boxplot"), e("echarts/chart/candlestick"), e("echarts/chart/effectScatter"), e("echarts/chart/lines"),
		e("echarts/chart/heatmap"), e("echarts/component/geo"), e("echarts/component/parallel"), e("echarts/component/title"),
		e("echarts/component/dataZoom"), e("echarts/component/visualMap"), e("echarts/component/markPoint"), e(
			"echarts/component/markLine"), e("echarts/component/timeline"), e("echarts/component/toolbox"), e("zrender/vml/vml"),
		i
}),
function(e, t) {
	"function" == typeof define && define.amd ? define(["exports", "echarts"], t) : "object" == typeof exports && "string" !=
		typeof exports.nodeName ? t(exports, require("echarts")) : t({}, e.echarts)
}(this, function(e, t) {
	var i = function(e) {
	...
	return t ? t.registerMap ? void t.registerMap("china", {
		...
		features: [{
			...
			geometry: {
				type: "MultiPolygon",
				coordinates: [
					["@@\\aM`Ç½ÓnUKĜēs¤­©yrý§uģcJ»eIP]ªrºc_ħ²G¼s`jÎŸnüsÂľP", "@@U`Ts¿mÄ",
			...
			geometry: {
				type: "MultiPolygon",
				coordinates: [
					["@@L@@s]", "@@MnNm", "@@dc", "@@eÀC@b", "@@fXwkbrÄ`qg", "@@^jtWQ", "@@~ Y[c",
						"@@I`ĖN^_¿ZÁM", "@@Ïxǌ{q_×^Gigp", "@@iX¶BY", "@@YZ", "@@L_yG`b", "@@^WqCTZ", "@@\\[§t|]", "@@m`p[",
			...
			geometry: {
				type: "MultiPolygon",
				coordinates: [
					["@@jX^n", "@@sfdM", "@@qP\\xz[_i", "@@o\\VzRZ}mECy", "@@R¢FX}°[m]", "@@Cb\\}", "@@e|v\\laus",
						"@@v~s{", "@@QxÂF©}", "@@¹nvÞs©m", "@@rQgYIh", "@@bi«ZX", "@@p[}ILd", "@@À¿|", "@@¹dnb", "@@rS}[Kl",
						"@@g~h}", "@@FlCk", "@@ůTG°ĄLHm°UF", "@@OdRe", "@@v[u\\", "@@FjâL~wyoo~sµLZ", "@@¬e¹aH",
						"@@\\nÔ¡q]L³ë\\ÿ®QÌ", "@@ÊA­©]ª", "@@Kxv{­", "@@@hlIk_", "@@pWcrxp", "@@Md|_iA", "@@¢X£½z\\ðpN",
						"@@hlÜ[LykAvyfw^E ", "@@fp¤MusH", "@@®_ma~LÁ¬`", "@@@°¡mÛGĕ¨§Ianá[ýƤjfæÐNäGp", "@@iMt\\",
						"@@Zc[b", "@@X®±GrÆ°Zæĉm", "@@Z~dOSo|A¿qZv", "@@@`EN£p", "@@|s", "@@@nDi",
			...
			geometry: {
				type: "MultiPolygon",
				coordinates: [
					["@@zht´}[", "@@aj^~ĆGå", "@@edHse", "@@@vPGsyQ", "@@sBzddW[O", "@@S¨Qy", "@@NVucW", "@@qptB@q",
						"@@¸[iu", "@@Q\\pD[_", "@@jSwUappI", "@@eXª~", "@@AjvFoo", "@@fT_Çí\\v|ba¦jZÆy|®", "@@IjLg",
						"@@wJIx«¼AoNe{M¥", "@@K±¡ÓČ~N¾",
			...
			geometry: {
				type: "MultiPolygon",
				coordinates: [
					["@@Xjd]mE", "@@itnq", "@@Dl@k", "@@TGw", "@@K¬U", "@@Wd`c", "@@PtMs", "@@LnXlc", "@@ppVu]Qn",
						"@@cdzAU_", "@@udRhnCE", "@@oIpP",
			...
			geometry: {
				type: "MultiPolygon",
				coordinates: [
					["@@QdAsa", "@@lxDRm", "@@sbhNLo", "@@Ă ý", "@@WltOY[", "@@Kr]S", "@@e~AS}", "@@I|Mym",
						"@@Û³LS²Q", "@@nvºBë¥cÕº", "@@zdÛJm", "@@°³", "@@a yAª¸ËJIxØ@ĀHÉÕZofoo",
						"@@sŗÃÔėAƁZÄ ~°ČPºb", "@@¶ÝÌvmĞh¹Ĺ", "@@HdSjĒ¢D}waru«ZqadY{K", "@@el\\LqqO", "@@~rMmX",
						"@@f^E", "@@øPªoj÷ÍÝħXČx°Q¨ıXJp", "@@gÇƳmxatfu", "@@EÆC½",
			...
			geometry: {
				type: "MultiPolygon",
				coordinates: [
					["@@ɧư¬EpƸÁx]", "@@©²", "@@MA", "@@QpªKWT§¨", "@@bŝÕÕEȣÚƥêImɇǦèÜĠÚÄÓŴ·ʌÇ",
						"@@Sô¤r]ìƬįǜûȬɋŭ×^sYɍDŋŽąñCG²«ªč@h_p¯A{oloY¬j@Ĳ`gQÚpptǀ^MĲvtbe´Rh@oj¨", "@@ÆLH{a}Eo¦"
					]
				],
				encodeOffsets: [
					[
