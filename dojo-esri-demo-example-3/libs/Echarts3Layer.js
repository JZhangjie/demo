	...
	function(e, t, n, i) {
		return e("Echarts3Layer", null, {
			...
			constructor: function(e, t) {
				...
				n.style.position = "absolute", n.style.height = e.height + "px", n.style.width = e.width + "px", n.style.top =
					0, n.style.left = 0, e.__container.appendChild(n), this._init(e, t)
			},
			_init: function(e, t) {
				...
				o._bindEvent = function() {
					...
					o._map.on("resize", function() {
						...
						o._mapOffset = [-parseInt(e.style.left) || 0, -parseInt(e.style.top) || 0], o._echartsContainer.style.left =
							o._mapOffset[0] + "px", o._echartsContainer.style.top = o._mapOffset[1] + "px", setTimeout(function() {
					...
					o._ec.getZr().on("mousewheel", function(e) {
						...
						var t = e.wheelDelta,
							n = o._map,
							a = n.getZoom();
						t = t > 0 ? Math.ceil(t) : Math.floor(t), t = Math.max(Math.min(t, 4), -4), t = Math.max(n.getMinZoom(),
							Math.min(n.getMaxZoom(), a + t)) - a, o._delta = 0, o._startTime = null, t && n.setZoom(a + t)
					})
				}
			}
		})
